...
export function renderNavBar(
  ...
  const themeIcon = theme === "dark"
    ...
    : icon(`
      ...
      `);
  // Ordered by how often people need them: overview first, deep dives after.
  ...
  return `
    <header class="navbar" role="navigation" aria-label="Main navigation">
      <div class="navbar-brand">
        ...
        ${dataSourceLabel ? `<span class="navbar-badge" title="Where this dashboard gets its data">${dataSourceLabel}</span>` : ""}
        <span class="navbar-version" title="Dashboard version">v${__APP_VERSION__}</span>
      ...
      <nav class="navbar-tabs ${isMenuOpen ? "mobile-open" : ""}">
