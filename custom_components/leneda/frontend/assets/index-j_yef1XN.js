var _a=Object.defineProperty;var xa=(t,e,a)=>e in t?_a(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var De=(t,e,a)=>xa(t,typeof e!="symbol"?e+"":e,a);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(o){if(o.ep)return;o.ep=!0;const n=a(o);fetch(o.href,n)}})();const ka="modulepreload",Ma=function(t){return"/leneda-panel/static/"+t},Dt={},me=function(e,a,s){let o=Promise.resolve();if(a&&a.length>0){let r=function(f){return Promise.all(f.map(d=>Promise.resolve(d).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),u=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));o=r(a.map(f=>{if(f=Ma(f),f in Dt)return;Dt[f]=!0;const d=f.endsWith(".css"),g=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${f}"]${g}`))return;const h=document.createElement("link");if(h.rel=d?"stylesheet":ka,d||(h.as="script"),h.crossOrigin="",h.href=f,u&&h.setAttribute("nonce",u),document.head.appendChild(h),d)return new Promise((m,y)=>{h.addEventListener("load",m),h.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${f}`)))})}))}function n(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return o.then(r=>{for(const l of r||[])l.status==="rejected"&&n(l.reason);return e().catch(n)})};function qt(t){return{api_key:(t.api_key??"").trim(),energy_id:(t.energy_id??"").trim(),meters:(t.meters??[]).map(e=>({...e,id:(e.id??"").trim()})),proxy_url:(t.proxy_url??"").trim()}}function Ca(){var t,e,a,s,o;try{const n=(e=(t=window.parent)==null?void 0:t.document)==null?void 0:e.querySelector("home-assistant");return((o=(s=(a=n==null?void 0:n.hass)==null?void 0:a.auth)==null?void 0:s.data)==null?void 0:o.access_token)??null}catch{return null}}async function J(t,e){const a=Ca(),s={...e==null?void 0:e.headers,...a?{Authorization:`Bearer ${a}`}:{}},o={...e,credentials:"include",headers:s},n=await fetch(t,o);if(!n.ok){const r=n.headers.get("content-type")??"";let l="",u="";if(r.includes("application/json")){const f=await n.json().catch(()=>null);l=String((f==null?void 0:f.error)??"").trim(),u=String((f==null?void 0:f.message)??(f==null?void 0:f.error)??"").trim()}else u=(await n.text().catch(()=>"")).trim();throw l==="missing_data"||l==="no_data"||n.status===503?new Error("Missing data"):new Error(u?`API ${n.status}: ${u}`:`API ${n.status}: ${n.statusText}`)}return n.json()}async function et(t){return J(`/leneda_api/data?range=${t}`)}async function Sa(t,e){return J(`/leneda_api/data/custom?start=${encodeURIComponent(t)}&end=${encodeURIComponent(e)}`)}async function Ae(t,e,a){let s=`/leneda_api/data/timeseries?obis=${encodeURIComponent(t)}`;return e&&(s+=`&start=${encodeURIComponent(e)}`),a&&(s+=`&end=${encodeURIComponent(a)}`),J(s)}async function gt(t,e,a){let s=`/leneda_api/data/timeseries/per-meter?obis=${encodeURIComponent(t)}`;return e&&(s+=`&start=${encodeURIComponent(e)}`),a&&(s+=`&end=${encodeURIComponent(a)}`),J(s)}async function vt(){return J("/leneda_api/sensors")}async function He(){return J("/leneda_api/config")}async function Ta(t){await J("/leneda_api/config",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})}async function Ea(){await J("/leneda_api/config/reset",{method:"POST"})}async function Yt(){try{return await J("/leneda_api/mode")}catch{return{mode:"standalone",configured:!1}}}async function jt(){return J("/leneda_api/credentials")}async function Da(t){const e=qt(t);await J("/leneda_api/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})}async function Fa(t){const e=qt(t);return J("/leneda_api/credentials/test",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})}async function zt(){return J("/leneda_api/ha-entities")}const ke=Object.freeze(Object.defineProperty({__proto__:null,fetchConfig:He,fetchCredentials:jt,fetchCustomData:Sa,fetchHAEntities:zt,fetchMode:Yt,fetchPerMeterTimeseries:gt,fetchRangeData:et,fetchSensors:vt,fetchTimeseries:Ae,resetConfig:Ea,saveConfig:Ta,saveCredentials:Da,testCredentials:Fa},Symbol.toStringTag,{value:"Module"}));function ft(t){const e=t.match(/^(\d{4})-(\d{2})-(\d{2})$/);if(e){const[,a,s,o]=e;return new Date(Number(a),Number(s)-1,Number(o))}return new Date(t)}function p(t,e=2){return t==null?"—":t.toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:e})}function we(t){return ft(t).toLocaleDateString(void 0,{month:"short",day:"numeric"})}function Xt(t){return ft(t).toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}function We(t){return ft(t).toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}const at=[{id:"year",label:"Year",shortLabel:"Yr",stepLabel:"year",approxMs:365*864e5,maxBuckets:30},{id:"month",label:"Month",shortLabel:"Mo",stepLabel:"month",approxMs:30*864e5,maxBuckets:72},{id:"week",label:"Week",shortLabel:"Wk",stepLabel:"week",approxMs:7*864e5,maxBuckets:104},{id:"day",label:"Day",shortLabel:"Day",stepLabel:"day",approxMs:864e5,maxBuckets:370},{id:"hour",label:"Hour",shortLabel:"Hr",stepLabel:"hour",approxMs:36e5,maxBuckets:744},{id:"quarter_hour",label:"15 min",shortLabel:"15m",stepLabel:"15 minutes",approxMs:15*6e4,maxBuckets:672}];function Zt(t){return at.find(e=>e.id===t)??at[3]}function yt(t,e){if(!t||!e)return 0;const a=new Date(t).getTime(),s=new Date(e).getTime();return!Number.isFinite(a)||!Number.isFinite(s)?0:Math.max(0,s-a)}function Ne(t,e){const a=Zt(t);if(e<=0)return t==="quarter_hour";const s=e/a.approxMs;return s>=1.5&&s<=a.maxBuckets}function Wa(t,e){var o;if(e&&Ne(e,t))return e;const a=t/864e5,s=a<=1.25?"quarter_hour":a<=7?"hour":a<=45?"day":a<=180?"week":a<=900?"month":"year";return Ne(s,t)?s:((o=at.find(n=>Ne(n.id,t)))==null?void 0:o.id)??"quarter_hour"}function La(t,e){return new Date(t,e+1,0).getDate()}function Ft(t,e,a){const s=t.getDate(),o=new Date(t),n=o.getMonth()+a,r=o.getFullYear()+e+Math.floor(n/12),l=(n%12+12)%12,u=Math.min(s,La(r,l));return o.setFullYear(r,l,u),o}function Wt(t,e,a){switch(e){case"year":return Ft(t,a,0);case"month":return Ft(t,0,a);case"week":return new Date(t.getTime()+a*7*864e5);case"day":return new Date(t.getTime()+a*864e5);case"hour":return new Date(t.getTime()+a*36e5);case"quarter_hour":return new Date(t.getTime()+a*15*6e4)}}function Jt(t,e,a,s){if(!t||!e)return null;const o=new Date(t),n=new Date(e);return!Number.isFinite(o.getTime())||!Number.isFinite(n.getTime())?null:{start:Wt(o,a,s),end:Wt(n,a,s)}}function Pa(t,e){if(!t||!e)return"No period loaded";const a=new Date(t),s=new Date(e);if(!Number.isFinite(a.getTime())||!Number.isFinite(s.getTime()))return"No period loaded";if(a.getFullYear()===s.getFullYear()&&a.getMonth()===s.getMonth()&&a.getDate()===s.getDate()){const n=a.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"}),r=a.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"}),l=s.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});return`${n}, ${r} - ${l}`}return`${a.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})} - ${s.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}`}const Oe=[{id:"yesterday",label:"Yesterday"},{id:"this_week",label:"This Week"},{id:"last_week",label:"Last Week"},{id:"this_month",label:"This Month"},{id:"last_month",label:"Last Month"},{id:"this_year",label:"This Year"},{id:"last_year",label:"Last Year"},{id:"custom",label:"Custom"}];function ge(t){const e=a=>`
  ...
  `;switch(t){case"consumption":return e(`
      ...
      `)}}function Ka(t){var qe,Pe,Ke,ue,Ye,Re,fe,Se;const e=t.rangeData,a=M=>{if(!M)return"";const E=M.match(/^(\d{4}-\d{2}-\d{2})/);return E?E[1]:""},s=(e==null?void 0:e.consumption)??0,o=(e==null?void 0:e.production)??0,n=(e==null?void 0:e.exported)??0,r=(e==null?void 0:e.self_consumed)??0,l=(e==null?void 0:e.gas_energy)??0,u=(e==null?void 0:e.gas_volume)??0,f=(e==null?void 0:e.peak_power_kw)??0,d=a(e==null?void 0:e.start),g=a(e==null?void 0:e.end),h=(e==null?void 0:e.shared_with_me)??0,m=(e==null?void 0:e.shared)??0,y=Math.max(0,n),$=(e==null?void 0:e.grid_import)!=null?s-e.grid_import:void 0,x=Math.max(0,$??(e==null?void 0:e.solar_to_home)??(e==null?void 0:e.direct_solar_to_home)??(r>0?r:o-y)),k=Math.max(0,(e==null?void 0:e.direct_solar_to_home)??Math.max(0,x-h)),C=x,_=Math.max(0,(e==null?void 0:e.grid_import)??s-x),S=s>0?s:_+x,i=!!((qe=t.config)!=null&&qe.meter_has_gas||(((Pe=t.config)==null?void 0:Pe.meters)??[]).some(M=>M.types.includes("gas"))),c=m+h,v=S>0?Math.min(100,x/S*100):0,b=Math.max(S,o,_,y,m,h,k,1),W=i?Math.min(Math.max(0,l),b):0,D=(M,E=2.8,F=8.2)=>M>0?E+M/b*(F-E):1.8,P=M=>D(M)+1.4,N=M=>D(M)+5.4,V=(M,E=.28,F=.88)=>M>0?E+M/b*(F-E):.1,I=(M,E=.09,F=.22)=>M>0?E+M/b*(F-E):.05,O=(M,E=1.6,F=3.9)=>`${(M>0?Math.max(E,F-M/b*(F-E)):F).toFixed(2)}s`,se=(M,E=3.4,F=5.8)=>M>0?E+M/b*(F-E):3,Q=M=>M>0?Math.max(18,Math.round(M/b*100)):0,re=M=>`
    <defs>
  ...
  `,j=M=>{const{x:E,y:F,width:G,accent:B,kicker:Te,value:ee,detail:he}=M;return`
    ...
    `},te=M=>{const{x:E,y:F,scale:G=1,glowId:B}=M;return`
    ...
    `},ce=M=>{const{x:E,y:F,scale:G=1,glowId:B}=M;return`
    ...
    `},Y=M=>{const{x:E,y:F,scale:G=1,glowId:B}=M;return`
    ...
    `},H=M=>{const{prefix:E,x:F,y:G,scale:B=1}=M;return`
    ...
    `},U=M=>{const{path:E,value:F,gradientId:G,colorVar:B,filterId:Te,particleClass:ee,direction:he="forward"}=M,Ee=he==="reverse"?"1;0":"0;1";return`
      <path
        class="flow-halo ${ee}"
        d="${E}"
        stroke="url(#${G})"
        stroke-width="${N(F).toFixed(1)}"
      ...
      ${F>0?`
        <circle
          ...
          filter="url(#${Te})"
        >
          <animateMotion dur="${O(F)}" repeatCount="indefinite" path="${E}" keyPoints="${Ee}" keyTimes="0;1" calcMode="linear" />
        </circle>
        <circle
          ...
          filter="url(#${Te})"
        >
          <animateMotion dur="${O(F)}" begin="-${(parseFloat(O(F))/2).toFixed(2)}s" repeatCount="indefinite" path="${E}" keyPoints="${Ee}" keyTimes="0;1" calcMode="linear" />
        </circle>
      `:""}
    `},ne=()=>`
    <div class="elite-scene elite-scene-desktop">
      <svg class="elite-main-svg" viewBox="0 0 860 460" fill="none" preserveAspectRatio="xMidYMid meet">
        ...
        ${i?U({path:"M 430 404 C 430 370 430 336 430 302",value:W,gradientId:"desktop-flow-gas",colorVar:"var(--clr-gas)",filterId:"desktop-glow-gas",particleClass:"flow-gas"}):""}
      </svg>
    </div>
  `,de=()=>`
    <div class="elite-scene elite-scene-mobile">
      <svg class="elite-main-svg" viewBox="0 0 420 560" fill="none" preserveAspectRatio="xMidYMid meet">
        ...
        ${i?U({path:"M 210 474 C 210 432 210 390 210 344",value:W,gradientId:"mobile-flow-gas",colorVar:"var(--clr-gas)",filterId:"mobile-glow-gas",particleClass:"flow-gas"}):""}
      </svg>
    </div>
  `,Me=e!=null&&e.start&&(e!=null&&e.end)?`${we(e.start)} — ${we(e.end)}`:t.range==="custom"&&t.customStart&&t.customEnd?`${we(t.customStart+"T00:00:00")} — ${we(t.customEnd+"T00:00:00")}`:((Ke=Oe.find(M=>M.id===t.range))==null?void 0:Ke.label)??"Yesterday",Ce=(Ye=(ue=t.consumptionTimeseries)==null?void 0:ue.items)!=null&&Ye.length?t.consumptionTimeseries.items:((Re=t.productionTimeseries)==null?void 0:Re.items)??[],ye=t.chartViewportStart??((fe=Ce[0])==null?void 0:fe.startedAt)??(e==null?void 0:e.start),oe=t.chartViewportEnd??((Se=Ce[Ce.length-1])==null?void 0:Se.startedAt)??(e==null?void 0:e.end),X=yt(ye,oe),pe=Zt(t.chartTimeBucket),z=Pa(ye,oe),be=Jt(ye,oe,t.chartTimeBucket,1),ae=new Date,Ue=!be||be.start.getTime()>ae.getTime(),Le=at.map(M=>{const E=Ne(M.id,X),F=M.id===t.chartTimeBucket,G=M.id==="quarter_hour"?"15-minute detail would be too dense for this selected period":`${M.label} detail does not add useful resolution for this selected period`;return`
            <button
            ...
            <div class="mobile-flow-summary">
              ...
              <div class="mobile-flow-list">
                ...
                <div class="mobile-flow-item gas">
                  ...
                  <div class="mobile-flow-bar"><span style="width: ${Q(W||b)}%;"></span></div>
  ...
  `}function Ra(t=""){return{iso:t,consumptionKw:0,productionKw:0,gridImportKw:0,solarExportKw:0}}function Xe(t,e,a){for(const s of(e==null?void 0:e.items)??[]){const o=new Date(s.startedAt).getTime();if(!Number.isFinite(o))continue;const n=t.get(o)??Ra(s.startedAt);n[a]+=Math.max(0,Number(s.value)||0),n.iso||(n.iso=s.startedAt),t.set(o,n)}}function Va(t,e,a={}){var r,l,u,f;const s=new Map,o=!!((l=(r=a.gridImport)==null?void 0:r.items)!=null&&l.length),n=!!((f=(u=a.marketExport)==null?void 0:u.items)!=null&&f.length);return Xe(s,t,"consumptionKw"),Xe(s,e,"productionKw"),Xe(s,a.gridImport,"gridImportKw"),Xe(s,a.marketExport,"solarExportKw"),[...s.entries()].sort((d,g)=>d[0]-g[0]).map(([d,g])=>{const h=Math.max(0,g.consumptionKw),m=Math.max(0,g.productionKw),y=Math.max(0,Math.min(h,m)),$=o?Math.max(0,g.gridImportKw):Math.max(0,h-y),x=Math.max(0,h-$),k=n?Math.max(0,g.solarExportKw):Math.max(0,m-y);return{timestamp:d,iso:g.iso||new Date(d).toISOString(),consumptionKw:h,productionKw:m,solarToHomeKw:x,gridImportKw:$,solarExportKw:k}})}function Ge(t,e){return Number.isFinite(t)?Number(t):e}function ut(t,e,a){return Math.min(a,Math.max(e,t))}function Ia(t,e,a){const s=t.reduce((m,y)=>m+y.producedKwh,0),o=t.reduce((m,y)=>m+y.selfConsumedKwh,0),n=t.reduce((m,y)=>m+y.exportedKwh,0),r=Ge(e,o),l=Ge(a,n),u=Math.max(0,r)+Math.max(0,l),f=Math.max(0,s-Math.max(0,l));if(s<=0)return{selfConsumedKwh:0,exportedKwh:0};if(u<=s+1e-6)return{selfConsumedKwh:ut(Math.max(Math.max(0,r),f),0,s),exportedKwh:ut(Math.max(0,l),0,s)};const d=u>0?Math.max(0,r)/u:0,g=Math.min(s,Math.max(0,r)),h=ut(s*d,0,g);return{selfConsumedKwh:h,exportedKwh:Math.max(0,s-h)}}function Aa(t,e){const a=t?t.slice(-8):"";return a?`Solar ${e} (${a})`:`Solar ${e}`}function tt(t,e,a){return(typeof a=="string"?a.trim():"")||Aa(t,e)}function wt(t){const e=(t.meters??[]).filter(o=>o.types.includes("production")),a=t.feed_in_rates??[],s=t.currency??"EUR";return e.map((o,n)=>{const r=a.find(g=>g.meter_id===o.id),l=(r==null?void 0:r.mode)==="sensor"&&r.sensor_value!=null&&Number.isFinite(r.sensor_value),u=l?(r==null?void 0:r.sensor_value)??0:Ge(r==null?void 0:r.tariff,Ge(t.feed_in_tariff,0)),f=Math.max(1,Math.round(Ge(r==null?void 0:r.self_use_priority,n+1))),d=tt(o.id,n+1,r==null?void 0:r.display_name);return{meterId:o.id,shortId:o.id?"…"+o.id.slice(-8):`Meter ${n+1}`,displayName:d,rate:u,label:l?`Sensor (${u.toFixed(4)} ${s}/kWh)`:"Fixed tariff",mode:(r==null?void 0:r.mode)??"fixed",selfUsePriority:f}}).sort((o,n)=>o.selfUsePriority!==n.selfUsePriority?o.selfUsePriority-n.selfUsePriority:o.meterId.localeCompare(n.meterId))}function $t(t,e,a,s,o){var c;if(!e||!(a!=null&&a.length))return null;const n=wt(t);if(!n.length)return null;const r=new Map(a.map(v=>[v.meter_id,v]));if(!n.some(v=>r.has(v.meterId)))return null;const l=n.map(v=>({...v,producedKwh:0,selfConsumedKwh:0,exportedKwh:0,revenue:0,exportEquivalentForSelfUse:0})),u=new Map(l.map((v,b)=>[v.meterId,b])),f=new Map,d=new Set;for(const v of e.items)v.startedAt&&d.add(v.startedAt);const g=new Map;for(const v of e.items){const b=Math.max(0,Number(v.value)||0);g.set(v.startedAt,(g.get(v.startedAt)??0)+b)}for(const v of a){const b=new Map;for(const W of v.items??[]){const D=Math.max(0,Number(W.value)||0);b.set(W.startedAt,(b.get(W.startedAt)??0)+D),W.startedAt&&d.add(W.startedAt)}f.set(v.meter_id,b)}for(const v of[...d].sort()){let b=Math.max(0,g.get(v)??0);for(const W of l){const D=u.get(W.meterId);if(D==null)continue;const P=Math.max(0,((c=f.get(W.meterId))==null?void 0:c.get(v))??0),N=P*.25,V=Math.min(b,P),I=V*.25,O=Math.max(0,P-V)*.25;l[D].producedKwh+=N,l[D].selfConsumedKwh+=I,l[D].exportedKwh+=O,b=Math.max(0,b-V)}}const h=l.reduce((v,b)=>v+b.selfConsumedKwh,0),m=l.reduce((v,b)=>v+b.exportedKwh,0),y=Ia(l,s,o),$=y.selfConsumedKwh,x=y.exportedKwh,k=h>0?$/h:1,C=m>0?x/m:1;for(const v of l)v.selfConsumedKwh*=k,v.exportedKwh*=C,v.revenue=v.exportedKwh*v.rate,v.exportEquivalentForSelfUse=v.selfConsumedKwh*v.rate;const _=l.reduce((v,b)=>v+b.revenue,0),S=l.reduce((v,b)=>v+b.exportEquivalentForSelfUse,0),i=x>0?_/x:0;return{meters:l,totalFeedInRevenue:_,totalSelfUseExportEquivalent:S,weightedExportRate:i,usedPriorityAllocation:!0}}const Lt=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],Ve={house:"Total Usage",grid:"Net Grid",solar:"Solar Production",exceedance_kwh:"Exceedance kWh",exceedance_frequency:"Exceedance Rate"},Ze={house:"Total Usage",grid:"Net Grid",solar:"Solar Production"},Fe={previous:"Previous Period",last_year:"Last Year"};function Pt(t){if(!t)return"";const e=t.match(/^(\d{4}-\d{2}-\d{2})/);return e?e[1]:""}function Ha(t){const e=new Date(t),a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${o}`}function Na(t){const[e,a,s]=t.split("-").map(Number);return new Date(e,a-1,s,12,0,0,0)}function ie(t,e=0){return t.length?Math.max(...t):e}function bt(t,e=0){return t.length?Math.min(...t):e}function $e(t,e,a){return Math.min(a,Math.max(e,t))}function q(t,e){if(!t.length)return 0;const a=[...t].sort((u,f)=>u-f),s=$e(e,0,1),o=(a.length-1)*s,n=Math.floor(o),r=Math.ceil(o);if(n===r)return a[n];const l=o-n;return a[n]*(1-l)+a[r]*l}function Ga(t){const e=Math.floor(t/4),a=t%4*15;return`${String(e).padStart(2,"0")}:${String(a).padStart(2,"0")}`}function R(t,e){return`${p(t,2)} ${e}`}function st(t,e){return`${t>0?"+":t<0?"-":""}${p(Math.abs(t),2)} ${e}`}function Je(t,e=1){return Math.abs(t)<.005?"0":`${t>0?"+":""}${p(t,e)}`}function Kt(t){const[e,a]=t.split(":").map(s=>parseInt(s,10)||0);return e*60+a}function Oa(t,e){return e==="all"?!0:e==="weekdays"?t>=1&&t<=5:t===0||t===6}function Qt(t,e,a,s){if(!Oa(t.getDay(),e))return!1;const o=t.getHours()*60+t.getMinutes(),n=Kt(a),r=Kt(s);return n===r?!0:n<r?o>=n&&o<r:o>=n||o<r}function Ua(t,e){return e.find(a=>Qt(t,a.day_group,a.start_time,a.end_time))}function Ba(t,e){return e.find(a=>Qt(t,a.day_group,a.start_time,a.end_time))}function ea(t,e,a,s,o){const n=$t(t,e,a,s,o);if(n&&n.weightedExportRate>0)return n.weightedExportRate;const r=wt(t).map(l=>l.rate).filter(l=>Number.isFinite(l)&&l>=0);return r.length?r.reduce((l,u)=>l+u,0)/r.length:t.feed_in_tariff??0}function qa(t,e,a,s,o,n){const r=o.consumption_rate_windows??[],l=o.reference_power_windows??[],u=o.reference_power_kw??0,f=(o.exceedance_rate??0)*(1+(o.vat_rate??0));return Va(t,e,{gridImport:a,marketExport:s}).map(d=>{var b,W;const g=d.timestamp,h=new Date(g),m=d.consumptionKw,y=d.productionKw,$=d.solarToHomeKw,x=d.gridImportKw,k=d.solarExportKw,C=((b=Ba(h,l))==null?void 0:b.reference_power_kw)??u,_=Math.max(0,m-C),S=Math.max(0,x-C),i=Math.max(0,_-S),v=((((W=Ua(h,r))==null?void 0:W.rate)??o.energy_variable_rate??0)+(o.network_variable_rate??0)+(o.electricity_tax_rate??0)+(o.compensation_fund_rate??0))*(1+(o.vat_rate??0));return{timestamp:g,iso:d.iso,date:h,houseKw:m,solarKw:y,solarToHomeKw:$,gridKw:x,exportKw:k,referenceKw:C,overKw:S,avoidedOverKw:i,importRateWithVat:v,feedInRate:n,exceedanceRateWithVat:f}})}function ta(t,e,a,s,o,n){const r=qa(t,e,a,s,o,n),l=new Map,u=Array.from({length:24},()=>0),f=Array.from({length:24},(i,c)=>({label:`${String(c).padStart(2,"0")}:00`,importCost:0,exportSpreadValue:0,gridKwh:0,exportKwh:0})),d={house:Array.from({length:7},()=>Array.from({length:24},()=>({sum:0,count:0}))),grid:Array.from({length:7},()=>Array.from({length:24},()=>({sum:0,count:0}))),solar:Array.from({length:7},()=>Array.from({length:24},()=>({sum:0,count:0}))),exceedance_kwh:Array.from({length:7},()=>Array.from({length:24},()=>({sum:0,count:0}))),exceedance_frequency:Array.from({length:7},()=>Array.from({length:24},()=>({sum:0,count:0})))},g=()=>Array.from({length:96},()=>[]),h={house:{weekday:g(),weekend:g()},grid:{weekday:g(),weekend:g()},solar:{weekday:g(),weekend:g()}},m={houseKwh:0,solarKwh:0,solarToHomeKwh:0,gridKwh:0,exportKwh:0,exceedanceKwh:0,avoidedExceedanceKwh:0,importCost:0,solarSavings:0,exportRevenue:0,selfConsumptionAdvantage:0,exceedanceCost:0,avoidedExceedanceValue:0,solarValue:0,netValue:0,coveragePct:0,selfConsumedPct:0,peakGridKw:0,peakHouseKw:0,exceedanceIntervals:0};for(const i of r){const v=Ha(i.timestamp),b=l.get(v)??(()=>{const de=Na(v);return{key:v,label:de.toLocaleDateString(void 0,{month:"short",day:"numeric"}),fullDate:de.toLocaleDateString(void 0,{weekday:"short",month:"short",day:"numeric"}),houseKwh:0,solarKwh:0,solarToHomeKwh:0,gridKwh:0,exportKwh:0,exceedanceKwh:0,avoidedExceedanceKwh:0,importCost:0,solarSavings:0,exportRevenue:0,selfConsumptionAdvantage:0,exceedanceCost:0,avoidedExceedanceValue:0,solarValue:0,netValue:0,coveragePct:0,selfConsumedPct:0,peakGridKw:0,peakHouseKw:0,exceedanceIntervals:0}})(),W=i.houseKw*.25,D=i.solarKw*.25,P=i.solarToHomeKw*.25,N=i.gridKw*.25,V=i.exportKw*.25,I=i.overKw*.25,O=i.avoidedOverKw*.25,se=N*i.importRateWithVat,Q=P*i.importRateWithVat,re=V*i.feedInRate,j=P*(i.importRateWithVat-i.feedInRate),le=I*i.exceedanceRateWithVat,te=O*i.exceedanceRateWithVat,ce=Q+re+te-se-le;b.houseKwh+=W,b.solarKwh+=D,b.solarToHomeKwh+=P,b.gridKwh+=N,b.exportKwh+=V,b.exceedanceKwh+=I,b.avoidedExceedanceKwh+=O,b.importCost+=se,b.solarSavings+=Q,b.exportRevenue+=re,b.selfConsumptionAdvantage+=j,b.exceedanceCost+=le,b.avoidedExceedanceValue+=te,b.netValue+=ce,b.peakGridKw=Math.max(b.peakGridKw,i.gridKw),b.peakHouseKw=Math.max(b.peakHouseKw,i.houseKw),b.exceedanceIntervals+=i.overKw>0?1:0,l.set(v,b),m.houseKwh+=W,m.solarKwh+=D,m.solarToHomeKwh+=P,m.gridKwh+=N,m.exportKwh+=V,m.exceedanceKwh+=I,m.avoidedExceedanceKwh+=O,m.importCost+=se,m.solarSavings+=Q,m.exportRevenue+=re,m.selfConsumptionAdvantage+=j,m.exceedanceCost+=le,m.avoidedExceedanceValue+=te,m.netValue+=ce,m.peakGridKw=Math.max(m.peakGridKw,i.gridKw),m.peakHouseKw=Math.max(m.peakHouseKw,i.houseKw),m.exceedanceIntervals+=i.overKw>0?1:0;const Y=(i.date.getDay()+6)%7,H=i.date.getHours(),U=H*4+Math.floor(i.date.getMinutes()/15),ne=i.date.getDay()===0||i.date.getDay()===6?"weekend":"weekday";d.house[Y][H].sum+=i.houseKw,d.house[Y][H].count+=1,d.grid[Y][H].sum+=i.gridKw,d.grid[Y][H].count+=1,d.solar[Y][H].sum+=i.solarKw,d.solar[Y][H].count+=1,d.exceedance_kwh[Y][H].sum+=I,d.exceedance_kwh[Y][H].count+=1,d.exceedance_frequency[Y][H].sum+=i.overKw>0?1:0,d.exceedance_frequency[Y][H].count+=1,u[H]+=I,h.house[ne][U].push(i.houseKw),h.grid[ne][U].push(i.gridKw),h.solar[ne][U].push(i.solarKw),f[H].importCost+=se,f[H].exportSpreadValue+=V*Math.max(i.importRateWithVat-i.feedInRate,0),f[H].gridKwh+=N,f[H].exportKwh+=V}const y=[...l.values()].sort((i,c)=>i.key.localeCompare(c.key)).map(i=>(i.coveragePct=i.houseKwh>0?i.solarToHomeKwh/i.houseKwh*100:0,i.selfConsumedPct=i.solarKwh>0?$e(i.solarToHomeKwh/i.solarKwh*100,0,100):0,i.solarValue=i.solarSavings+i.exportRevenue+i.avoidedExceedanceValue,i));m.coveragePct=m.houseKwh>0?m.solarToHomeKwh/m.houseKwh*100:0,m.selfConsumedPct=m.solarKwh>0?$e(m.solarToHomeKwh/m.solarKwh*100,0,100):0,m.solarValue=m.solarSavings+m.exportRevenue+m.avoidedExceedanceValue;const $={house:d.house.map(i=>i.map(c=>c.count?c.sum/c.count:0)),grid:d.grid.map(i=>i.map(c=>c.count?c.sum/c.count:0)),solar:d.solar.map(i=>i.map(c=>c.count?c.sum/c.count:0)),exceedance_kwh:d.exceedance_kwh.map(i=>i.map(c=>c.sum)),exceedance_frequency:d.exceedance_frequency.map(i=>i.map(c=>c.count?c.sum/c.count*100:0))},x=Array.from({length:96},(i,c)=>Ga(c)),k={house:{weekday:{lower:h.house.weekday.map(i=>q(i,.1)),median:h.house.weekday.map(i=>q(i,.5)),upper:h.house.weekday.map(i=>q(i,.9))},weekend:{lower:h.house.weekend.map(i=>q(i,.1)),median:h.house.weekend.map(i=>q(i,.5)),upper:h.house.weekend.map(i=>q(i,.9))}},grid:{weekday:{lower:h.grid.weekday.map(i=>q(i,.1)),median:h.grid.weekday.map(i=>q(i,.5)),upper:h.grid.weekday.map(i=>q(i,.9))},weekend:{lower:h.grid.weekend.map(i=>q(i,.1)),median:h.grid.weekend.map(i=>q(i,.5)),upper:h.grid.weekend.map(i=>q(i,.9))}},solar:{weekday:{lower:h.solar.weekday.map(i=>q(i,.1)),median:h.solar.weekday.map(i=>q(i,.5)),upper:h.solar.weekday.map(i=>q(i,.9))},weekend:{lower:h.solar.weekend.map(i=>q(i,.1)),median:h.solar.weekend.map(i=>q(i,.5)),upper:h.solar.weekend.map(i=>q(i,.9))}}},C=r.filter(i=>i.overKw>0).sort((i,c)=>c.overKw-i.overKw||c.timestamp-i.timestamp).slice(0,8),_=[...r].sort((i,c)=>c.houseKw-i.houseKw||c.timestamp-i.timestamp).slice(0,8),S=[...y].filter(i=>i.exceedanceKwh>0).sort((i,c)=>c.exceedanceKwh-i.exceedanceKwh).slice(0,6);return{points:r,daily:y,totals:m,topExceedances:C,peakIntervals:_,hourlyExceedanceKwh:u,heatmapValues:$,intradayProfiles:k,intradayLabels:x,hourlyOpportunity:f,loadDurationGrossKw:r.map(i=>i.houseKw).sort((i,c)=>c-i),loadDurationNetKw:r.map(i=>i.gridKw).sort((i,c)=>c-i),worstDays:S}}function Ya(t){var e,a,s;return(e=t.rangeData)!=null&&e.start&&((a=t.rangeData)!=null&&a.end)?`${we(t.rangeData.start)} - ${we(t.rangeData.end)}`:((s=Oe.find(o=>o.id===t.range))==null?void 0:s.label)??"Selected Period"}function ja(t){var e,a;return(e=t.rangeData)!=null&&e.start&&((a=t.rangeData)!=null&&a.end)?`${We(t.rangeData.start)} - ${We(t.rangeData.end)}`:t.range==="custom"&&t.customStart&&t.customEnd?`${t.customStart} - ${t.customEnd}`:"Based on the currently selected range."}function Rt(t){const e=t.analysisComparisonMode==="last_year"?"Same period last year":"Previous matched period";return t.analysisComparison?`${e}: ${We(t.analysisComparison.start)} - ${We(t.analysisComparison.end)}`:e}function za(t){switch(t){case"house":return{description:"Average hourly power by weekday for total house usage.",note:"Each cell shows the average kW seen in that weekday/hour slot over the selected period."};case"grid":return{description:"Average hourly power by weekday for remaining grid draw after solar.",note:"Each cell shows the average net-grid kW seen in that weekday/hour slot over the selected period."};case"solar":return{description:"Average hourly power by weekday for solar production.",note:"Each cell shows the average solar kW seen in that weekday/hour slot over the selected period."};case"exceedance_kwh":return{description:"Cumulative exceedance energy by weekday and hour, showing where the reference limit hurt the most.",note:"Each cell shows cumulative exceedance kWh recorded in that weekday/hour slot over the selected period."};case"exceedance_frequency":return{description:"How often each weekday/hour slot went over the reference limit.",note:"Each cell shows the share of 15-minute intervals in that weekday/hour slot that exceeded the reference limit."}}}function Xa(t,e){switch(t){case"house":case"grid":case"solar":return`${p(e,2)} kW average`;case"exceedance_kwh":return`${p(e,2)} kWh`;case"exceedance_frequency":return`${p(e,0)}% of intervals`}}function ve(t){const e=t.series.filter(v=>v.values.length>0);if(!e.length)return'<div class="analysis-empty">No chart data available for this period.</div>';const a=Math.max(...e.map(v=>v.values.length)),s=Math.max(720,a*24+92),o=244,n=50,r=20,l=18,u=30,f=e.flatMap(v=>v.values);t.referenceValue!=null&&f.push(t.referenceValue);let d=t.minValue??bt(f,0),g=t.maxValue??ie(f,1);d===g&&(g+=1,d=Math.min(0,d-1)),t.minValue==null&&(d=Math.min(0,d));const h=s-n-r,m=o-l-u,y=(v,b)=>b<=1?n+h/2:n+v*h/(b-1),$=v=>l+(g-v)/(g-d)*m,x=t.valueFormatter??(v=>p(v,1)),k=Array.from({length:4},(v,b)=>d+(g-d)/3*b),C=[0,Math.floor((a-1)/2),a-1].filter((v,b,W)=>W.indexOf(v)===b),_=k.map(v=>{const b=$(v);return`
    ...
    `}).join(""),S=t.referenceValue!=null?(()=>{const v=$(t.referenceValue);return`
      ...
      `})():"",i=e.map(v=>{const b=v.values.map((D,P)=>{const N=y(P,v.values.length),V=$(D);return`${P===0?"M":"L"} ${N.toFixed(1)} ${V.toFixed(1)}`}).join(" "),W=v.values.length<=40?v.values.map((D,P)=>{const N=y(P,v.values.length),V=$(D);return`<circle cx="${N.toFixed(1)}" cy="${V.toFixed(1)}" r="2.6" fill="${v.color}" />`}).join(""):"";return`
      <path d="${b}" fill="none" stroke="${v.color}" stroke-width="2.5" ${v.dashed?'stroke-dasharray="6 4"':""} />
      ${W}
    `}).join(""),c=C.map(v=>{const b=y(v,a),W=t.labels[v]??`Point ${v+1}`;return`<text x="${b.toFixed(1)}" y="${o-8}" text-anchor="middle" class="analysis-svg-x-label">${W}</text>`}).join("");return`
  ...
  `}function Za(t){const e=t.series.filter(c=>c.band.median.length>0);if(!e.length)return'<div class="analysis-empty">No profile data available for this period.</div>';const a=Math.max(...e.map(c=>c.band.median.length)),s=Math.max(760,a*12+92),o=248,n=50,r=20,l=18,u=30,f=e.flatMap(c=>[...c.band.lower,...c.band.median,...c.band.upper]),d=Math.min(0,bt(f,0));let g=ie(f,1);g<=d&&(g=d+1);const h=s-n-r,m=o-l-u,y=(c,v)=>v<=1?n+h/2:n+c*h/(v-1),$=c=>l+(g-c)/(g-d)*m,x=t.valueFormatter??(c=>p(c,1)),k=Array.from({length:4},(c,v)=>d+(g-d)/3*v),C=[0,16,32,48,64,80,a-1].filter((c,v,b)=>c>=0&&c<a&&b.indexOf(c)===v),_=k.map(c=>{const v=$(c);return`
  ...
  `}function Ja(t){const e=new Date(t.timestamp);return{date:e.toLocaleDateString(void 0,{month:"short",day:"numeric"}),time:e.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"})}}function Qa(t){if(!t.length)return'<div class="analysis-empty">No peak intervals available for this period.</div>';const e=Math.max(760,t.length*86+96),a=276,s=52,o=16,n=18,r=54,l=ie(t.map($=>$.houseKw),1),u=e-s-o,f=a-n-r,d=n+f,g=u/t.length,h=Math.max(22,Math.min(38,g*.54)),m=t.map(($,x)=>{const k=s+x*g+(g-h)/2,C=$.solarToHomeKw/l*f,S=Math.max(0,Math.min($.gridKw,$.referenceKw))/l*f,i=Math.max(0,$.gridKw-$.referenceKw)/l*f;return`
      <g>
        <rect x="${k.toFixed(1)}" y="${(d-C).toFixed(1)}" width="${h.toFixed(1)}" height="${C.toFixed(1)}" rx="4" fill="rgba(63, 185, 80, 0.85)" />
        <rect x="${k.toFixed(1)}" y="${(d-C-S).toFixed(1)}" width="${h.toFixed(1)}" height="${S.toFixed(1)}" rx="4" fill="rgba(248, 81, 73, 0.62)" />
        ${i>0?`<rect x="${k.toFixed(1)}" y="${(d-C-S-i).toFixed(1)}" width="${h.toFixed(1)}" height="${i.toFixed(1)}" rx="4" fill="rgba(210, 153, 34, 0.92)" />`:""}
      </g>
    `}).join(""),y=t.map(($,x)=>{const k=s+x*g+g/2,{date:C,time:_}=Ja($);return`
      <text x="${k.toFixed(1)}" y="${a-20}" text-anchor="middle" class="analysis-svg-x-label">
        <tspan x="${k.toFixed(1)}" dy="0">${C}</tspan>
  ...
  `}function es(t){if(!t.length)return'<div class="analysis-empty">No daily energy data available.</div>';const e=Math.max(760,t.length*28+84),a=250,s=52,o=16,n=18,r=34,l=ie(t.map(_=>_.houseKwh),1),u=ie(t.map(_=>_.exportKwh),0),f=e-s-o,d=a-n-r,g=u>0?d*.72:d,h=u>0?d-g:0,m=n+g,y=f/t.length,$=Math.max(8,Math.min(18,y*.62)),x=Math.max(1,Math.ceil(t.length/10)),k=t.map((_,S)=>{const i=s+S*y+(y-$)/2,c=_.solarToHomeKwh/l*g,v=_.gridKwh/l*g,b=u>0?_.exportKwh/u*h:0,W=m-c-v-8;return`
      <g>
    ...
    `}).join(""),C=t.map((_,S)=>S%x!==0&&S!==t.length-1?"":`<text x="${(s+S*y+y/2).toFixed(1)}" y="${a-10}" text-anchor="middle" class="analysis-svg-x-label">${_.label}</text>`).join("");return`
    <div class="analysis-chart-scroller">
  ...
  `}function ts(t,e){const a=$e(e,0,1);return t==="solar"?`rgba(63, 185, 80, ${.12+a*.82})`:t==="exceedance_kwh"||t==="exceedance_frequency"?`rgba(210, 153, 34, ${.14+a*.82})`:t==="grid"?`rgba(210, 153, 34, ${.12+a*.82})`:`rgba(248, 81, 73, ${.12+a*.82})`}function as(t,e){const a=t.flat(),s=ie(a,1),o=bt(a,0);return`
        ...
        <div class="analysis-heatmap-row">
          ...
          ${n.map((l,u)=>{const f=s===o?0:(l-o)/(s-o);return`
              <span
                ...
                style="background:${ts(e,f)};"
                title="${Lt[r]} ${String(u).padStart(2,"0")}:00 - ${Xa(e,l)}"
  ...
  `:'<div class="analysis-empty">No standout patterns in this period.</div>'}function ss(t){var s,o,n,r;const e=Pt(((s=t.rangeData)==null?void 0:s.start)??t.customStart),a=Pt(((o=t.rangeData)==null?void 0:o.end)??t.customEnd);return`
    <div class="range-selector">
      ${Oe.map(l=>`
        <button
    ...
    ${t.range==="custom"?`
      ...
      `:e&&a?`
        ...
        `:""}
  `}function rs(t,e,a){const s=a.communitySolarToHomeKwh>.01?`${p(a.totalSolarCoverageKwh)} kWh of ${p(a.consumptionKwh)} kWh usage covered, incl. ${p(a.communitySolarToHomeKwh)} kWh shared`:`${p(a.totalSolarCoverageKwh)} kWh of ${p(a.consumptionKwh)} kWh usage covered`;return`
  ...
  `}function os(t,e){const a=za(t.analysisHeatmapMetric);return`
    <div class="card analysis-card">
      ...
      ${as(e.heatmapValues[t.analysisHeatmapMetric],t.analysisHeatmapMetric)}
      <p class="analysis-note">${a.note}</p>
    </div>
  `}function is(t,e){const a=t.analysisProfileMetric,s=e.intradayProfiles[a],o=Ze[a],n=s.weekday.median.reduce((l,u,f,d)=>u>d[l]?f:l,0),r=s.weekend.median.reduce((l,u,f,d)=>u>d[l]?f:l,0);return`
    <div class="card analysis-card">
      <div class="analysis-card-header">
        <div>
      ...
      ${Za({title:`${o} intraday profile`,labels:e.intradayLabels,series:[{label:"Weekday median (p10-p90 band)",color:"#58a6ff",fill:"rgba(88, 166, 255, 0.14)",band:s.weekday},{label:"Weekend median (p10-p90 band)",color:"#d29922",fill:"rgba(210, 153, 34, 0.13)",band:s.weekend,dashed:!0}],valueFormatter:l=>`${p(l,1)} kW`})}
      <p class="analysis-note">This makes the typical daily rhythm much easier to read than the weekday/hour heatmap alone.</p>
    </div>
  `}function ls(t,e,a){const s=t.meters.reduce((n,r)=>n+r.selfConsumedKwh*e,0),o=s+t.totalFeedInRevenue;return`
    <div class="analysis-subchart">
  ...
  `}function cs(t,e,a,s){const o=t.totals.solarKwh>0?$e(t.totals.solarToHomeKwh/t.totals.solarKwh*100,0,100):0,n=t.totals.solarKwh>0?$e(t.totals.exportKwh/t.totals.solarKwh*100,0,100):0;return`
    <div class="card analysis-card">
      <div class="analysis-card-header">
        <div>
      ...
      ${a!=null&&a.meters.length?ls(a,s,e):""}
      <div class="analysis-subchart">
  ...
  `}function ps(t,e){const a=t.hourlyExceedanceKwh.map((s,o)=>({label:`${String(o).padStart(2,"0")}:00`,value:s,meta:`${p(s,2)} kWh`,colorClass:"analysis-progress-fill-warn"})).filter(s=>s.value>0).sort((s,o)=>o.value-s.value).slice(0,6);return`
    <div class="card analysis-card">
      <div class="analysis-card-header">
        <div>
  ...
  `}function us(t){const e=t.peakIntervals.length?t.peakIntervals.reduce((a,s)=>a+(s.houseKw>0?s.solarToHomeKw/s.houseKw*100:0),0)/t.peakIntervals.length:0;return`
    <div class="card analysis-card analysis-card-full">
      <div class="analysis-card-header">
        <div>
  ...
  `}function hs(t,e,a){var u,f;const s=e.analysisComparisonMode==="last_year"?"Last year":"Previous";if(e.analysisComparisonLoading)return`
      <div class="card analysis-card">
        <div class="analysis-card-header">
          <div>
  ...
  `}function gs(t,e){const a=Array.from({length:Math.max(t.loadDurationGrossKw.length,t.loadDurationNetKw.length,1)},(s,o)=>`${o+1}`);return`
    <div class="card analysis-card">
      <div class="analysis-card-header">
        <div>
  ...
  `}function vs(t){var i,c;const e=t.config,a=t.rangeData,s=t.consumptionTimeseries,o=t.productionTimeseries;if(!e||!a||!s||!o)return`
      <section class="analysis-view">
        <div class="card">
          <p class="muted">Loading analysis data...</p>
        </div>
      </section>
    `;const n=Math.max(0,a.consumption??0),r=Math.max(0,a.production??0),l=Math.max(0,a.exported??0),u=Math.max(0,a.direct_solar_to_home??(a.self_consumed&&a.self_consumed>0?a.self_consumed:0)),f=Math.max(0,(a.grid_import!=null?n-a.grid_import:void 0)??a.solar_to_home??u??(a.self_consumed&&a.self_consumed>0?a.self_consumed:r-l)),d=Math.max(0,a.grid_import??n-f),g=Math.max(0,f-u),h=$t(e,s,((i=t.perMeterProductionTimeseries)==null?void 0:i.meters)??null,u,l),m=ea(e,s,((c=t.perMeterProductionTimeseries)==null?void 0:c.meters)??null,u,l),y=ta(s,o,t.gridImportTimeseries,t.marketExportTimeseries,e,m),$=e.currency||"EUR",x=((e.energy_variable_rate??0)+(e.network_variable_rate??0)+(e.electricity_tax_rate??0)+(e.compensation_fund_rate??0))*(1+(e.vat_rate??0)),k=u*x,C=h?h.totalSelfUseExportEquivalent:u*m,_=h?h.totalFeedInRevenue:l*m,S={consumptionKwh:n,totalSolarCoverageKwh:f,directSolarToHomeKwh:u,communitySolarToHomeKwh:g,exportedKwh:l,billedGridImportKwh:d,coveragePct:n>0?$e(f/n*100,0,100):0,selfConsumedPct:r>0?$e(u/r*100,0,100):0,totalSolarValue:k+y.totals.avoidedExceedanceValue+_,selfConsumptionAdvantage:k-C,variableImportCost:d*x};return`
    <section class="analysis-view">
      <div class="section-header analysis-section-header">
        <div>
          <span class="badge">Analysis</span>
          <h2>Charts and Optimization</h2>
          <p class="muted">Deeper electricity analysis for ${Ya(t)}. This page is built from the same 15-minute data and billing settings that drive the dashboard and invoice.</p>
        </div>
        ...
        <div style="overflow-x: auto;">
          <table class="sensor-table">
            ...
            <tbody>
              ${f.map(g=>`
                <tr>
                  <td class="sensor-name">${ys(g.key)}</td>
  ...
  `}const It=[{kw:3,fixedMonthlyFee:7.42},{kw:7,fixedMonthlyFee:12.84},{kw:12,fixedMonthlyFee:19.61},{kw:17,fixedMonthlyFee:26.39},{kw:27,fixedMonthlyFee:39.94},{kw:43,fixedMonthlyFee:61.62},{kw:70,fixedMonthlyFee:98.2},{kw:100,fixedMonthlyFee:138.85},{kw:150,fixedMonthlyFee:206.6,existingContractsOnly:!0},{kw:200,fixedMonthlyFee:274.35,existingContractsOnly:!0}];function Qe(t){if(!t)return null;const e=t.match(/^(\d{4})-(\d{2})-(\d{2})/);if(e){const[,s,o,n]=e;return new Date(Number(s),Number(o)-1,Number(n))}const a=new Date(t);return Number.isNaN(a.getTime())?null:new Date(a.getFullYear(),a.getMonth(),a.getDate())}function At(t){if(!t)return"";const e=t.match(/^(\d{4}-\d{2}-\d{2})/);return e?e[1]:""}function ws(t,e,a,s,o){const n=new Date,r=Qe(s),l=Qe(o);let u=r,f=l;if(!u||!f)switch(t){case"yesterday":{const y=new Date(n);y.setDate(y.getDate()-1),u=new Date(y.getFullYear(),y.getMonth(),y.getDate()),f=new Date(u);break}case"this_week":{const y=new Date(n),$=y.getDay()||7;u=new Date(y.getFullYear(),y.getMonth(),y.getDate()-$+1),f=new Date(n.getFullYear(),n.getMonth(),n.getDate());break}case"last_week":{const y=new Date(n),$=y.getDay()||7,x=new Date(y.getFullYear(),y.getMonth(),y.getDate()-$+1);u=new Date(x.getFullYear(),x.getMonth(),x.getDate()-7),f=new Date(x.getFullYear(),x.getMonth(),x.getDate()-1);break}case"this_month":{u=new Date(n.getFullYear(),n.getMonth(),1),f=new Date(n.getFullYear(),n.getMonth(),n.getDate());break}case"last_month":{u=new Date(n.getFullYear(),n.getMonth()-1,1),f=new Date(n.getFullYear(),n.getMonth(),0);break}case"this_year":{u=new Date(n.getFullYear(),0,1),f=new Date(n.getFullYear(),n.getMonth(),n.getDate());break}case"last_year":{u=new Date(n.getFullYear()-1,0,1),f=new Date(n.getFullYear()-1,11,31);break}case"custom":{u=Qe(e)??new Date(n.getFullYear(),n.getMonth(),n.getDate()),f=Qe(a)??new Date(u);break}default:{u=new Date(n.getFullYear(),n.getMonth(),n.getDate()-1),f=new Date(u);break}}if(f<u){const y=u;u=f,f=y}let d=0,g=0;const h=new Date(u);for(;h<=f;){const y=new Date(h.getFullYear(),h.getMonth()+1,0).getDate();g+=1/y,d+=1,h.setDate(h.getDate()+1)}const m=u.getFullYear()===f.getFullYear()&&u.getMonth()===f.getMonth()&&u.getDate()===1&&f.getDate()===new Date(f.getFullYear(),f.getMonth()+1,0).getDate();return{days:d,factor:g,label:m?"full month":`${d} day${d===1?"":"s"}`}}function $s(t,e){return e==="all"?!0:e==="weekdays"?t>=1&&t<=5:t===0||t===6}function Ht(t){const[e,a]=t.split(":").map(s=>parseInt(s,10)||0);return e*60+a}function aa(t,e,a,s){if(!$s(t.getDay(),e))return!1;const o=t.getHours()*60+t.getMinutes(),n=Ht(a),r=Ht(s);return n===r?!0:n<r?o>=n&&o<r:o>=n||o<r}function bs(t,e){return e.find(a=>aa(t,a.day_group,a.start_time,a.end_time))}function _s(t,e){return e.find(a=>aa(t,a.day_group,a.start_time,a.end_time))}function Nt(t,e,a,s,o,n=[]){var m;const r=new Map;let l=0,u=0,f=0,d=0,g=0;const h=new Map;for(const y of n){const $=Number(y.value)||0;h.set(y.startedAt,(h.get(y.startedAt)??0)+$)}for(const y of t){const $=Number(y.value)||0,x=$*.25,k=h.get(y.startedAt)??0,C=Math.max(0,$-k),_=new Date(y.startedAt);if(Number.isNaN(_.getTime()))continue;const S=bs(_,s),i=_s(_,o),c=(S==null?void 0:S.rate)??e,v=((m=S==null?void 0:S.label)==null?void 0:m.trim())||"Base tariff",b=(i==null?void 0:i.reference_power_kw)??a;l+=x*c,g=Math.max(g,$),d=Math.max(d,C),$>b&&(f+=($-b)*.25),C>b&&(u+=(C-b)*.25);const W=`${v}__${c}`,D=r.get(W);D?D.kwh+=x:r.set(W,{label:v,rate:c,kwh:x})}return{energyCost:l,exceedanceKwh:u,grossExceedanceKwh:f,avoidedExceedanceKwh:Math.max(0,f-u),peakPowerKw:d,grossPeakPowerKw:g,rateBreakdown:Array.from(r.values()).sort((y,$)=>y.label.localeCompare($.label))}}function xs(t){var Ct,St;const e=t.config,a=t.rangeData;if(!e||!a)return`
    ...
    `;const s=a.consumption||0,o=a.production||0,n=a.exported||0,r=Math.max(0,n),l=a.grid_import,u=(a.solar_to_home??a.direct_solar_to_home??a.self_consumed??o)>0,f=l!=null&&!(l<=0&&s>0&&!u),d=Math.max(0,(f?s-l:void 0)??a.solar_to_home??a.direct_solar_to_home??(a.self_consumed&&a.self_consumed>0?a.self_consumed:o-r)),g=Math.min(d,Math.max(0,a.direct_solar_to_home??(a.self_consumed&&a.self_consumed>0?a.self_consumed:o-r))),h=Math.max(0,d-g),m=Math.max(0,l!=null&&!(l<=0&&s>0&&d<=0)?l:s-d),y=a.peak_power_kw||0,$=e.reference_power_kw||5,x=a.exceedance_kwh||0,k=a.gas_energy||0,C=a.gas_volume||0,_=k>0||C>0,S=e.consumption_rate_windows??[],i=e.reference_power_windows??[],c=t.consumptionTimeseries?Nt(t.consumptionTimeseries.items,e.energy_variable_rate,$,S,i,((Ct=t.productionTimeseries)==null?void 0:Ct.items)??[]):null,v=S.length>0&&!!c&&Math.abs(m-s)<.01,b=i.length>0&&!!c,W=c?c.peakPowerKw:y,D=c?c.exceedanceKwh:x,P=At(a.start??t.customStart),N=At(a.end??t.customEnd),{days:V,factor:I,label:O}=ws(t.range,t.customStart,t.customEnd,a.start,a.end),se=e.energy_fixed_fee*I,Q=e.network_metering_rate*I,re=e.network_power_ref_rate*I,j=v?c.energyCost:m*e.energy_variable_rate,le=m*e.network_variable_rate,te=D*e.exceedance_rate,ce=e.meter_monthly_fees??[],Y=ce.reduce((w,A)=>w+(A.fee||0),0)*I,H=m*e.compensation_fund_rate,U=m*e.electricity_tax_rate,ne=Math.max(0,e.domiciliation_discount??0)*I,de=Math.max(0,e.connect_discount??0)*I,Me=se+j+Q+re+le+te+Y+H+U-ne-de,Ce=Me*e.vat_rate,ye=Me+Ce,oe=wt(e),X=$t(e,t.consumptionTimeseries,((St=t.perMeterProductionTimeseries)==null?void 0:St.meters)??null,g,r),pe=oe.filter(w=>isFinite(w.rate)&&w.rate>0),z=oe.length>1,be=X?X.weightedExportRate:pe.length>0?pe.reduce((w,A)=>w+A.rate,0)/pe.length:e.feed_in_tariff,ae=X?X.totalFeedInRevenue:r*be,Ue=z&&oe.length>0?r/oe.length:r,Le=X?X.meters:oe.map(w=>({...w,producedKwh:0,exportedKwh:Ue,revenue:Ue*w.rate,selfConsumedKwh:0,exportEquivalentForSelfUse:0})),_e=!!X,Z=X?X.meters.reduce((w,A)=>w+A.selfConsumedKwh,0):g,Be=e.energy_variable_rate+e.network_variable_rate+e.electricity_tax_rate+e.compensation_fund_rate,qe=Be*(1+e.vat_rate),Pe=Z*Be,Ke=Pe*e.vat_rate,ue=Pe+Ke,Ye=X?X.totalSelfUseExportEquivalent:Z*be,Re=ue-Ye,fe=Math.max(0,(c==null?void 0:c.avoidedExceedanceKwh)??0),Se=fe*e.exceedance_rate,M=Se*e.vat_rate,E=Se+M,F=fe>1e-4,G=ue+E+ae,B=Le.map(w=>{const A=w.selfConsumedKwh*qe,xe=A-w.exportEquivalentForSelfUse;return{...w,selfUseSavings:A,selfUseVsExport:xe,totalTrackedValue:A+w.revenue}}),Te=_e&&B.length>0,ee=ye-ae,he=(e.gas_fixed_fee??6.5)*I,Ee=k*(e.gas_variable_rate??.055),nt=(e.gas_network_fee??4.8)*I,_t=k*(e.gas_network_variable_rate??.012),xt=k*(e.gas_tax_rate??.001),ot=he+Ee+nt+_t+xt,kt=ot*(e.gas_vat_rate??.08),it=ot+kt,K=e.currency||"EUR",T=w=>`${p(w,2)} ${K}`,lt=w=>`${w>0?"+":w<0?"-":""}${p(Math.abs(w),2)} ${K}`,L=w=>p(w,3),Mt=w=>p(w,3),la=w=>w>=0?"comparison-delta-savings":"comparison-delta-extra",ca=Te?`
            ...
            <tr>
              ...
              <td style="text-align: right;">
                ...
                <span class="${la(w.selfUseVsExport)}">${lt(w.selfUseVsExport)}</span> self-use vs export<br/>
      ...
      `:"",da=_e?`Compared with exporting the same ${L(Z)} kWh using the configured PV self-use priority and each system's own feed-in tariff`:`Compared with selling the same ${L(Z)} kWh at ${p(be,4)} ${K}/kWh`,ct=It.find(w=>Math.abs(w.kw-$)<.05),pa=Me-re-te,dt=c?It.map(w=>{var Et;const A=Nt(t.consumptionTimeseries.items,e.energy_variable_rate,w.kw,S,i,((Et=t.productionTimeseries)==null?void 0:Et.items)??[]),xe=w.fixedMonthlyFee*I,ze=A.exceedanceKwh*e.exceedance_rate,Tt=(pa+xe+ze)*(1+e.vat_rate);return{...w,fixedCharge:xe,exceedanceKwh:A.exceedanceKwh,exceedanceCharge:ze,total:Tt,deltaVsCurrent:Tt-ye}}):[],je=dt.reduce((w,A)=>!w||A.total<w.total?A:w,null),ua=w=>Math.abs(w)<.005?"Current total":`${w>0?"+":"-"}${T(Math.abs(w))}`,pt=a.start&&a.end?`${we(a.start)} — ${we(a.end)}`:t.range.replace("_"," ").replace(/\b\w/g,w=>w.toUpperCase()),ha=D>0?`<div class="card exceedance-warning">
        <strong>⚠️ Reference Power Exceeded</strong>
        <p>Peak load: <strong>${p(W,1)} kW</strong> &mdash; ${b?"Reference power windows active":`Reference power level: ${p($,1)} kW`}</p>
        <p>Exceedance volume: <strong>${L(D)} kWh</strong></p>
        <p class="muted">Exceedance charge: ${T(te)}</p>
      </div>`:"",ma=v?c.rateBreakdown.map(w=>`
            <tr>
          ...
          `,ga=b?`Reference power windows active (${i.length})`:`${p($,1)} kW`,va=v?`Time-of-use windows active (${S.length})`:`${p(e.energy_variable_rate,4)} ${K}/kWh`,ya=dt.map(w=>{const A=!!je&&w.kw===je.kw,xe=!!ct&&w.kw===ct.kw,ze=w.deltaVsCurrent<-.005?"comparison-delta-savings":w.deltaVsCurrent>.005?"comparison-delta-extra":"";return`
            <tr class="${A?"reference-power-best-row":""}${xe?" reference-power-current-row":""}">
              ...
              <td class="${ze}" style="text-align: right;">${ua(w.deltaVsCurrent)}</td>
            </tr>
          `}).join(""),fa=dt.length>0?`
    ...
    `,$a=a.start&&a.end?(()=>{const w=new Date(a.start),A=new Date(a.end);return Number.isNaN(w.getTime())||Number.isNaN(A.getTime())?"":`
        <div class="range-info-bar">
    ...
    <section class="invoice-view">
      ...
      <div class="section-header invoice-section-header">
        ...
        <div class="invoice-summary-badges">
          ...
          ${_?`<span class="badge" style="background: rgba(255,160,50,0.12); color: #f5a623;">🔥 ${L(k)} kWh gas (${Mt(C)} m³)</span>`:""}
        </div>
      </div>
      ...
      <div class="card invoice-card">
        <table class="invoice-table">
          ...
          <tbody>
            ...
            <tr>
              <td>Reference power level (${ga}) <span class="muted">(${O})</span></td>
      ...
      <div class="card invoice-footer">
        <p class="muted" style="line-height: var(--lh-relaxed);">
          ...
          Peak load (${p(W,1)} kW) is compared against ${b?"your configured reference power windows":`your reference power level (${p($,1)} kW)`} &mdash;
    ...
    <div class="meter-card">
      ...
      <div class="form-row">
        ...
        <div class="meter-type-checkboxes">
          ...
          <label class="meter-type-cb">
            <input type="checkbox" name="meter_${t}_export" ${e.types.includes("export")?"checked":""} />
  ...
  `}function ra(t){return ks.map(e=>`<option value="${e.value}" ${e.value===t?"selected":""}>${e.label}</option>`).join("")}function Ts(t,e){return`
    <div class="meter-card">
      <div class="meter-header">
  ...
  `}function Ds(t,e="ha",a){if(!t&&e==="ha")return`
        ...
        `}).join(""),g=((t==null?void 0:t.meters)??[]).some(i=>i.types.includes("gas"))||(t==null?void 0:t.meter_has_gas),h=(t==null?void 0:t.consumption_rate_windows)??[],m=(t==null?void 0:t.reference_power_windows)??[],y=(t==null?void 0:t.meters)??[],$=(t==null?void 0:t.meter_monthly_fees)??[];function x(i){return $.find(c=>c.meter_id===i)??{meter_id:i,label:"",fee:0}}const k=y.length===0?'<p class="muted">No meters configured.</p>':y.map((i,c)=>{const v=x(i.id),b=i.id?"…"+i.id.slice(-8):`Meter ${c+1}`;return`
          <div class="meter-fee-card" style="margin-bottom: var(--sp-3); padding: var(--sp-3); border: 1px solid var(--clr-border); border-radius: var(--radius);">
            <div style="display: flex; align-items: center; gap: var(--sp-2); margin-bottom: var(--sp-2);">
              <span>${i.types.map(D=>sa[D]??"").join(" ")}</span>
              <code style="font-size: var(--text-sm);">${b}</code>
    ...
    <div id="consumption-windows-container">
      ${h.length>0?h.map((i,c)=>Ts(c,i)).join(""):'<p class="muted">No time-of-use windows configured. Using the flat supplier rate.</p>'}
    </div>
  ...
  `,_=`
    ...
    <div id="reference-windows-container">
      ${m.length>0?m.map((i,c)=>Es(c,i)).join(""):'<p class="muted">No scheduled reference windows configured. Using one reference power all day.</p>'}
    </div>
    <button type="button" id="add-reference-window-btn" class="btn btn-outline" style="margin-top: var(--sp-3);">
      + Add Reference Window
    </button>
  `,S=Ms.map(i=>{if(i.title==="Gas Billing"&&!g||i.title==="Meter Fees"&&y.length<2)return"";let c;return i.title==="Feed-in / Selling"?c=d:i.title==="Time-of-Use Tariffs"?c=C:i.title==="Reference Power Windows"?c=_:i.title==="Discounts"?c=`<p class="muted" style="margin: 0 0 var(--sp-3) 0; font-size: 0.85rem;">
  ...
  `}const na="leneda_credentials",oa="leneda_theme";function Fs(){try{const t=localStorage.getItem(na);if(t)return JSON.parse(t)}catch{}return null}function mt(t){try{localStorage.setItem(na,JSON.stringify(t))}catch{}}function Ws(){var t;try{const e=localStorage.getItem(oa);if(e==="dark"||e==="light")return e}catch{}return(t=window.matchMedia)!=null&&t.call(window,"(prefers-color-scheme: light)").matches?"light":"dark"}function Ls(t){try{localStorage.setItem(oa,t)}catch{}}function Ot(t){const e=t.match(/^(\d{4})-(\d{2})-(\d{2})$/);if(!e)return null;const[,a,s,o]=e;return new Date(Number(a),Number(s)-1,Number(o))}function Ut(t){const e=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),s=String(t.getDate()).padStart(2,"0");return`${e}-${a}-${s}`}function Ie(t){const e=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),s=String(t.getDate()).padStart(2,"0"),o=String(t.getHours()).padStart(2,"0"),n=String(t.getMinutes()).padStart(2,"0"),r=String(t.getSeconds()).padStart(2,"0"),l=String(t.getMilliseconds()).padStart(3,"0"),u=-t.getTimezoneOffset(),f=u>=0?"+":"-",d=String(Math.floor(Math.abs(u)/60)).padStart(2,"0"),g=String(Math.abs(u)%60).padStart(2,"0");return`${e}-${a}-${s}T${o}:${n}:${r}.${l}${f}${d}:${g}`}function Bt(t,e){return t.getFullYear()===e.getFullYear()&&t.getMonth()===e.getMonth()&&t.getDate()===e.getDate()}function Ps(t,e=new Date){switch(t){case"yesterday":{const a=new Date(e);a.setDate(a.getDate()-1),a.setHours(0,0,0,0);const s=new Date(a);return s.setHours(23,59,59,999),{start:a,end:s}}case"this_week":{const a=new Date(e),s=a.getDay()||7;return a.setDate(a.getDate()-s+1),a.setHours(0,0,0,0),{start:a,end:e}}case"last_week":{const a=new Date(e),s=a.getDay()||7,o=new Date(a);o.setDate(a.getDate()-s),o.setHours(23,59,59,999);const n=new Date(o);return n.setDate(o.getDate()-6),n.setHours(0,0,0,0),{start:n,end:o}}case"this_month":return{start:new Date(e.getFullYear(),e.getMonth(),1),end:e};case"last_month":{const a=new Date(e.getFullYear(),e.getMonth()-1,1),s=new Date(e.getFullYear(),e.getMonth(),0,23,59,59,999);return{start:a,end:s}}case"this_year":return{start:new Date(e.getFullYear(),0,1),end:e};case"last_year":{const a=new Date(e.getFullYear()-1,0,1),s=new Date(e.getFullYear()-1,11,31,23,59,59,999);return{start:a,end:s}}}}function Ks(t,e,a=new Date){const s=Ot(t),o=Ot(e);if(!s||!o)return null;const n=["yesterday","this_week","last_week","this_month","last_month","this_year","last_year"];for(const r of n){const l=Ps(r,a);if(Bt(s,l.start)&&Bt(o,l.end))return r}return null}class Rs{constructor(e){De(this,"root");De(this,"state",{tab:"dashboard",range:"yesterday",customStart:"",customEnd:"",chartViewportStart:null,chartViewportEnd:null,chartUnit:"kwh",chartTimeBucket:"quarter_hour",chartConsumptionView:"grid",analysisHeatmapMetric:"grid",analysisProfileMetric:"house",analysisComparisonMode:"previous",analysisComparison:null,analysisComparisonLoading:!1,rangeData:null,consumptionTimeseries:null,productionTimeseries:null,gridImportTimeseries:null,marketExportTimeseries:null,perMeterProductionTimeseries:null,sensors:null,config:null,loading:!0,error:null,mode:"ha",credentials:null,isMenuOpen:!1,theme:Ws()});De(this,"preZoomRange",null);De(this,"preZoomCustomStart","");De(this,"preZoomCustomEnd","");this.root=e}async mount(){this.applyTheme(),this.render();const e=await Yt();if(this.state.mode=e.mode,e.mode==="standalone"){const a=Fs();if(a&&(this.state.credentials=a),!e.configured&&!a){this.state.tab="settings",this.state.loading=!1,this.state.error=null,this.render();return}if(!e.configured&&a)try{const{saveCredentials:s}=await me(async()=>{const{saveCredentials:o}=await Promise.resolve().then(()=>ke);return{saveCredentials:o}},void 0);await s(a)}catch{}if(!a)try{this.state.credentials=await jt()}catch{}}await this.loadData()}toDisplayError(e,a="Failed to load data"){const s=e instanceof Error?e.message:String(e??"").trim(),o=s.toLowerCase();return o.includes("missing data")||o.includes("no_data")||o.includes("no data")?"Missing data":s||a}clearRangeStateWithError(e,a="Failed to load data"){this.state.rangeData=null,this.state.consumptionTimeseries=null,this.state.productionTimeseries=null,this.state.gridImportTimeseries=null,this.state.marketExportTimeseries=null,this.state.perMeterProductionTimeseries=null,this.clearChartViewport(),this.state.analysisComparison=null,this.state.analysisComparisonLoading=!1,this.state.error=this.toDisplayError(e,a)}async fetchPerMeterProductionForRange(e,a,s){var n;if(((e==null?void 0:e.meters)??[]).filter(r=>r.types.includes("production")).length<=1)return null;try{const r=await gt("1-1:2.29.0",a,s);return(n=r.meters)!=null&&n.length?r:null}catch(r){return console.warn("Per-meter production fetch failed:",r),null}}async fetchEnergyFlowTimeseries(e,a){const[s,o,n,r]=await Promise.all([Ae("1-1:1.29.0",e,a),Ae("1-1:2.29.0",e,a),Ae("1-65:1.29.9",e,a),Ae("1-65:2.29.9",e,a)]);return{consumptionTimeseries:s,productionTimeseries:o,gridImportTimeseries:n,marketExportTimeseries:r}}resetAnalysisComparison(){this.state.analysisComparison=null,this.state.analysisComparisonLoading=!1}clearChartViewport(){this.state.chartViewportStart=null,this.state.chartViewportEnd=null}normalizeChartTimeBucket(){const{start:e,end:a}=this.getDateRangeISO(),s=Wa(yt(e,a),this.state.chartTimeBucket);s!==this.state.chartTimeBucket&&(this.state.chartTimeBucket=s)}getCurrentRangeKey(){const{start:e,end:a}=this.getDateRangeISO();return`${e}|${a}`}shiftIsoByYears(e,a){const s=new Date(e);if(!Number.isFinite(s.getTime()))return e;const o=new Date(s);return o.setUTCFullYear(o.getUTCFullYear()+a),o.toISOString()}getComparisonRangeISO(e,a,s){if(s==="last_year")return{start:this.shiftIsoByYears(e,-1),end:this.shiftIsoByYears(a,-1)};const o=new Date(e).getTime(),n=new Date(a).getTime(),r=Math.max(0,n-o),l=o-1,u=l-r;return{start:new Date(u).toISOString(),end:new Date(l).toISOString()}}async loadAnalysisComparison(e=!1){var l;if(!this.state.consumptionTimeseries||!this.state.productionTimeseries)return;const{start:a,end:s}=this.getDateRangeISO(),o=this.state.analysisComparisonMode,n=`${a}|${s}|${o}`;if(!e&&(this.state.analysisComparisonLoading||((l=this.state.analysisComparison)==null?void 0:l.key)===n))return;const r=this.getComparisonRangeISO(a,s,o);this.state.analysisComparisonLoading=!0,this.state.tab==="charts"&&this.renderPreserveMainScroll();try{const{consumptionTimeseries:u,productionTimeseries:f,gridImportTimeseries:d,marketExportTimeseries:g}=await this.fetchEnergyFlowTimeseries(r.start,r.end);if(n!==this.getCurrentRangeKey())return;this.state.analysisComparison={key:n,mode:o,start:r.start,end:r.end,consumptionTimeseries:u,productionTimeseries:f,gridImportTimeseries:d,marketExportTimeseries:g}}catch(u){console.warn("Comparison data fetch failed:",u),n===this.getCurrentRangeKey()&&(this.state.analysisComparison=null)}finally{n===this.getCurrentRangeKey()&&(this.state.analysisComparisonLoading=!1,this.state.tab==="charts"&&this.renderPreserveMainScroll())}}async loadData(){this.state.loading=!0,this.state.error=null,this.state.rangeData=null,this.clearChartViewport(),this.resetAnalysisComparison(),this.render();try{const[e,a,s]=await Promise.all([et(this.state.range),vt(),He()]),{start:o,end:n}=this.getDateRangeISO(),[r,l]=await Promise.all([this.fetchEnergyFlowTimeseries(o,n),this.fetchPerMeterProductionForRange(s,o,n)]);this.state.rangeData=e,this.state.consumptionTimeseries=r.consumptionTimeseries,this.state.productionTimeseries=r.productionTimeseries,this.state.gridImportTimeseries=r.gridImportTimeseries,this.state.marketExportTimeseries=r.marketExportTimeseries,this.state.perMeterProductionTimeseries=l,this.state.sensors=a,this.state.config=s}catch(e){this.clearRangeStateWithError(e,"Failed to load data")}finally{this.state.loading=!1,this.render(),this.state.tab==="charts"&&this.state.rangeData&&this.loadAnalysisComparison()}}async changeRange(e){if(this.preZoomRange=null,this.clearChartViewport(),this.state.range=e,this.resetAnalysisComparison(),e==="custom"){if(!this.state.customStart||!this.state.customEnd){const a=new Date;a.setDate(a.getDate()-1);const s=new Date(a);s.setDate(s.getDate()-6),this.state.customStart=Ut(s),this.state.customEnd=Ut(a)}this.render();return}this.state.error=null,this.state.loading=!0,this.render();try{const{start:a,end:s}=this.getDateRangeISO(),[o,n,r]=await Promise.all([et(e),this.fetchEnergyFlowTimeseries(a,s),this.fetchPerMeterProductionForRange(this.state.config,a,s)]);this.state.rangeData=o,this.state.consumptionTimeseries=n.consumptionTimeseries,this.state.productionTimeseries=n.productionTimeseries,this.state.gridImportTimeseries=n.gridImportTimeseries,this.state.marketExportTimeseries=n.marketExportTimeseries,this.state.perMeterProductionTimeseries=r}catch(a){this.clearRangeStateWithError(a,"Missing data")}finally{this.state.loading=!1,this.render(),this.state.tab==="charts"&&this.state.rangeData&&this.loadAnalysisComparison()}}async applyCustomRange(){this.preZoomRange=null,this.clearChartViewport();const{customStart:e,customEnd:a}=this.state;if(!(!e||!a)){this.state.error=null,this.state.loading=!0,this.resetAnalysisComparison(),this.render();try{const s=Ks(e,a),o=s?et(s):me(async()=>{const{fetchCustomData:g}=await Promise.resolve().then(()=>ke);return{fetchCustomData:g}},void 0).then(({fetchCustomData:g})=>g(e,a)),n=this.state.config,r=Ie(new Date(e+"T00:00:00")),l=Ie(new Date(a+"T23:59:59.999")),[u,f,d]=await Promise.all([o,this.fetchEnergyFlowTimeseries(r,l),this.fetchPerMeterProductionForRange(n,r,l)]);this.state.rangeData={range:"custom",consumption:u.consumption,production:u.production,exported:u.exported??0,self_consumed:u.self_consumed??0,grid_import:u.grid_import,solar_to_home:u.solar_to_home,direct_solar_to_home:u.direct_solar_to_home,shared:u.shared,shared_with_me:u.shared_with_me,gas_energy:u.gas_energy??0,gas_volume:u.gas_volume??0,peak_power_kw:u.peak_power_kw??0,exceedance_kwh:u.exceedance_kwh??0,metering_point:u.metering_point??"",start:u.start??e,end:u.end??a},this.state.consumptionTimeseries=f.consumptionTimeseries,this.state.productionTimeseries=f.productionTimeseries,this.state.gridImportTimeseries=f.gridImportTimeseries,this.state.marketExportTimeseries=f.marketExportTimeseries,this.state.perMeterProductionTimeseries=d}catch(s){this.clearRangeStateWithError(s,"Missing data")}finally{this.state.loading=!1,this.render(),this.state.tab==="charts"&&this.state.rangeData&&this.loadAnalysisComparison()}}}async shiftChartPeriod(e){const{start:a,end:s}=this.getDateRangeISO(),o=Jt(a,s,this.state.chartTimeBucket,e);o&&await this.handleChartZoomChange(Ie(o.start),Ie(o.end))}changeTab(e){this.state.tab=e,this.render(),(e==="dashboard"||e==="charts")&&!this.state.rangeData&&!this.state.loading&&this.loadData(),e==="charts"&&this.state.rangeData&&this.loadAnalysisComparison(),e==="sensors"&&!this.state.sensors&&vt().then(a=>{this.state.sensors=a,this.render()}),e==="settings"&&!this.state.config&&He().then(a=>{this.state.config=a,this.render()}),this.state.isMenuOpen=!1}toggleMenu(){this.state.isMenuOpen=!this.state.isMenuOpen,this.render()}applyTheme(){document.documentElement.dataset.theme=this.state.theme}setTheme(e){e!==this.state.theme&&(this.state.theme=e,Ls(e),this.applyTheme(),this.render())}toggleTheme(){this.setTheme(this.state.theme==="dark"?"light":"dark")}printInvoice(){var r,l;const e=document.title,s=`Leneda-invoice-${(r=this.state.rangeData)!=null&&r.start&&((l=this.state.rangeData)!=null&&l.end)?`${this.state.rangeData.start.slice(0,10)}_to_${this.state.rangeData.end.slice(0,10)}`:this.state.range}`.replace(/[^a-z0-9_-]+/gi,"-");let o=!1;const n=()=>{o||(o=!0,document.title=e,window.removeEventListener("afterprint",n))};document.title=s,window.addEventListener("afterprint",n,{once:!0}),window.print(),window.setTimeout(n,1e3)}getMainContentScrollTop(){const e=this.root.querySelector(".main-content");return e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}restoreMainContentScrollTop(e){requestAnimationFrame(()=>{const a=this.root.querySelector(".main-content");a?a.scrollTop=e:window.scrollTo({top:e})})}renderPreserveMainScroll(){const e=this.getMainContentScrollTop();this.render(),this.restoreMainContentScrollTop(e)}getDataSourceLabel(){return this.state.mode==="ha"?"Home Assistant":"Standalone"}getHostedDataNoticeHtml(){var e;return(((e=this.state.credentials)==null?void 0:e.proxy_url)??"").trim().length>0,""}render(){var u;const{tab:e,loading:a,error:s,theme:o}=this.state,n=this.getDataSourceLabel(),r=this.getHostedDataNoticeHtml();if(a&&!this.state.rangeData){this.root.innerHTML=`
      ...
      `,this.attachNavListeners(),(u=this.root.querySelector("#retry-btn"))==null||u.addEventListener("click",()=>this.loadData());return}this.state.rangeData&&this.normalizeChartTimeBucket();let l="";switch(e){case"dashboard":l=Ka(this.state);break;case"charts":l=vs(this.state);break;case"sensors":l=fs(this.state.sensors);break;case"invoice":l=xs(this.state);break;case"settings":l=Ds(this.state.config,this.state.mode,this.state.credentials);break}this.root.innerHTML=`
      <div class="app-shell">
