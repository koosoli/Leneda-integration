var Ve=Object.defineProperty;var Ue=(t,e,s)=>e in t?Ve(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var I=(t,e,s)=>Ue(t,typeof e!="symbol"?e+"":e,s);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function s(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(n){if(n.ep)return;n.ep=!0;const r=s(n);fetch(n.href,r)}})();const Ne="modulepreload",He=function(t){return"/leneda-panel/static/"+t},_e={},L=function(e,s,a){let n=Promise.resolve();if(s&&s.length>0){let i=function(v){return Promise.all(v.map(o=>Promise.resolve(o).then(c=>({status:"fulfilled",value:c}),c=>({status:"rejected",reason:c}))))};document.getElementsByTagName("link");const m=document.querySelector("meta[property=csp-nonce]"),f=(m==null?void 0:m.nonce)||(m==null?void 0:m.getAttribute("nonce"));n=i(s.map(v=>{if(v=He(v),v in _e)return;_e[v]=!0;const o=v.endsWith(".css"),c=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${v}"]${c}`))return;const l=document.createElement("link");if(l.rel=o?"stylesheet":Ne,o||(l.as="script"),l.crossOrigin="",l.href=v,f&&l.setAttribute("nonce",f),document.head.appendChild(l),o)return new Promise((g,u)=>{l.addEventListener("load",g),l.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${v}`)))})}))}function r(i){const m=new Event("vite:preloadError",{cancelable:!0});if(m.payload=i,window.dispatchEvent(m),!m.defaultPrevented)throw i}return n.then(i=>{for(const m of i||[])m.status==="rejected"&&r(m.reason);return e().catch(r)})};function je(){var t,e,s,a,n;try{const r=(e=(t=window.parent)==null?void 0:t.document)==null?void 0:e.querySelector("home-assistant");return((n=(a=(s=r==null?void 0:r.hass)==null?void 0:s.auth)==null?void 0:a.data)==null?void 0:n.access_token)??null}catch{return null}}async function R(t,e){const s=je(),a={...e==null?void 0:e.headers,...s?{Authorization:`Bearer ${s}`}:{}},n={...e,credentials:"include",headers:a},r=await fetch(t,n);if(!r.ok)throw new Error(`API ${r.status}: ${r.statusText}`);return r.json()}async function te(t){return R(`/leneda_api/data?range=${t}`)}async function Xe(t,e){return R(`/leneda_api/data/custom?start=${encodeURIComponent(t)}&end=${encodeURIComponent(e)}`)}async function q(t,e,s){let a=`/leneda_api/data/timeseries?obis=${encodeURIComponent(t)}`;return e&&(a+=`&start=${encodeURIComponent(e)}`),s&&(a+=`&end=${encodeURIComponent(s)}`),R(a)}async function Ye(t,e,s){let a=`/leneda_api/data/timeseries/per-meter?obis=${encodeURIComponent(t)}`;return e&&(a+=`&start=${encodeURIComponent(e)}`),s&&(a+=`&end=${encodeURIComponent(s)}`),R(a)}async function se(){return R("/leneda_api/sensors")}async function V(){return R("/leneda_api/config")}async function Ze(t){await R("/leneda_api/config",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})}async function ze(){await R("/leneda_api/config/reset",{method:"POST"})}async function Ce(){try{return await R("/leneda_api/mode")}catch{return{mode:"standalone",configured:!1}}}async function Ee(){return R("/leneda_api/credentials")}async function Be(t){await R("/leneda_api/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})}async function Ke(t){return R("/leneda_api/credentials/test",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})}const P=Object.freeze(Object.defineProperty({__proto__:null,fetchConfig:V,fetchCredentials:Ee,fetchCustomData:Xe,fetchMode:Ce,fetchPerMeterTimeseries:Ye,fetchRangeData:te,fetchSensors:se,fetchTimeseries:q,resetConfig:ze,saveConfig:Ze,saveCredentials:Be,testCredentials:Ke},Symbol.toStringTag,{value:"Module"}));function d(t,e=2){return t==null?"—":t.toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:e})}function we(t){return new Date(t).toLocaleDateString(void 0,{month:"short",day:"numeric"})}function Je(t){return new Date(t).toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}const be=[{id:"yesterday",label:"Yesterday"},{id:"this_week",label:"This Week"},{id:"last_week",label:"Last Week"},{id:"this_month",label:"This Month"},{id:"last_month",label:"Last Month"},{id:"this_year",label:"This Year"},{id:"last_year",label:"Last Year"},{id:"custom",label:"Custom"}];function ke(t){var C;const e=t.rangeData,s=(e==null?void 0:e.consumption)??0,a=(e==null?void 0:e.production)??0,n=(e==null?void 0:e.exported)??0,r=(e==null?void 0:e.self_consumed)??0,i=(e==null?void 0:e.gas_energy)??0,m=(e==null?void 0:e.gas_volume)??0,f=(e==null?void 0:e.peak_power_kw)??0,v=(e==null?void 0:e.shared_with_me)??0,o=Math.min(a,r),c=o+v,l=s,g=Math.max(0,n-((e==null?void 0:e.shared)??0)),u=(e==null?void 0:e.shared)??0,y=l+c,k=y>0?Math.min(100,c/y*100):0,b=Math.max(a,l,g,u,v,o,1),_=(S,D=3,M=11)=>(S>0?D+S/b*(M-D):2).toFixed(1),x=(S,D=.22,M=.94)=>(S>0?D+S/b*(M-D):.12).toFixed(2),E=(S,D=1.35,M=3.2)=>`${(S>0?Math.max(D,M-S/b*(M-D)):M).toFixed(2)}s`,p=(S,D=4,M=7.5)=>(S>0?D+S/b*(M-D):3.5).toFixed(1),h=t.range==="custom"&&t.customStart&&t.customEnd?`${we(t.customStart+"T00:00:00")} — ${we(t.customEnd+"T00:00:00")}`:((C=be.find(S=>S.id===t.range))==null?void 0:C.label)??"Yesterday";return`
      ...
      <div class="stats-grid">
        <div class="stat-card consumption">
          ...
          <div class="stat-body">
            ...
            <div class="stat-value">${d(s)} <span class="stat-unit">kWh</span></div>
          </div>
        </div>
        ...
        <div class="stat-card.export">
          ...
          <div class="stat-body">
            ...
            <div class="stat-value">${d(n)} <span class="stat-unit">kWh</span></div>
          </div>
        </div>
            ...
            <div class="elite-header">
              <div class="glass-module consumption-module">
                <div class="module-info">
                  ...
                  <div class="module-value-row">
                    <span class="module-value highlight-red">${d(s)}</span>
              ...
              <div class="glass-module production-module">
                <div class="module-info">
                  ...
                  <div class="module-value-row">
                    <span class="module-value highlight-green">${d(a)}</span>
                    <span class="module-unit">kWh</span>
                  </div>
                </div>
            ...
            <div class="elite-scene">
              <svg class="elite-main-svg" viewBox="0 0 800 400" fill="none" preserveAspectRatio="xMidYMid meet">
                ...
                <g class="scene-node-label" transform="translate(54, 108)">
                  ...
                  <text x="16" y="38" class="scene-node-value">${d(l+g)} kWh</text>
                </g>
                ...
                <g class="scene-node-label" transform="translate(338, 44)">
                  ...
                  <text x="16" y="36" class="scene-node-value">${d(a)} kWh</text>
                </g>
                ...
                <g class="scene-node-label" transform="translate(600, 108)">
                  ...
                  <text x="16" y="38" class="scene-node-value">${d(u+v)} kWh</text>
                </g>
                ...
                <g class="elite-house" transform="translate(312, 92)">
                  ...
                  <g transform="translate(90, 124)">
                    ...
                    <text text-anchor="middle" y="18" class="house-core-value">${d(k,0)}%</text>
                  </g>
                </g>
            ...
            <div class="flow-legend">
              <div class="flow-legend-item solar">
                ...
                <span class="flow-legend-copy">
                  ...
                  <span>${d(c)} kWh used in the house${v>0?` (${d(o)} direct + ${d(v)} via community)`:""}</span>
                </span>
              </div>
              <div class="flow-legend-item import">
                ...
                <span class="flow-legend-copy">
                  ...
                  <span>${d(l)} kWh bought from the grid</span>
                </span>
              </div>
              <div class="flow-legend-item export">
                ...
                <span class="flow-legend-copy">
                  ...
                  <span>${d(g)} kWh sent back to the market</span>
                </span>
              </div>
              <div class="flow-legend-item community">
                ...
                <span class="flow-legend-copy">
                  ...
                  <span>${d(u)} kWh sent · ${d(v)} kWh received${v>0?" (included in solar to home)":""}</span>
                </span>
              </div>
            </div>
          </div>
        ...
        <div class="metrics-list">
          <div class="metric">
            <div class="metric-header">
              ...
              <span class="metric-value">${d(k,1)}%</span>
            </div>
          ...
          <div class="metric">
            <div class="metric-header">
              ...
              <span class="metric-value">${d(r)} kWh</span>
            </div>
          </div>
          ${f>0?`
          <div class="metric">
            <div class="metric-header">
              ...
              <span class="metric-value">${d(f,2)} kW</span>
            </div>
          </div>
          `:""}
          ...
          <div class="metric">
            <div class="metric-header">
              ...
              <span class="metric-value">${d(i)} kWh</span>
            </div>
          </div>
          <div class="metric">
            <div class="metric-header">
              <span class="metric-label">Gas Volume</span>
              <span class="metric-value">${d(m)} m³</span>
            </div>
          </div>
          `:""}
        </div>
        ...
        <div style="overflow-x: auto;">
          <table class="sensor-table">
            ...
            <tbody>
              ${v.map(c=>`
                <tr>
                  <td class="sensor-name">${Qe(c.key)}</td>
                  <td class="sensor-value" style="text-align: right; color: var(--clr-${o});">${d(c.value)}</td>
                  <td class="sensor-unit">${c.unit}</td>
                  <td class="sensor-peak">${c.peak_timestamp?Je(c.peak_timestamp):'<span style="color: var(--clr-border)">—</span>'}</td>
                </tr>
              `).join("")}
            </tbody>
          </table>
  ...
  `}function tt(t,e,s){const a=new Date,n=(f,v)=>new Date(f,v+1,0).getDate();let r,i;switch(t){case"yesterday":{const f=new Date(a);f.setDate(f.getDate()-1),r=1,i=f;break}case"this_week":{const f=new Date(a),v=f.getDay()||7,o=new Date(f);o.setDate(f.getDate()-v+1),r=Math.max(1,Math.round((a.getTime()-o.getTime())/864e5)+1),i=o;break}case"last_week":{r=7;const f=new Date(a);f.setDate(f.getDate()-7),i=f;break}case"this_month":{r=a.getDate(),i=a;break}case"last_month":{const f=new Date(a.getFullYear(),a.getMonth()-1,1);r=n(f.getFullYear(),f.getMonth()),i=f;break}case"custom":{if(e&&s){const f=new Date(e),v=new Date(s);r=Math.max(1,Math.round((v.getTime()-f.getTime())/864e5)+1),i=f}else r=1,i=a;break}default:r=1,i=a}const m=n(i.getFullYear(),i.getMonth());return{days:r,monthDays:m,factor:r/m}}function st(t,e){return e==="all"?!0:e==="weekdays"?t>=1&&t<=5:t===0||t===6}function xe(t){const[e,s]=t.split(":").map(a=>parseInt(a,10)||0);return e*60+s}function Te(t,e,s,a){if(!st(t.getDay(),e))return!1;const n=t.getHours()*60+t.getMinutes(),r=xe(s),i=xe(a);return r===i?!0:r<i?n>=r&&n<i:n>=r||n<i}function at(t,e){return e.find(s=>Te(t,s.day_group,s.start_time,s.end_time))}function rt(t,e){return e.find(s=>Te(t,s.day_group,s.start_time,s.end_time))}function nt(t,e,s,a,n){var v;const r=new Map;let i=0,m=0,f=0;for(const o of t){const c=Number(o.value)||0,l=c*.25,g=new Date(o.startedAt);if(Number.isNaN(g.getTime()))continue;const u=at(g,a),y=rt(g,n),k=(u==null?void 0:u.rate)??e,b=((v=u==null?void 0:u.label)==null?void 0:v.trim())||"Base tariff",_=(y==null?void 0:y.reference_power_kw)??s;i+=l*k,f=Math.max(f,c),c>_&&(m+=(c-_)*.25);const x=`${b}__${k}`,E=r.get(x);E?E.kwh+=l:r.set(x,{label:b,rate:k,kwh:l})}return{energyCost:i,exceedanceKwh:m,peakPowerKw:f,rateBreakdown:Array.from(r.values()).sort((o,c)=>o.label.localeCompare(c.label))}}function ot(t){const e=t.config,s=t.rangeData;if(!e||!s)return`
      <section class="invoice-view">
        <div class="card">
          <p class="muted">Loading billing configuration…</p>
        </div>
      </section>
    `;const a=s.consumption||0,n=s.production||0,r=s.exported||0,i=s.peak_power_kw||0,m=e.reference_power_kw||5,f=s.exceedance_kwh||0,v=s.gas_energy||0,o=s.gas_volume||0,c=v>0||o>0,l=e.consumption_rate_windows??[],g=e.reference_power_windows??[],u=t.consumptionTimeseries?nt(t.consumptionTimeseries.items,e.energy_variable_rate,m,l,g):null,y=l.length>0&&!!u,k=g.length>0&&!!u,b=k?u.peakPowerKw:i,_=k?u.exceedanceKwh:f,{days:x,monthDays:E,factor:p}=tt(t.range,t.customStart,t.customEnd),h=e.energy_fixed_fee*p,C=e.network_metering_rate*p,S=e.network_power_ref_rate*p,D=x<E?`${x}/${E} days`:"full month",M=y?u.energyCost:a*e.energy_variable_rate,ae=a*e.network_variable_rate,N=_*e.exceedance_rate,H=e.meter_monthly_fees??[],Le=H.reduce((w,W)=>w+(W.fee||0),0)*p,re=a*e.compensation_fund_rate,ne=a*e.electricity_tax_rate,j=Math.max(0,e.connect_discount??0)*p,X=h+M+C+S+ae+N+Le+re+ne-j,oe=X*e.vat_rate,ie=X+oe,Pe=(e.meters??[]).filter(w=>w.types.includes("production")),Fe=e.feed_in_rates??[],F=Pe.map(w=>{const W=Fe.find(U=>U.meter_id===w.id);if(W){const U=W.mode==="sensor"&&W.sensor_value!=null&&isFinite(W.sensor_value),ye=U?W.sensor_value:isFinite(W.tariff)?W.tariff:e.feed_in_tariff,qe=U?`Sensor (${d(ye,4)} ${e.currency??"EUR"}/kWh)`:"Fixed tariff";return{meterId:w.id,shortId:w.id?"…"+w.id.slice(-8):"Meter",rate:ye,label:qe,mode:W.mode}}return{meterId:w.id,shortId:w.id?"…"+w.id.slice(-8):"Meter",rate:e.feed_in_tariff,label:"Fixed tariff",mode:"fixed"}}),Y=F.filter(w=>isFinite(w.rate)&&w.rate>0),le=Y.length>0?Y.reduce((w,W)=>w+W.rate,0)/Y.length:e.feed_in_tariff,G=r*le,A=F.length>1,O=s.self_consumed||0,ce=O*(e.energy_variable_rate+e.network_variable_rate+e.electricity_tax_rate+e.compensation_fund_rate),de=ce*e.vat_rate,Z=ce+de,ue=Z+G,z=ie-G,pe=(e.gas_fixed_fee??6.5)*p,me=v*(e.gas_variable_rate??.055),he=(e.gas_network_fee??4.8)*p,ge=v*(e.gas_network_variable_rate??.012),fe=v*(e.gas_tax_rate??.001),B=pe+me+he+ge+fe,ve=B*(e.gas_vat_rate??.08),K=B+ve,T=e.currency||"EUR",$=w=>`${d(w,2)} ${T}`,J=t.range.replace("_"," ").replace(/\b\w/g,w=>w.toUpperCase()),Ae=_>0?`<div class="card exceedance-warning">
        <strong>⚠️ Reference Power Exceeded</strong>
        <p>Peak: <strong>${d(b,1)} kW</strong> &mdash; ${k?"Scheduled reference windows active":`Reference: ${d(m,1)} kW`}</p>
        <p>Total exceedance energy: <strong>${d(_,2)} kWh</strong></p>
        <p class="muted">Surcharge: ${$(N)}</p>
      </div>`:"",Ie=y?u.rateBreakdown.map(w=>`
            <tr>
              <td>${w.label} (${d(w.kwh)} kWh)</td>
              <td style="text-align: right;">${d(w.rate,4)} ${T}/kWh</td>
              <td style="text-align: right;">${$(w.kwh*w.rate)}</td>
            </tr>
          `).join(""):`
            <tr>
              <td>Variable (${d(a)} kWh)</td>
              <td style="text-align: right;">${d(e.energy_variable_rate,4)} ${T}/kWh</td>
              <td style="text-align: right;">${$(M)}</td>
            </tr>
          `,Ge=k?`Scheduled windows active (${g.length})`:`${d(m,1)} kW`,Oe=y?`Time-of-use windows active (${l.length})`:`${d(e.energy_variable_rate,4)} ${T}/kWh`;return`
    <section class="invoice-view">
      <div class="section-header">
        <h2>Cost Estimate &mdash; ${J}</h2>
        <div style="display: flex; gap: var(--sp-4); flex-wrap: wrap; margin-top: var(--sp-2);">
          <span class="badge" style="background: var(--clr-consumption-muted); color: var(--clr-consumption);">⚡ ${d(a)} kWh consumed</span>
          <span class="badge" style="background: var(--clr-production-muted); color: var(--clr-production);">☀️ ${d(n)} kWh produced</span>
          ${r>0?`<span class="badge" style="background: var(--clr-export-muted); color: var(--clr-export);">📤 ${d(r)} kWh exported</span>`:""}
          ${c?`<span class="badge" style="background: rgba(255,160,50,0.12); color: #f5a623;">🔥 ${d(v)} kWh gas (${d(o)} m³)</span>`:""}
        </div>
      </div>
        ...
        <table class="invoice-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: right;">${d(e.energy_fixed_fee,2)} ${T}/mo</td>
            ...
            <tr>
              ...
              <td style="text-align: right;">${d(e.network_metering_rate,2)} ${T}/mo</td>
              <td style="text-align: right;">${$(C)}</td>
            </tr>
            <tr>
              <td>Power Reference (${Ge}) <span class="muted">(${D})</span></td>
              <td style="text-align: right;">${d(e.network_power_ref_rate,2)} ${T}/mo</td>
              <td style="text-align: right;">${$(S)}</td>
            </tr>
            <tr>
              <td>Variable (${d(a)} kWh)</td>
              <td style="text-align: right;">${d(e.network_variable_rate,4)} ${T}/kWh</td>
              <td style="text-align: right;">${$(ae)}</td>
            </tr>
            <tr class="${_>0?"exceedance-row":""}">
              <td>Exceedance (${d(_,2)} kWh over ref)</td>
              <td style="text-align: right;">${d(e.exceedance_rate,4)} ${T}/kWh</td>
            ...
            <tr>
              ...
              <td style="text-align: right;">${d(w.fee,2)} ${T}/mo</td>
            ...
            <tr>
              ...
              <td style="text-align: right;">${d(e.compensation_fund_rate,4)} ${T}/kWh</td>
              <td style="text-align: right;">${$(re)}</td>
            </tr>
            <tr>
              <td>Electricity Tax</td>
              <td style="text-align: right;">${d(e.electricity_tax_rate,4)} ${T}/kWh</td>
            ...
            <tr>
              ...
              <td style="text-align: right;">-${d(Math.max(0,e.connect_discount??0),2)} ${T}/mo</td>
            ...
            <tr class="revenue-row">
              <td>Exported (${A?w.shortId:d(r)+" kWh"})</td>
              <td style="text-align: right;">${w.label}<br/>${d(w.rate,4)} ${T}/kWh</td>
              <td class="revenue-amount" style="text-align: right;">-${$(A?r/F.length*w.rate:r*w.rate)}</td>
            </tr>
            `).join("")}
            ${A?`
            <tr class="revenue-row">
              <td><em>Total feed-in (${d(r)} kWh, avg rate)</em></td>
              <td style="text-align: right;">${d(le,4)} ${T}/kWh</td>
      ...
      <div class="card invoice-footer">
        <p class="muted" style="line-height: var(--lh-relaxed);">
          ...
          Fixed monthly fees are prorated to the viewed period (${x} of ${E} days = ${d(p*100,1)}%).
          Supplier energy pricing: ${Oe}.
          Peak power (${d(b,1)} kW) is compared against ${k?"your scheduled reference windows":`your reference power (${d(m,1)} kW)`} &mdash; 
          every kWh consumed above the Referenzwert incurs a surcharge of ${d(e.exceedance_rate,4)} ${T}/kWh.
      ...
      <div class="card invoice-card gas-invoice-card">
        ...
        <div style="display: flex; gap: var(--sp-4); flex-wrap: wrap; margin-bottom: var(--sp-4);">
          <span class="badge" style="background: rgba(255,160,50,0.12); color: #f5a623;">🔥 ${d(v)} kWh</span>
          <span class="badge" style="background: rgba(255,160,50,0.12); color: #f5a623;">📐 ${d(o)} m³</span>
        </div>
        <table class="invoice-table">
          <thead>
            <tr>
          ...
          <tbody>
            ...
            <tr>
              <td>Fixed Fee <span class="muted">(${D})</span></td>
              <td style="text-align: right;">${d(e.gas_fixed_fee??6.5,2)} ${T}/mo</td>
              <td style="text-align: right;">${$(pe)}</td>
            </tr>
            <tr>
              <td>Energy (${d(v)} kWh)</td>
              <td style="text-align: right;">${d(e.gas_variable_rate??.055,4)} ${T}/kWh</td>
            ...
            <tr>
              ...
              <td style="text-align: right;">${d(e.gas_network_fee??4.8,2)} ${T}/mo</td>
              <td style="text-align: right;">${$(he)}</td>
            </tr>
            <tr>
              <td>Network Variable (${d(v)} kWh)</td>
              <td style="text-align: right;">${d(e.gas_network_variable_rate??.012,4)} ${T}/kWh</td>
              <td style="text-align: right;">${$(ge)}</td>
            </tr>

            <tr class="section-label"><td colspan="3">Gas Tax</td></tr>
            <tr>
              <td>Gas Tax (${d(v)} kWh)</td>
              <td style="text-align: right;">${d(e.gas_tax_rate??.001,4)} ${T}/kWh</td>
      ...
      <div class="card solar-revenue-card">
        ...
        <table class="invoice-table solar-table">
          ...
          <tbody>
            ...
            <tr>
              <td>Energy not bought (${d(O)} kWh)</td>
              <td style="text-align: right;">${d(e.energy_variable_rate,4)} ${T}/kWh</td>
            ...
            <tr>
              ...
              <td style="text-align: right;">${d(e.electricity_tax_rate+e.compensation_fund_rate,4)} ${T}/kWh</td>
            ...
            ${F.map(w=>`
            <tr>
              <td>Sold to grid ${A?`(${w.shortId})`:`(${d(r)} kWh)`}</td>
              <td style="text-align: right;">${w.label}<br/>${d(w.rate,4)} ${T}/kWh</td>
  ...
  `}function Me(t){return it.map(e=>`<option value="${e.value}" ${e.value===t?"selected":""}>${e.label}</option>`).join("")}function ut(t,e){return`
    <div class="meter-card">
      <div class="meter-header">
  ...
  `}function mt(t,e="ha",s){if(!t&&e==="ha")return`
    ...
    `}const r=p=>p.map(h=>{const C=t?t[h.key]??"":"";return`
      ...
      `}).join(""),i=((t==null?void 0:t.meters)??[]).filter(p=>p.types.includes("production")),m=(t==null?void 0:t.feed_in_rates)??[],f=e==="ha";function v(p){return m.find(h=>h.meter_id===p)??{meter_id:p,mode:"fixed",tariff:(t==null?void 0:t.feed_in_tariff)??.08,sensor_entity:""}}const o=i.length===0?'<p class="muted">No production meters configured — add a meter with Power Production type above.</p>':i.map((p,h)=>{const C=v(p.id),S=p.id?"…"+p.id.slice(-8):`Meter ${h+1}`;return`
        ...
        `}).join(""),c=((t==null?void 0:t.meters)??[]).some(p=>p.types.includes("gas"))||(t==null?void 0:t.meter_has_gas),l=(t==null?void 0:t.consumption_rate_windows)??[],g=(t==null?void 0:t.reference_power_windows)??[],u=(t==null?void 0:t.meters)??[],y=(t==null?void 0:t.meter_monthly_fees)??[];function k(p){return y.find(h=>h.meter_id===p)??{meter_id:p,label:"",fee:0}}const b=u.length===0?'<p class="muted">No meters configured.</p>':u.map((p,h)=>{const C=k(p.id),S=p.id?"…"+p.id.slice(-8):`Meter ${h+1}`;return`
          <div class="meter-fee-card" style="margin-bottom: var(--sp-3); padding: var(--sp-3); border: 1px solid var(--clr-border); border-radius: var(--radius);">
            <div style="display: flex; align-items: center; gap: var(--sp-2); margin-bottom: var(--sp-2);">
              <span>${p.types.map(M=>De[M]??"").join(" ")}</span>
    ...
    <div id="consumption-windows-container">
      ${l.length>0?l.map((p,h)=>ut(h,p)).join(""):'<p class="muted">No time-of-use windows configured. Using the flat supplier rate.</p>'}
    </div>
  ...
  `,x=`
    ...
    <div id="reference-windows-container">
      ${g.length>0?g.map((p,h)=>pt(h,p)).join(""):'<p class="muted">No scheduled reference windows configured. Using one reference power all day.</p>'}
    </div>
    <button type="button" id="add-reference-window-btn" class="btn btn-outline" style="margin-top: var(--sp-3);">
      + Add Reference Window
    </button>
  `,E=lt.map(p=>{if(p.title==="Gas Billing"&&!c||p.title==="Meter Fees"&&u.length<2)return"";let h;return p.title==="Feed-in / Selling"?h=o:p.title==="Time-of-Use Tariffs"?h=_:p.title==="Reference Power Windows"?h=x:p.title==="Discounts"?h=`<p class="muted" style="margin: 0 0 var(--sp-3) 0; font-size: 0.85rem;">
  ...
  `}const We="leneda_credentials",Re="leneda_theme";function ht(){try{const t=localStorage.getItem(We);if(t)return JSON.parse(t)}catch{}return null}function ee(t){try{localStorage.setItem(We,JSON.stringify(t))}catch{}}function gt(){var t;try{const e=localStorage.getItem(Re);if(e==="dark"||e==="light")return e}catch{}return(t=window.matchMedia)!=null&&t.call(window,"(prefers-color-scheme: light)").matches?"light":"dark"}function ft(t){try{localStorage.setItem(Re,t)}catch{}}class vt{constructor(e){I(this,"root");I(this,"state",{tab:"dashboard",range:"yesterday",customStart:"",customEnd:"",chartUnit:"kw",rangeData:null,consumptionTimeseries:null,sensors:null,config:null,loading:!0,error:null,mode:"ha",credentials:null,isMenuOpen:!1,theme:gt()});I(this,"preZoomRange",null);I(this,"preZoomCustomStart","");I(this,"preZoomCustomEnd","");this.root=e}async mount(){this.applyTheme(),this.render();const e=await Ce();if(this.state.mode=e.mode,e.mode==="standalone"){const s=ht();if(s&&(this.state.credentials=s),!e.configured&&!s){this.state.tab="settings",this.state.loading=!1,this.state.error="Please configure your Leneda API credentials in Settings.",this.render();return}if(!e.configured&&s)try{const{saveCredentials:a}=await L(async()=>{const{saveCredentials:n}=await Promise.resolve().then(()=>P);return{saveCredentials:n}},void 0);await a(s)}catch{}if(!s)try{this.state.credentials=await Ee()}catch{}}await this.loadData()}async loadData(){this.state.loading=!0,this.state.error=null,this.render();try{const[e,s,a]=await Promise.all([te(this.state.range),se(),V()]),{start:n,end:r}=this.getDateRangeISO(),i=await q("1-1:1.29.0",n,r);this.state.rangeData=e,this.state.consumptionTimeseries=i,this.state.sensors=s,this.state.config=a}catch(e){this.state.error=e instanceof Error?e.message:"Failed to load data"}finally{this.state.loading=!1,this.render()}}async changeRange(e){if(this.preZoomRange=null,this.state.range=e,e==="custom"){if(!this.state.customStart||!this.state.customEnd){const s=new Date;s.setDate(s.getDate()-1);const a=new Date(s);a.setDate(a.getDate()-6),this.state.customStart=a.toISOString().slice(0,10),this.state.customEnd=s.toISOString().slice(0,10)}this.render();return}this.state.loading=!0,this.render();try{const{start:s,end:a}=this.getDateRangeISO(),[n,r]=await Promise.all([te(e),q("1-1:1.29.0",s,a)]);this.state.rangeData=n,this.state.consumptionTimeseries=r}catch(s){this.state.error=s instanceof Error?s.message:"Failed to load data"}finally{this.state.loading=!1,this.render()}}async applyCustomRange(){this.preZoomRange=null;const{customStart:e,customEnd:s}=this.state;if(!(!e||!s)){this.state.loading=!0,this.render();try{const{fetchCustomData:a}=await L(async()=>{const{fetchCustomData:i}=await Promise.resolve().then(()=>P);return{fetchCustomData:i}},void 0),[n,r]=await Promise.all([a(e,s),q("1-1:1.29.0",new Date(e+"T00:00:00").toISOString(),new Date(s+"T23:59:59.999").toISOString())]);this.state.rangeData={range:"custom",consumption:n.consumption,production:n.production,exported:n.exported??0,self_consumed:n.self_consumed??0,gas_energy:n.gas_energy??0,gas_volume:n.gas_volume??0,peak_power_kw:n.peak_power_kw??0,exceedance_kwh:n.exceedance_kwh??0,metering_point:n.metering_point??""},this.state.consumptionTimeseries=r}catch(a){this.state.error=a instanceof Error?a.message:"Failed to load custom data"}finally{this.state.loading=!1,this.render()}}}changeTab(e){this.state.tab=e,this.render(),e==="sensors"&&!this.state.sensors&&se().then(s=>{this.state.sensors=s,this.render()}),e==="settings"&&!this.state.config&&V().then(s=>{this.state.config=s,this.render()}),this.state.isMenuOpen=!1}toggleMenu(){this.state.isMenuOpen=!this.state.isMenuOpen,this.render()}applyTheme(){document.documentElement.dataset.theme=this.state.theme}setTheme(e){e!==this.state.theme&&(this.state.theme=e,ft(e),this.applyTheme(),this.render())}toggleTheme(){this.setTheme(this.state.theme==="dark"?"light":"dark")}getMainContentScrollTop(){const e=this.root.querySelector(".main-content");return e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}restoreMainContentScrollTop(e){requestAnimationFrame(()=>{const s=this.root.querySelector(".main-content");s?s.scrollTop=e:window.scrollTo({top:e})})}renderPreserveMainScroll(){const e=this.getMainContentScrollTop();this.render(),this.restoreMainContentScrollTop(e)}render(){var i;const{tab:e,loading:s,error:a,theme:n}=this.state;if(s&&!this.state.rangeData){this.root.innerHTML=`
      ...
      `,this.attachNavListeners(),(i=this.root.querySelector("#retry-btn"))==null||i.addEventListener("click",()=>this.loadData());return}let r="";switch(e){case"dashboard":r=ke(this.state);break;case"sensors":r=et(this.state.sensors);break;case"invoice":r=ot(this.state);break;case"settings":r=mt(this.state.config,this.state.mode,this.state.credentials);break}this.root.innerHTML=`
      <div class="app-shell">
    ...
    `,this.attachNavListeners(),this.attachDashboardListeners(),this.attachSettingsListeners()}attachNavListeners(){var e,s;(e=this.root.querySelector(".menu-toggle"))==null||e.addEventListener("click",()=>{this.toggleMenu()}),(s=this.root.querySelector("[data-theme-toggle]"))==null||s.addEventListener("click",()=>{this.toggleTheme()}),this.root.querySelectorAll("[data-tab]").forEach(a=>{a.addEventListener("click",()=>{const n=a.dataset.tab;this.changeTab(n)})})}attachDashboardListeners(e=!1){this.root.querySelectorAll("[data-range]").forEach(i=>{i.addEventListener("click",()=>{const m=i.dataset.range;this.changeRange(m)})});const s=this.root.querySelector("#custom-start"),a=this.root.querySelector("#custom-end");s&&s.addEventListener("change",()=>{this.state.customStart=s.value}),a&&a.addEventListener("change",()=>{this.state.customEnd=a.value});const n=this.root.querySelector("#apply-custom-range");if(n==null||n.addEventListener("click",()=>this.applyCustomRange()),this.root.querySelectorAll("[data-chart-unit]").forEach(i=>{i.addEventListener("click",()=>{const m=i.dataset.chartUnit;m!==this.state.chartUnit&&(this.state.chartUnit=m,this.render())})}),!e){const i=this.root.querySelector("#energy-chart");i&&this.state.rangeData&&this.initChart(i)}const r=this.root.querySelector(".reset-zoom-btn");r==null||r.addEventListener("click",async()=>{const{resetChartZoom:i}=await L(async()=>{const{resetChartZoom:m}=await import("./Charts-CD10JIPH.js");return{resetChartZoom:m}},[]);if(i(),r.style.display="none",this.preZoomRange!==null){const m=this.preZoomRange;this.state.customStart=this.preZoomCustomStart,this.state.customEnd=this.preZoomCustomEnd,this.preZoomRange=null,this.preZoomCustomStart="",this.preZoomCustomEnd="",m==="custom"?(this.state.range="custom",this.applyCustomRange()):this.changeRange(m)}else this.changeRange(this.state.range==="custom"?"yesterday":this.state.range)})}attachSettingsListeners(){var f,v;const e=this.root.querySelector("#credentials-form");if(e){const o=this.root.querySelector("#add-meter-btn");o==null||o.addEventListener("click",()=>{var y,k;const g=new FormData(e),u=c(g);if(u.length<10){u.push({id:"",types:["consumption"]});const b={api_key:g.get("api_key")||((y=this.state.credentials)==null?void 0:y.api_key)||"",energy_id:g.get("energy_id")||((k=this.state.credentials)==null?void 0:k.energy_id)||"",meters:u};this.state.credentials=b,ee(b),this.renderPreserveMainScroll()}}),this.root.querySelectorAll(".remove-meter-btn").forEach(g=>{g.addEventListener("click",()=>{var _,x;const u=parseInt(g.dataset.meter??"0",10),y=new FormData(e),k=c(y);k.splice(u,1);const b={api_key:y.get("api_key")||((_=this.state.credentials)==null?void 0:_.api_key)||"",energy_id:y.get("energy_id")||((x=this.state.credentials)==null?void 0:x.energy_id)||"",meters:k};this.state.credentials=b,ee(b),this.renderPreserveMainScroll()})});const c=g=>{var y,k,b;const u=[];for(let _=0;_<10;_++){const x=g.get(`meter_${_}_id`);if(x===null)break;const E=[];(y=e.querySelector(`[name="meter_${_}_consumption"]`))!=null&&y.checked&&E.push("consumption"),(k=e.querySelector(`[name="meter_${_}_production"]`))!=null&&k.checked&&E.push("production"),(b=e.querySelector(`[name="meter_${_}_gas"]`))!=null&&b.checked&&E.push("gas"),u.push({id:x.trim(),types:E})}return u};e.addEventListener("submit",async g=>{g.preventDefault();const u=new FormData(e),y={api_key:u.get("api_key"),energy_id:u.get("energy_id"),meters:c(u)},k=this.root.querySelector("#creds-status");try{ee(y);const{saveCredentials:b}=await L(async()=>{const{saveCredentials:_}=await Promise.resolve().then(()=>P);return{saveCredentials:_}},void 0);await b(y),k&&(k.innerHTML='<p style="color: var(--clr-production); padding: var(--sp-3) 0;">✓ Credentials saved. Reloading data…</p>'),this.state.credentials=y,this.state.error=null,await this.loadData()}catch(b){k&&(k.innerHTML=`<p style="color: var(--clr-danger); padding: var(--sp-3) 0;">✗ Save failed: ${b instanceof Error?b.message:b}</p>`)}});const l=this.root.querySelector("#test-creds-btn");l==null||l.addEventListener("click",async()=>{const g=new FormData(e),u={api_key:g.get("api_key"),energy_id:g.get("energy_id"),meters:c(g)},y=this.root.querySelector("#creds-status");y&&(y.innerHTML='<p style="color: var(--clr-muted); padding: var(--sp-3) 0;">Testing connection…</p>');try{const{testCredentials:k}=await L(async()=>{const{testCredentials:_}=await Promise.resolve().then(()=>P);return{testCredentials:_}},void 0),b=await k(u);y&&(y.innerHTML=b.success?`<p style="color: var(--clr-production); padding: var(--sp-3) 0;">✓ ${b.message}</p>`:`<p style="color: var(--clr-danger); padding: var(--sp-3) 0;">✗ ${b.message}</p>`)}catch(k){y&&(y.innerHTML=`<p style="color: var(--clr-danger); padding: var(--sp-3) 0;">✗ Test failed: ${k instanceof Error?k.message:k}</p>`)}})}const s=this.root.querySelector("#settings-form");if(!s)return;const a=o=>{const c=[];for(let l=0;l<24;l++){const g=o.get(`consumption_window_${l}_label`),u=o.get(`consumption_window_${l}_day_group`),y=o.get(`consumption_window_${l}_start_time`),k=o.get(`consumption_window_${l}_end_time`),b=o.get(`consumption_window_${l}_rate`);if(g===null&&u===null&&y===null&&k===null&&b===null)break;c.push({label:(g??"").trim()||`Window ${l+1}`,day_group:u??"all",start_time:y??"00:00",end_time:k??"06:00",rate:parseFloat(b??"0")||0})}return c},n=o=>{const c=[];for(let l=0;l<24;l++){const g=o.get(`reference_window_${l}_label`),u=o.get(`reference_window_${l}_day_group`),y=o.get(`reference_window_${l}_start_time`),k=o.get(`reference_window_${l}_end_time`),b=o.get(`reference_window_${l}_reference_power_kw`);if(g===null&&u===null&&y===null&&k===null&&b===null)break;c.push({label:(g??"").trim()||`Reference ${l+1}`,day_group:u??"all",start_time:y??"17:00",end_time:k??"00:00",reference_power_kw:parseFloat(b??"0")||0})}return c},r=()=>{const o=new FormData(s),c={};s.querySelectorAll('input[type="checkbox"]').forEach(_=>{c[_.name]=_.checked});const l=[],g=/^feed_in_rate_(\d+)_(.+)$/,u={},y=[],k=/^meter_fee_(\d+)_(.+)$/,b={};for(const[_,x]of o.entries()){if(_.startsWith("consumption_window_")||_.startsWith("reference_window_"))continue;const E=_.match(g);if(E){const C=E[1],S=E[2];u[C]||(u[C]={}),u[C][S]=x;continue}const p=_.match(k);if(p){const C=p[1],S=p[2];b[C]||(b[C]={}),b[C][S]=x;continue}if(c[_]!==void 0&&typeof c[_]=="boolean")continue;const h=parseFloat(x);c[_]=isNaN(h)?x:h}for(const _ of Object.keys(u).sort()){const x=u[_],E=x.mode??"fixed",p=E==="sensor"?x.fallback_tariff??x.tariff:x.tariff;l.push({meter_id:x.meter_id??"",mode:E,tariff:parseFloat(p??"0.08")||.08,sensor_entity:x.sensor_entity??""})}l.length>0&&(c.feed_in_rates=l);for(const _ of Object.keys(b).sort()){const x=b[_];y.push({meter_id:x.meter_id??"",label:x.label??"",fee:parseFloat(x.fee??"0")||0})}return y.length>0&&(c.meter_monthly_fees=y),c.consumption_rate_windows=a(o),c.reference_power_windows=n(o),c},i=o=>{if(!this.state.config)return;const c=r();o(c),this.state.config={...this.state.config,...c},this.renderPreserveMainScroll()};if((f=this.root.querySelector("#add-consumption-window-btn"))==null||f.addEventListener("click",()=>{i(o=>{var l;const c=Array.isArray(o.consumption_rate_windows)?[...o.consumption_rate_windows]:[];c.push({label:`Window ${c.length+1}`,day_group:"weekdays",start_time:"17:00",end_time:"00:00",rate:((l=this.state.config)==null?void 0:l.energy_variable_rate)??.15}),o.consumption_rate_windows=c})}),this.root.querySelectorAll(".remove-consumption-window-btn").forEach(o=>{o.addEventListener("click",()=>{const c=parseInt(o.dataset.window??"0",10);i(l=>{const g=Array.isArray(l.consumption_rate_windows)?[...l.consumption_rate_windows]:[];g.splice(c,1),l.consumption_rate_windows=g})})}),(v=this.root.querySelector("#add-reference-window-btn"))==null||v.addEventListener("click",()=>{i(o=>{var l;const c=Array.isArray(o.reference_power_windows)?[...o.reference_power_windows]:[];c.push({label:`Reference ${c.length+1}`,day_group:"weekdays",start_time:"17:00",end_time:"00:00",reference_power_kw:((l=this.state.config)==null?void 0:l.reference_power_kw)??5}),o.reference_power_windows=c})}),this.root.querySelectorAll(".remove-reference-window-btn").forEach(o=>{o.addEventListener("click",()=>{const c=parseInt(o.dataset.window??"0",10);i(l=>{const g=Array.isArray(l.reference_power_windows)?[...l.reference_power_windows]:[];g.splice(c,1),l.reference_power_windows=g})})}),s.querySelectorAll('input[type="radio"][name^="feed_in_rate_"][name$="_mode"]').forEach(o=>{o.addEventListener("change",()=>{const c=o.name.match(/feed_in_rate_(\d+)_mode/);if(!c)return;const l=c[1],g=s.querySelector(`.feed-in-fixed-fields[data-rate-idx="${l}"]`),u=s.querySelector(`.feed-in-sensor-fields[data-rate-idx="${l}"]`);g&&(g.style.display=o.value==="fixed"?"":"none"),u&&(u.style.display=o.value==="sensor"?"":"none")})}),this.state.mode==="ha"){const o=this.root.querySelector("#ha-entity-list");o&&fetch("/api/leneda/ha-entities").then(c=>c.ok?c.json():Promise.resolve({entities:[]})).then(({entities:c})=>{o.innerHTML=c.map(l=>`<option value="${l}"></option>`).join("")}).catch(()=>{})}s.addEventListener("submit",async o=>{o.preventDefault();const c=r();try{const{saveConfig:l}=await L(async()=>{const{saveConfig:g}=await Promise.resolve().then(()=>P);return{saveConfig:g}},void 0);await l(c),this.state.config=await V(),this.render()}catch(l){alert("Failed to save: "+(l instanceof Error?l.message:l))}});const m=this.root.querySelector("#reset-config-btn");m==null||m.addEventListener("click",async()=>{if(confirm("Reset all billing rates to defaults?"))try{const{resetConfig:o}=await L(async()=>{const{resetConfig:c}=await Promise.resolve().then(()=>P);return{resetConfig:c}},void 0);await o(),this.state.config=await V(),this.render()}catch(o){alert("Failed to reset: "+(o instanceof Error?o.message:o))}})}async initChart(e){var s,a;try{const{renderEnergyChart:n}=await L(async()=>{const{renderEnergyChart:u}=await import("./Charts-CD10JIPH.js");return{renderEnergyChart:u}},[]),{fetchTimeseries:r,fetchPerMeterTimeseries:i}=await L(async()=>{const{fetchTimeseries:u,fetchPerMeterTimeseries:y}=await Promise.resolve().then(()=>P);return{fetchTimeseries:u,fetchPerMeterTimeseries:y}},void 0),{start:m,end:f}=this.getDateRangeISO(),[v,o]=await Promise.all([r("1-1:1.29.0",m,f),r("1-1:2.29.0",m,f)]),c=((s=this.state.config)==null?void 0:s.reference_power_kw)??0,l=(((a=this.state.config)==null?void 0:a.meters)??[]).filter(u=>u.types.includes("production"));let g;if(l.length>1)try{const u=await i("1-1:2.29.0",m,f);u.meters&&u.meters.length>1&&(g=u.meters)}catch(u){console.warn("Per-meter timeseries fetch failed, using merged view:",u)}n(e,v,o,{unit:this.state.chartUnit,referencePowerKw:c,perMeterProduction:g,onZoomChange:(u,y)=>{this.handleChartZoomChange(u,y)}})}catch(n){console.error("Chart init failed:",n)}}async handleChartZoomChange(e,s){try{this.preZoomRange===null&&(this.preZoomRange=this.state.range,this.preZoomCustomStart=this.state.customStart,this.preZoomCustomEnd=this.state.customEnd);const{fetchCustomData:a}=await L(async()=>{const{fetchCustomData:f}=await Promise.resolve().then(()=>P);return{fetchCustomData:f}},void 0),n=e.slice(0,10),r=s.slice(0,10),i=await a(n,r),m=await q("1-1:1.29.0",new Date(n+"T00:00:00").toISOString(),new Date(r+"T23:59:59.999").toISOString());this.state.range="custom",this.state.customStart=n,this.state.customEnd=r,this.state.rangeData={range:"custom",consumption:i.consumption,production:i.production,exported:i.exported??0,self_consumed:i.self_consumed??0,gas_energy:i.gas_energy??0,gas_volume:i.gas_volume??0,peak_power_kw:i.peak_power_kw??0,exceedance_kwh:i.exceedance_kwh??0,metering_point:i.metering_point??""},this.state.consumptionTimeseries=m,this.renderDashboardPartial()}catch(a){console.error("Zoom data fetch failed:",a)}}renderDashboardPartial(){var x,E;const e=this.root.querySelector(".dashboard");if(!e||!this.state.rangeData)return;const s=document.createElement("div");s.innerHTML=ke(this.state);const a=s.querySelector(".dashboard");if(!a)return;const n=e.querySelector(".range-selector"),r=a.querySelector(".range-selector");n&&r&&n.replaceWith(r);const i=e.querySelector(".custom-range-picker"),m=a.querySelector(".custom-range-picker");i&&m?i.replaceWith(m):!i&&m?(x=e.querySelector(".range-selector"))==null||x.insertAdjacentElement("afterend",m):i&&!m&&i.remove();const f=e.querySelector(".stats-grid"),v=a.querySelector(".stats-grid");f&&v&&f.replaceWith(v);const o=e.querySelector(".flow-card"),c=a.querySelector(".flow-card");o&&c&&o.replaceWith(c);const l=e.querySelector(".metrics-card"),g=a.querySelector(".metrics-card");l&&g&&l.replaceWith(g);const u=e.querySelector(".chart-header .card-title"),y=a.querySelector(".chart-header .card-title");u&&y&&u.replaceWith(y);const k=e.querySelector(".reset-zoom-btn");k&&(k.style.display=""),e.querySelectorAll("[data-range]").forEach(p=>{p.addEventListener("click",()=>{this.changeRange(p.dataset.range)})});const b=e.querySelector("#custom-start"),_=e.querySelector("#custom-end");b&&b.addEventListener("change",()=>{this.state.customStart=b.value}),_&&_.addEventListener("change",()=>{this.state.customEnd=_.value}),(E=e.querySelector("#apply-custom-range"))==null||E.addEventListener("click",()=>{this.preZoomRange=null,this.applyCustomRange()})}getDateRangeISO(){const e=new Date,s=a=>a.toISOString();switch(this.state.range){case"custom":{const a=new Date(this.state.customStart+"T00:00:00"),n=new Date(this.state.customEnd+"T23:59:59.999");return{start:s(a),end:s(n)}}case"yesterday":{const a=new Date(e);a.setDate(a.getDate()-1),a.setHours(0,0,0,0);const n=new Date(a);return n.setHours(23,59,59,999),{start:s(a),end:s(n)}}case"this_week":{const a=new Date(e),n=a.getDay()||7;return a.setDate(a.getDate()-n+1),a.setHours(0,0,0,0),{start:s(a),end:s(e)}}case"last_week":{const a=new Date(e),n=a.getDay()||7,r=new Date(a);r.setDate(a.getDate()-n),r.setHours(23,59,59,999);const i=new Date(r);return i.setDate(r.getDate()-6),i.setHours(0,0,0,0),{start:s(i),end:s(r)}}case"this_month":{const a=new Date(e.getFullYear(),e.getMonth(),1);return{start:s(a),end:s(e)}}case"last_month":{const a=new Date(e.getFullYear(),e.getMonth()-1,1),n=new Date(e.getFullYear(),e.getMonth(),0,23,59,59,999);return{start:s(a),end:s(n)}}case"this_year":{const a=new Date(e.getFullYear(),0,1);return{start:s(a),end:s(e)}}case"last_year":{const a=new Date(e.getFullYear()-1,0,1),n=new Date(e.getFullYear()-1,11,31,23,59,59,999);return{start:s(a),end:s(n)}}default:{const a=new Date(e);a.setDate(a.getDate()-1),a.setHours(0,0,0,0);const n=new Date(a);return n.setHours(23,59,59,999),{start:s(a),end:s(n)}}}}}if(window.self===window.top&&window.location.pathname.startsWith("/leneda-panel/"))window.location.href="/leneda";else{const t=document.getElementById("app");t&&new vt(t).mount()}
