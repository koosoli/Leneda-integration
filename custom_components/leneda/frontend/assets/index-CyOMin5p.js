var pt=Object.defineProperty;var mt=(t,e,s)=>e in t?pt(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var K=(t,e,s)=>mt(t,typeof e!="symbol"?e+"":e,s);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&a(o)}).observe(document,{childList:!0,subtree:!0});function s(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(n){if(n.ep)return;n.ep=!0;const r=s(n);fetch(n.href,r)}})();const ht="modulepreload",gt=function(t){return"/leneda-panel/static/"+t},Fe={},V=function(e,s,a){let n=Promise.resolve();if(s&&s.length>0){let o=function(f){return Promise.all(f.map(d=>Promise.resolve(d).then(g=>({status:"fulfilled",value:g}),g=>({status:"rejected",reason:g}))))};document.getElementsByTagName("link");const u=document.querySelector("meta[property=csp-nonce]"),m=(u==null?void 0:u.nonce)||(u==null?void 0:u.getAttribute("nonce"));n=o(s.map(f=>{if(f=gt(f),f in Fe)return;Fe[f]=!0;const d=f.endsWith(".css"),g=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${f}"]${g}`))return;const i=document.createElement("link");if(i.rel=d?"stylesheet":ht,d||(i.as="script"),i.crossOrigin="",i.href=f,m&&i.setAttribute("nonce",m),document.head.appendChild(i),d)return new Promise((y,c)=>{i.addEventListener("load",y),i.addEventListener("error",()=>c(new Error(`Unable to preload CSS for ${f}`)))})}))}function r(o){const u=new Event("vite:preloadError",{cancelable:!0});if(u.payload=o,window.dispatchEvent(u),!u.defaultPrevented)throw o}return n.then(o=>{for(const u of o||[])u.status==="rejected"&&r(u.reason);return e().catch(r)})};function Ue(t){return{api_key:(t.api_key??"").trim(),energy_id:(t.energy_id??"").trim(),meters:(t.meters??[]).map(e=>({...e,id:(e.id??"").trim()}))}}function ft(){var t,e,s,a,n;try{const r=(e=(t=window.parent)==null?void 0:t.document)==null?void 0:e.querySelector("home-assistant");return((n=(a=(s=r==null?void 0:r.hass)==null?void 0:s.auth)==null?void 0:a.data)==null?void 0:n.access_token)??null}catch{return null}}async function F(t,e){const s=ft(),a={...e==null?void 0:e.headers,...s?{Authorization:`Bearer ${s}`}:{}},n={...e,credentials:"include",headers:a},r=await fetch(t,n);if(!r.ok){const o=r.headers.get("content-type")??"";let u="",m="";if(o.includes("application/json")){const f=await r.json().catch(()=>null);u=String((f==null?void 0:f.error)??"").trim(),m=String((f==null?void 0:f.message)??(f==null?void 0:f.error)??"").trim()}else m=(await r.text().catch(()=>"")).trim();throw u==="missing_data"||u==="no_data"||r.status===503?new Error("Missing data"):new Error(m?`API ${r.status}: ${m}`:`API ${r.status}: ${r.statusText}`)}return r.json()}async function le(t){return F(`/leneda_api/data?range=${t}`)}async function vt(t,e){return F(`/leneda_api/data/custom?start=${encodeURIComponent(t)}&end=${encodeURIComponent(e)}`)}async function O(t,e,s){let a=`/leneda_api/data/timeseries?obis=${encodeURIComponent(t)}`;return e&&(a+=`&start=${encodeURIComponent(e)}`),s&&(a+=`&end=${encodeURIComponent(s)}`),F(a)}async function yt(t,e,s){let a=`/leneda_api/data/timeseries/per-meter?obis=${encodeURIComponent(t)}`;return e&&(a+=`&start=${encodeURIComponent(e)}`),s&&(a+=`&end=${encodeURIComponent(s)}`),F(a)}async function _e(){return F("/leneda_api/sensors")}async function ae(){return F("/leneda_api/config")}async function _t(t){await F("/leneda_api/config",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})}async function wt(){await F("/leneda_api/config/reset",{method:"POST"})}async function je(){try{return await F("/leneda_api/mode")}catch{return{mode:"standalone",configured:!1}}}async function Xe(){return F("/leneda_api/credentials")}async function bt(t){const e=Ue(t);await F("/leneda_api/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})}async function $t(t){const e=Ue(t);return F("/leneda_api/credentials/test",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})}async function ze(){return F("/leneda_api/ha-entities")}const Y=Object.freeze(Object.defineProperty({__proto__:null,fetchConfig:ae,fetchCredentials:Xe,fetchCustomData:vt,fetchHAEntities:ze,fetchMode:je,fetchPerMeterTimeseries:yt,fetchRangeData:le,fetchSensors:_e,fetchTimeseries:O,resetConfig:wt,saveConfig:_t,saveCredentials:bt,testCredentials:$t},Symbol.toStringTag,{value:"Module"}));function l(t,e=2){return t==null?"—":t.toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:e})}function B(t){return new Date(t).toLocaleDateString(void 0,{month:"short",day:"numeric"})}function kt(t){return new Date(t).toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}const we=[{id:"yesterday",label:"Yesterday"},{id:"this_week",label:"This Week"},{id:"last_week",label:"Last Week"},{id:"this_month",label:"This Month"},{id:"last_month",label:"Last Month"},{id:"this_year",label:"This Year"},{id:"last_year",label:"Last Year"},{id:"custom",label:"Custom"}];function Ie(t){var H;const e=t.rangeData,s=S=>{if(!S)return"";const E=S.match(/^(\d{4}-\d{2}-\d{2})/);return E?E[1]:""},a=(e==null?void 0:e.consumption)??0,n=(e==null?void 0:e.production)??0,r=(e==null?void 0:e.exported)??0,o=(e==null?void 0:e.self_consumed)??0,u=(e==null?void 0:e.gas_energy)??0,m=(e==null?void 0:e.gas_volume)??0,f=(e==null?void 0:e.peak_power_kw)??0,d=s(e==null?void 0:e.start),g=s(e==null?void 0:e.end),i=(e==null?void 0:e.shared_with_me)??0,y=(e==null?void 0:e.shared)??0,c=Math.max(0,r),_=Math.max(0,(e==null?void 0:e.solar_to_home)??(e==null?void 0:e.direct_solar_to_home)??(o>0?o:n-c)),b=Math.max(0,(e==null?void 0:e.direct_solar_to_home)??_),w=_,x=Math.max(0,(e==null?void 0:e.grid_import)??a-_),k=a>0?a:x+_,D=k>0?Math.min(100,_/k*100):0,v=Math.max(n,x,c,y,i,b,1),h=(S,E=2.8,M=8.2)=>S>0?E+S/v*(M-E):1.8,C=S=>h(S)+1.4,L=S=>h(S)+5.4,P=(S,E=.28,M=.88)=>S>0?E+S/v*(M-E):.1,W=(S,E=.09,M=.22)=>S>0?E+S/v*(M-E):.05,I=(S,E=1.6,M=3.9)=>`${(S>0?Math.max(E,M-S/v*(M-E)):M).toFixed(2)}s`,J=(S,E=3.4,M=5.8)=>S>0?E+S/v*(M-E):3,G=S=>S>0?Math.max(18,Math.round(S/v*100)):0,q=S=>{const{path:E,value:M,gradientId:Q,colorVar:Z,filterId:U,particleClass:N,direction:ee="forward"}=S,ne=ee==="reverse"?"1;0":"0;1";return`
      <path
        class="flow-halo ${N}"
        d="${E}"
        stroke="url(#${Q})"
        stroke-width="${L(M).toFixed(1)}"
        stroke-opacity="${W(M).toFixed(2)}"
      ...
      <path
        ...
        d="${E}"
        stroke="url(#${Q})"
        stroke-width="${h(M).toFixed(1)}"
        stroke-opacity="${P(M).toFixed(2)}"
        stroke-linecap="round"
        fill="none"
      />
      ${M>0?`
        <circle
          ...
          filter="url(#${U})"
        >
          <animateMotion dur="${I(M)}" repeatCount="indefinite" path="${E}" keyPoints="${ne}" keyTimes="0;1" calcMode="linear" />
        </circle>
        <circle
          class="flow-particle flow-particle-secondary ${N}"
          r="${Math.max(2.4,J(M)-1.2).toFixed(1)}"
          fill="${Z}"
          fill-opacity="0.75"
          filter="url(#${U})"
        >
          <animateMotion dur="${I(M)}" begin="-${(parseFloat(I(M))/2).toFixed(2)}s" repeatCount="indefinite" path="${E}" keyPoints="${ne}" keyTimes="0;1" calcMode="linear" />
        </circle>
      `:""}
    `},re=e!=null&&e.start&&(e!=null&&e.end)?`${B(e.start)} — ${B(e.end)}`:t.range==="custom"&&t.customStart&&t.customEnd?`${B(t.customStart+"T00:00:00")} — ${B(t.customEnd+"T00:00:00")}`:((H=we.find(S=>S.id===t.range))==null?void 0:H.label)??"Yesterday";return`
      ...
      <div class="stats-grid">
        ...
        <div class="stat-card.self-consumed">
          ...
          <div class="stat-body">
            ...
            <div class="stat-value">${l(w)} <span class="stat-unit">kWh</span></div>
          </div>
        </div>
      </div>
          ...
          <div class="leneda-elite-flow">
              ...
              <svg class="elite-main-svg" viewBox="0 0 800 400" fill="none" preserveAspectRatio="xMidYMid meet">
                ...
                <g class="elite-house" transform="translate(312, 92)">
                  ...
                  <g transform="translate(90, 124)">
                    ...
                    <text text-anchor="middle" y="18" class="house-core-value">${l(D,0)}%</text>
                  </g>
                </g>

                ${q({path:"M 560 98 C 520 102 474 130 434 182",value:b,gradientId:"flow-solar",colorVar:"var(--clr-production)",filterId:"glow-green",particleClass:"flow-solar"})}
            ...
            <div class="mobile-flow-summary">
              <div class="mobile-flow-house">
                ...
                <strong class="mobile-flow-house-value">${l(k)} kWh supplied</strong>
                <span class="mobile-flow-house-meta">
                  ${l(D,0)}% solar supplied${f>0?` · Peak ${l(f,2)} kW`:""}
                </span>
              </div>
              ...
              <div class="mobile-flow-list">
                <div class="mobile-flow-item solar">
                  <div class="mobile-flow-item-top">
                    ...
                    <strong>${l(_)} kWh</strong>
                  </div>
                  <div class="mobile-flow-bar"><span style="width: ${G(_)}%;"></span></div>
            ...
            <div class="flow-legend">
              <div class="flow-legend-item solar">
                ...
                <span class="flow-legend-copy">
                  ...
                  <span>${l(_)} kWh used in the house</span>
                </span>
              </div>
        ...
        <div class="metrics-list">
          <div class="metric">
            <div class="metric-header">
              ...
              <span class="metric-value">${l(D,1)}%</span>
            </div>
          ...
          <div class="metric">
            <div class="metric-header">
              ...
              <span class="metric-value">${l(w)} kWh</span>
            </div>
          </div>
          ${f>0?`
          <div class="metric">
          ...
          <div class="metric">
            <div class="metric-header">
              ...
              <span class="metric-value">${l(u)} kWh</span>
            </div>
          </div>
          <div class="metric">
            <div class="metric-header">
        ...
        <div style="overflow-x: auto;">
          <table class="sensor-table">
            ...
            <tbody>
              ${f.map(g=>`
                <tr>
                  <td class="sensor-name">${xt(g.key)}</td>
                  <td class="sensor-value" style="text-align: right; color: var(--clr-${d});">${l(g.value)}</td>
                  <td class="sensor-unit">${g.unit}</td>
                  <td class="sensor-peak">${g.peak_timestamp?kt(g.peak_timestamp):'<span style="color: var(--clr-border)">—</span>'}</td>
                </tr>
              `).join("")}
            </tbody>
          </table>
  ...
  `}const Ve=[{kw:3,fixedMonthlyFee:7.42},{kw:7,fixedMonthlyFee:12.84},{kw:12,fixedMonthlyFee:19.61},{kw:17,fixedMonthlyFee:26.39},{kw:27,fixedMonthlyFee:39.94},{kw:43,fixedMonthlyFee:61.62},{kw:70,fixedMonthlyFee:98.2},{kw:100,fixedMonthlyFee:138.85},{kw:150,fixedMonthlyFee:206.6,existingContractsOnly:!0},{kw:200,fixedMonthlyFee:274.35,existingContractsOnly:!0}];function ie(t){if(!t)return null;const e=t.match(/^(\d{4})-(\d{2})-(\d{2})/);if(e){const[,a,n,r]=e;return new Date(Number(a),Number(n)-1,Number(r))}const s=new Date(t);return Number.isNaN(s.getTime())?null:new Date(s.getFullYear(),s.getMonth(),s.getDate())}function Oe(t){if(!t)return"";const e=t.match(/^(\d{4}-\d{2}-\d{2})/);return e?e[1]:""}function Dt(t,e,s,a,n){const r=new Date,o=ie(a),u=ie(n);let m=o,f=u;if(!m||!f)switch(t){case"yesterday":{const c=new Date(r);c.setDate(c.getDate()-1),m=new Date(c.getFullYear(),c.getMonth(),c.getDate()),f=new Date(m);break}case"this_week":{const c=new Date(r),_=c.getDay()||7;m=new Date(c.getFullYear(),c.getMonth(),c.getDate()-_+1),f=new Date(r.getFullYear(),r.getMonth(),r.getDate());break}case"last_week":{const c=new Date(r),_=c.getDay()||7,b=new Date(c.getFullYear(),c.getMonth(),c.getDate()-_+1);m=new Date(b.getFullYear(),b.getMonth(),b.getDate()-7),f=new Date(b.getFullYear(),b.getMonth(),b.getDate()-1);break}case"this_month":{m=new Date(r.getFullYear(),r.getMonth(),1),f=new Date(r.getFullYear(),r.getMonth(),r.getDate());break}case"last_month":{m=new Date(r.getFullYear(),r.getMonth()-1,1),f=new Date(r.getFullYear(),r.getMonth(),0);break}case"this_year":{m=new Date(r.getFullYear(),0,1),f=new Date(r.getFullYear(),r.getMonth(),r.getDate());break}case"last_year":{m=new Date(r.getFullYear()-1,0,1),f=new Date(r.getFullYear()-1,11,31);break}case"custom":{m=ie(e)??new Date(r.getFullYear(),r.getMonth(),r.getDate()),f=ie(s)??new Date(m);break}default:{m=new Date(r.getFullYear(),r.getMonth(),r.getDate()-1),f=new Date(m);break}}if(f<m){const c=m;m=f,f=c}let d=0,g=0;const i=new Date(m);for(;i<=f;){const c=new Date(i.getFullYear(),i.getMonth()+1,0).getDate();g+=1/c,d+=1,i.setDate(i.getDate()+1)}const y=m.getFullYear()===f.getFullYear()&&m.getMonth()===f.getMonth()&&m.getDate()===1&&f.getDate()===new Date(f.getFullYear(),f.getMonth()+1,0).getDate();return{days:d,factor:g,label:y?"full month":`${d} day${d===1?"":"s"}`}}function Ct(t,e){return e==="all"?!0:e==="weekdays"?t>=1&&t<=5:t===0||t===6}function Ge(t){const[e,s]=t.split(":").map(a=>parseInt(a,10)||0);return e*60+s}function Ze(t,e,s,a){if(!Ct(t.getDay(),e))return!1;const n=t.getHours()*60+t.getMinutes(),r=Ge(s),o=Ge(a);return r===o?!0:r<o?n>=r&&n<o:n>=r||n<o}function Et(t,e){return e.find(s=>Ze(t,s.day_group,s.start_time,s.end_time))}function Mt(t,e){return e.find(s=>Ze(t,s.day_group,s.start_time,s.end_time))}function qe(t,e,s,a,n,r=[]){var g;const o=new Map;let u=0,m=0,f=0;const d=new Map;for(const i of r){const y=Number(i.value)||0;d.set(i.startedAt,(d.get(i.startedAt)??0)+y)}for(const i of t){const y=Number(i.value)||0,c=y*.25,_=d.get(i.startedAt)??0,b=Math.max(0,y-_),w=new Date(i.startedAt);if(Number.isNaN(w.getTime()))continue;const x=Et(w,a),k=Mt(w,n),D=(x==null?void 0:x.rate)??e,v=((g=x==null?void 0:x.label)==null?void 0:g.trim())||"Base tariff",h=(k==null?void 0:k.reference_power_kw)??s;u+=c*D,f=Math.max(f,b),b>h&&(m+=(b-h)*.25);const C=`${v}__${D}`,L=o.get(C);L?L.kwh+=c:o.set(C,{label:v,rate:D,kwh:c})}return{energyCost:u,exceedanceKwh:m,peakPowerKw:f,rateBreakdown:Array.from(o.values()).sort((i,y)=>i.label.localeCompare(y.label))}}function Tt(t){var We;const e=t.config,s=t.rangeData;if(!e||!s)return`
      <section class="invoice-view">
        <div class="card">
          <p class="muted">Loading billing configuration…</p>
        </div>
      </section>
    `;const a=s.consumption||0,n=s.production||0,r=s.exported||0,o=Math.max(0,r),u=Math.max(0,s.solar_to_home??s.direct_solar_to_home??(s.self_consumed&&s.self_consumed>0?s.self_consumed:n-o)),m=Math.max(0,s.grid_import??a-u),f=s.peak_power_kw||0,d=e.reference_power_kw||5,g=s.exceedance_kwh||0,i=s.gas_energy||0,y=s.gas_volume||0,c=i>0||y>0,_=e.consumption_rate_windows??[],b=e.reference_power_windows??[],w=t.consumptionTimeseries?qe(t.consumptionTimeseries.items,e.energy_variable_rate,d,_,b,((We=t.productionTimeseries)==null?void 0:We.items)??[]):null,x=_.length>0&&!!w&&Math.abs(m-a)<.01,k=b.length>0&&!!w,D=w?w.peakPowerKw:f,v=w?w.exceedanceKwh:g,h=Oe(s.start??t.customStart),C=Oe(s.end??t.customEnd),{days:L,factor:P,label:W}=Dt(t.range,t.customStart,t.customEnd,s.start,s.end),I=e.energy_fixed_fee*P,J=e.network_metering_rate*P,G=e.network_power_ref_rate*P,q=x?w.energyCost:m*e.energy_variable_rate,re=m*e.network_variable_rate,H=v*e.exceedance_rate,S=e.meter_monthly_fees??[],E=S.reduce((p,R)=>p+(R.fee||0),0)*P,M=m*e.compensation_fund_rate,Q=m*e.electricity_tax_rate,Z=Math.max(0,e.connect_discount??0)*P,U=I+q+J+G+re+H+E+M+Q-Z,N=U*e.vat_rate,ee=U+N,ne=(e.meters??[]).filter(p=>p.types.includes("production")),et=e.feed_in_rates??[],j=ne.map(p=>{const R=et.find(A=>A.meter_id===p.id);if(R){const A=R.mode==="sensor"&&R.sensor_value!=null&&isFinite(R.sensor_value),z=A?R.sensor_value:isFinite(R.tariff)?R.tariff:e.feed_in_tariff,Re=A?`Sensor (${l(z,4)} ${e.currency??"EUR"}/kWh)`:"Fixed tariff";return{meterId:p.id,shortId:p.id?"…"+p.id.slice(-8):"Meter",rate:z,label:Re,mode:R.mode}}return{meterId:p.id,shortId:p.id?"…"+p.id.slice(-8):"Meter",rate:e.feed_in_tariff,label:"Fixed tariff",mode:"fixed"}}),ce=j.filter(p=>isFinite(p.rate)&&p.rate>0),be=ce.length>0?ce.reduce((p,R)=>p+R.rate,0)/ce.length:e.feed_in_tariff,te=o*be,X=j.length>1,se=u,$e=se*(e.energy_variable_rate+e.network_variable_rate+e.electricity_tax_rate+e.compensation_fund_rate),ke=$e*e.vat_rate,de=$e+ke,xe=de+te,ue=ee-te,Se=(e.gas_fixed_fee??6.5)*P,De=i*(e.gas_variable_rate??.055),Ce=(e.gas_network_fee??4.8)*P,Ee=i*(e.gas_network_variable_rate??.012),Me=i*(e.gas_tax_rate??.001),pe=Se+De+Ce+Ee+Me,Te=pe*(e.gas_vat_rate??.08),me=pe+Te,T=e.currency||"EUR",$=p=>`${l(p,2)} ${T}`,he=Ve.find(p=>Math.abs(p.kw-d)<.05),tt=U-G-H,ge=w?Ve.map(p=>{var Le;const R=qe(t.consumptionTimeseries.items,e.energy_variable_rate,p.kw,_,b,((Le=t.productionTimeseries)==null?void 0:Le.items)??[]),A=p.fixedMonthlyFee*P,z=R.exceedanceKwh*e.exceedance_rate,Pe=(tt+A+z)*(1+e.vat_rate);return{...p,fixedCharge:A,exceedanceKwh:R.exceedanceKwh,exceedanceCharge:z,total:Pe,deltaVsCurrent:Pe-ee}}):[],oe=ge.reduce((p,R)=>!p||R.total<p.total?R:p,null),st=p=>Math.abs(p)<.005?"Current total":`${p>0?"+":"-"}${$(Math.abs(p))}`,fe=s.start&&s.end?`${B(s.start)} — ${B(s.end)}`:t.range.replace("_"," ").replace(/\b\w/g,p=>p.toUpperCase()),at=v>0?`<div class="card exceedance-warning">
        <strong>⚠️ Reference Power Exceeded</strong>
        <p>Peak load: <strong>${l(D,1)} kW</strong> &mdash; ${k?"Reference power windows active":`Reference power level: ${l(d,1)} kW`}</p>
        <p>Exceedance volume: <strong>${l(v,2)} kWh</strong></p>
        <p class="muted">Exceedance charge: ${$(H)}</p>
      </div>`:"",rt=x?w.rateBreakdown.map(p=>`
            <tr>
              <td>${p.label} (${l(p.kwh)} kWh)</td>
              <td style="text-align: right;">${l(p.rate,4)} ${T}/kWh</td>
              <td style="text-align: right;">${$(p.kwh*p.rate)}</td>
            </tr>
          `).join(""):`
            <tr>
              <td>Supplier rate (${l(m)} kWh bought from grid)</td>
              <td style="text-align: right;">${l(e.energy_variable_rate,4)} ${T}/kWh</td>
              <td style="text-align: right;">${$(q)}</td>
            </tr>
          `,nt=k?`Reference power windows active (${b.length})`:`${l(d,1)} kW`,ot=x?`Time-of-use windows active (${_.length})`:`${l(e.energy_variable_rate,4)} ${T}/kWh`,it=ge.map(p=>{const R=!!oe&&p.kw===oe.kw,A=!!he&&p.kw===he.kw,z=p.deltaVsCurrent<-.005?"comparison-delta-savings":p.deltaVsCurrent>.005?"comparison-delta-extra":"";return`
            <tr class="${R?"reference-power-best-row":""}${A?" reference-power-current-row":""}">
              <td>
                <div class="reference-level-cell">
                  <span class="reference-level-kw">${l(p.kw,0)} kW</span>
                  ${R?'<span class="reference-level-badge best">Financially optimal</span>':""}
                  ${A?'<span class="reference-level-badge current">Current</span>':""}
                  ${p.existingContractsOnly?'<span class="reference-level-badge legacy">Existing contracts</span>':""}
                </div>
              </td>
              <td style="text-align: right;">${$(p.fixedCharge)}</td>
              <td style="text-align: right;">${$(p.exceedanceCharge)}</td>
              <td style="text-align: right;"><strong>${$(p.total)}</strong></td>
              <td class="${z}" style="text-align: right;">${st(p.deltaVsCurrent)}</td>
            </tr>
          `}).join(""),lt=ge.length>0?`
        ...
        <div class="reference-power-card-header">
          <div>
            ...
            <p class="muted reference-power-card-copy">
              ...
              ${he?"":`Your current configuration uses ${l(d,1)} kW, which is outside the standard Creos low-voltage reference power levels.`}
            </p>
          </div>
    ...
    `,ct=`
      <div class="range-selector">
        ${we.map(p=>`
          <button
            class="range-btn ${p.id===t.range?"active":""}"
            data-range="${p.id}"
          >${p.label}</button>
        `).join("")}
      </div>
    `,dt=s.start&&s.end?(()=>{const p=new Date(s.start),R=new Date(s.end);return Number.isNaN(p.getTime())||Number.isNaN(R.getTime())?"":`
        <div class="range-info-bar">
          Period: ${p.toLocaleDateString()} - ${R.toLocaleDateString()}
        </div>
      `})():"",ut=t.range==="custom"?`
      <div class="custom-range-picker">
        <label>
    ...
    `:h&&C?`
        <div class="custom-range-picker period-preview">
          ...
          <label>
            <span>To</span>
            <input type="date" value="${C}" readonly aria-label="Preset period end" />
          </label>
        </div>
      `:"";return`
    <section class="invoice-view">
      ...
      <div class="section-header invoice-section-header">
        <div class="invoice-header-top">
          <div>
            <h2>Invoice Estimate &mdash; ${fe}</h2>
        ...
        <table class="invoice-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: right;">${l(e.energy_fixed_fee,2)} ${T}/mo</td>
            ...
            <tr>
              ...
              <td style="text-align: right;">${l(e.network_metering_rate,2)} ${T}/mo</td>
              <td style="text-align: right;">${$(J)}</td>
            </tr>
            <tr>
              <td>Reference power level (${nt}) <span class="muted">(${W})</span></td>
              <td style="text-align: right;">${l(e.network_power_ref_rate,2)} ${T}/mo</td>
              <td style="text-align: right;">${$(G)}</td>
            </tr>
            <tr>
              <td>Volumetric charge (${l(m)} kWh bought from grid)</td>
              <td style="text-align: right;">${l(e.network_variable_rate,4)} ${T}/kWh</td>
            ...
            <tr class="${v>0?"exceedance-row":""}">
              ...
              <td style="text-align: right;">${l(e.exceedance_rate,4)} ${T}/kWh</td>
              <td style="text-align: right;">${$(H)}</td>
            </tr>

            ${S.filter(p=>p.fee>0).length>0?`
            <tr class="section-label"><td colspan="3">Extra Meter Fees</td></tr>
            ${S.filter(p=>p.fee>0).map(p=>`
            <tr>
              <td>${p.label||"…"+p.meter_id.slice(-8)} <span class="muted">(${W})</span></td>
              <td style="text-align: right;">${l(p.fee,2)} ${T}/mo</td>
              <td style="text-align: right;">${$(p.fee*P)}</td>
            </tr>
            `).join("")}
            `:""}
            ...
            <tr>
              ...
              <td style="text-align: right;">${l(e.compensation_fund_rate,4)} ${T}/kWh</td>
              <td style="text-align: right;">${$(M)}</td>
            </tr>
            <tr>
              <td>Electricity Tax</td>
              <td style="text-align: right;">${l(e.electricity_tax_rate,4)} ${T}/kWh</td>
              <td style="text-align: right;">${$(Q)}</td>
            </tr>
            ${Z>0?`
            ...
            <tr>
              ...
              <td style="text-align: right;">-${l(Math.max(0,e.connect_discount??0),2)} ${T}/mo</td>
            ...
            <tr class="total-row">
              ...
              <td style="text-align: right;"><strong>${$(ee)}</strong></td>
            </tr>
            ...
            <tr class="revenue-row">
              <td>Exported (${X?p.shortId:l(o)+" kWh"})</td>
              <td style="text-align: right;">${p.label}<br/>${l(p.rate,4)} ${T}/kWh</td>
              <td class="revenue-amount" style="text-align: right;">-${$(X?o/j.length*p.rate:o*p.rate)}</td>
            </tr>
            `).join("")}
            ${X?`
            <tr class="revenue-row">
              <td><em>Total feed-in (${l(o)} kWh, avg rate)</em></td>
              <td style="text-align: right;">${l(be,4)} ${T}/kWh</td>
              <td class="revenue-amount" style="text-align: right;">-${$(te)}</td>
            </tr>
            `:""}
      ...
      <div class="card invoice-footer">
        <p class="muted" style="line-height: var(--lh-relaxed);">
          ...
          Supplier pricing: ${ot}.
          Fixed monthly charges are prorated across the viewed period (${L} days, ${W}, equivalent to ${l(P,2)} monthly charges).
          Peak load (${l(D,1)} kW) is compared against ${k?"your configured reference power windows":`your reference power level (${l(d,1)} kW)`} &mdash;
          every kWh above the reference power level is billed with an exceedance charge of ${l(e.exceedance_rate,4)} ${T}/kWh.
      ...
      <div class="card invoice-card gas-invoice-card">
        <h3 class="card-title"><span class="title-icon">🔥</span> Gas Cost Estimate &mdash; ${fe}</h3>
        ...
        <table class="invoice-table">
          ...
          <tbody>
            ...
            <tr>
              <td>Fixed Fee <span class="muted">(${W})</span></td>
              <td style="text-align: right;">${l(e.gas_fixed_fee??6.5,2)} ${T}/mo</td>
              <td style="text-align: right;">${$(Se)}</td>
            </tr>
            <tr>
              <td>Energy (${l(i)} kWh)</td>
              <td style="text-align: right;">${l(e.gas_variable_rate??.055,4)} ${T}/kWh</td>
            ...
            <tr>
              ...
              <td style="text-align: right;">${l(e.gas_network_fee??4.8,2)} ${T}/mo</td>
              <td style="text-align: right;">${$(Ce)}</td>
            </tr>
            <tr>
              <td>Network Variable (${l(i)} kWh)</td>
              <td style="text-align: right;">${l(e.gas_network_variable_rate??.012,4)} ${T}/kWh</td>
            ...
            <tr>
              ...
              <td style="text-align: right;">${l(e.gas_tax_rate??.001,4)} ${T}/kWh</td>
              <td style="text-align: right;">${$(Me)}</td>
            </tr>

            <tr class="subtotal-row">
              <td colspan="2">Subtotal (excl. VAT)</td>
              <td style="text-align: right;"><strong>${$(pe)}</strong></td>
            </tr>
            <tr>
              <td>VAT</td>
            ...
            <tr class="total-row">
              ...
              <td style="text-align: right;"><strong>${$(me)}</strong></td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="card invoice-footer">
        <p class="muted" style="line-height: var(--lh-relaxed);">
          <strong>Combined Energy Total: ${$(ue+me)}</strong>
          (Electricity: ${$(ue)} + Gas: ${$(me)})
        </p>
      </div>
      `:""}
        ...
        <table class="invoice-table solar-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: right;">${l(e.energy_variable_rate,4)} ${T}/kWh</td>
              <td style="text-align: right;">${$(se*e.energy_variable_rate)}</td>
            </tr>
            <tr>
              <td>Network fees avoided</td>
              <td style="text-align: right;">${l(e.network_variable_rate,4)} ${T}/kWh</td>
              <td style="text-align: right;">${$(se*e.network_variable_rate)}</td>
            </tr>
            <tr>
              <td>Taxes & levies avoided</td>
              <td style="text-align: right;">${l(e.electricity_tax_rate+e.compensation_fund_rate,4)} ${T}/kWh</td>
              <td style="text-align: right;">${$(se*(e.electricity_tax_rate+e.compensation_fund_rate))}</td>
            </tr>
            <tr>
              <td>VAT saved</td>
              <td style="text-align: right;">${l(e.vat_rate*100,0)}%</td>
              <td style="text-align: right;">${$(ke)}</td>
            </tr>
            <tr class="subtotal-row">
            ...
            ${j.map(p=>`
            <tr>
              <td>Sold to grid ${X?`(${p.shortId})`:`(${l(o)} kWh)`}</td>
              <td style="text-align: right;">${p.label}<br/>${l(p.rate,4)} ${T}/kWh</td>
              <td style="text-align: right;">${$(X?o/j.length*p.rate:o*p.rate)}</td>
            </tr>
            `).join("")}
            ${X?`
            <tr class="subtotal-row">
              <td colspan="2"><strong>Total Feed-in Revenue</strong></td>
              <td style="text-align: right;"><strong>${$(te)}</strong></td>
            </tr>
            `:""}
            `:""}
            ...
            <tr class="total-row solar-total-row">
              ...
              <td style="text-align: right;"><strong>${$(xe)}</strong></td>
            </tr>
          </tbody>
        </table>
  ...
  `}function Be(t){return Wt.map(e=>`<option value="${e.value}" ${e.value===t?"selected":""}>${e.label}</option>`).join("")}function Ft(t,e){return`
    <div class="meter-card">
      <div class="meter-header">
  ...
  `}function At(t,e="ha",s){if(!t&&e==="ha")return`
      <section class="settings-view">
        <div class="card">
          <p class="muted">Loading configuration…</p>
        </div>
      </section>
    `;const a=e==="standalone"?(s==null?void 0:s.meters)??[{id:"",types:["consumption"]}]:(t==null?void 0:t.meters)??[];let n="";if(e==="standalone"){const v=a.map((h,C)=>Ne(C,h,!1)).join("");n=`
      <div class="section-header">
    ...
    `}else{const v=(t==null?void 0:t.meters)??[];n=`
      <div class="card" style="margin-bottom: var(--sp-6); padding: var(--sp-4) var(--sp-5);">
        ...
        <div class="form-section">
          ...
          <div id="meters-container">
            ${v.length>0?v.map((C,L)=>Ne(L,C,!0)).join(""):'<p class="muted">No meters configured</p>'}
          </div>
        </div>
      </div>
    `}const r=v=>v.map(h=>{const C=t?t[h.key]??"":"";return`
        <div class="form-row">
      ...
      `}).join(""),o=((t==null?void 0:t.meters)??[]).filter(v=>v.types.includes("production")),u=(t==null?void 0:t.feed_in_rates)??[],m=e==="ha";function f(v){return u.find(h=>h.meter_id===v)??{meter_id:v,mode:"fixed",tariff:(t==null?void 0:t.feed_in_tariff)??.08,sensor_entity:""}}const d=o.length===0?'<p class="muted">No production meters configured — add a meter with Power Production type above.</p>':o.map((v,h)=>{const C=f(v.id),L=v.id?"…"+v.id.slice(-8):`Meter ${h+1}`;return`
        ...
        `}).join(""),g=((t==null?void 0:t.meters)??[]).some(v=>v.types.includes("gas"))||(t==null?void 0:t.meter_has_gas),i=(t==null?void 0:t.consumption_rate_windows)??[],y=(t==null?void 0:t.reference_power_windows)??[],c=(t==null?void 0:t.meters)??[],_=(t==null?void 0:t.meter_monthly_fees)??[];function b(v){return _.find(h=>h.meter_id===v)??{meter_id:v,label:"",fee:0}}const w=c.length===0?'<p class="muted">No meters configured.</p>':c.map((v,h)=>{const C=b(v.id),L=v.id?"…"+v.id.slice(-8):`Meter ${h+1}`;return`
          <div class="meter-fee-card" style="margin-bottom: var(--sp-3); padding: var(--sp-3); border: 1px solid var(--clr-border); border-radius: var(--radius);">
            <div style="display: flex; align-items: center; gap: var(--sp-2); margin-bottom: var(--sp-2);">
              <span>${v.types.map(W=>Ke[W]??"").join(" ")}</span>
    ...
    <div id="consumption-windows-container">
      ${i.length>0?i.map((v,h)=>Ft(h,v)).join(""):'<p class="muted">No time-of-use windows configured. Using the flat supplier rate.</p>'}
    </div>
  ...
  `,k=`
    ...
    <div id="reference-windows-container">
      ${y.length>0?y.map((v,h)=>It(h,v)).join(""):'<p class="muted">No scheduled reference windows configured. Using one reference power all day.</p>'}
    </div>
    <button type="button" id="add-reference-window-btn" class="btn btn-outline" style="margin-top: var(--sp-3);">
      + Add Reference Window
    </button>
  `,D=Rt.map(v=>{if(v.title==="Gas Billing"&&!g||v.title==="Meter Fees"&&c.length<2)return"";let h;return v.title==="Feed-in / Selling"?h=d:v.title==="Time-of-Use Tariffs"?h=x:v.title==="Reference Power Windows"?h=k:v.title==="Discounts"?h=`<p class="muted" style="margin: 0 0 var(--sp-3) 0; font-size: 0.85rem;">
    ...
    <section class="settings-view">
      ...
      <div class="card">
        <form id="settings-form">
          ${t?D:'<p class="muted">Loading configuration…</p>'}
          ${t?`
          <div class="form-actions">
  ...
  `}function ve(t,e,s=!1,a="dark"){return`
  ...
  `}const Je="leneda_credentials",Qe="leneda_theme";function Vt(){try{const t=localStorage.getItem(Je);if(t)return JSON.parse(t)}catch{}return null}function ye(t){try{localStorage.setItem(Je,JSON.stringify(t))}catch{}}function Ot(){var t;try{const e=localStorage.getItem(Qe);if(e==="dark"||e==="light")return e}catch{}return(t=window.matchMedia)!=null&&t.call(window,"(prefers-color-scheme: light)").matches?"light":"dark"}function Gt(t){try{localStorage.setItem(Qe,t)}catch{}}function Ye(t){const e=t.match(/^(\d{4})-(\d{2})-(\d{2})$/);if(!e)return null;const[,s,a,n]=e;return new Date(Number(s),Number(a)-1,Number(n))}function He(t,e){return t.getFullYear()===e.getFullYear()&&t.getMonth()===e.getMonth()&&t.getDate()===e.getDate()}function qt(t,e=new Date){switch(t){case"yesterday":{const s=new Date(e);s.setDate(s.getDate()-1),s.setHours(0,0,0,0);const a=new Date(s);return a.setHours(23,59,59,999),{start:s,end:a}}case"this_week":{const s=new Date(e),a=s.getDay()||7;return s.setDate(s.getDate()-a+1),s.setHours(0,0,0,0),{start:s,end:e}}case"last_week":{const s=new Date(e),a=s.getDay()||7,n=new Date(s);n.setDate(s.getDate()-a),n.setHours(23,59,59,999);const r=new Date(n);return r.setDate(n.getDate()-6),r.setHours(0,0,0,0),{start:r,end:n}}case"this_month":return{start:new Date(e.getFullYear(),e.getMonth(),1),end:e};case"last_month":{const s=new Date(e.getFullYear(),e.getMonth()-1,1),a=new Date(e.getFullYear(),e.getMonth(),0,23,59,59,999);return{start:s,end:a}}case"this_year":return{start:new Date(e.getFullYear(),0,1),end:e};case"last_year":{const s=new Date(e.getFullYear()-1,0,1),a=new Date(e.getFullYear()-1,11,31,23,59,59,999);return{start:s,end:a}}}}function Nt(t,e,s=new Date){const a=Ye(t),n=Ye(e);if(!a||!n)return null;const r=["yesterday","this_week","last_week","this_month","last_month","this_year","last_year"];for(const o of r){const u=qt(o,s);if(He(a,u.start)&&He(n,u.end))return o}return null}class Yt{constructor(e){K(this,"root");K(this,"state",{tab:"dashboard",range:"yesterday",customStart:"",customEnd:"",chartUnit:"kwh",rangeData:null,consumptionTimeseries:null,productionTimeseries:null,sensors:null,config:null,loading:!0,error:null,mode:"ha",credentials:null,isMenuOpen:!1,theme:Ot()});K(this,"preZoomRange",null);K(this,"preZoomCustomStart","");K(this,"preZoomCustomEnd","");this.root=e}async mount(){this.applyTheme(),this.render();const e=await je();if(this.state.mode=e.mode,e.mode==="standalone"){const s=Vt();if(s&&(this.state.credentials=s),!e.configured&&!s){this.state.tab="settings",this.state.loading=!1,this.state.error=null,this.render();return}if(!e.configured&&s)try{const{saveCredentials:a}=await V(async()=>{const{saveCredentials:n}=await Promise.resolve().then(()=>Y);return{saveCredentials:n}},void 0);await a(s)}catch{}if(!s)try{this.state.credentials=await Xe()}catch{}}await this.loadData()}toDisplayError(e,s="Failed to load data"){const a=e instanceof Error?e.message:String(e??"").trim(),n=a.toLowerCase();return n.includes("missing data")||n.includes("no_data")||n.includes("no data")?"Missing data":a||s}clearRangeStateWithError(e,s="Failed to load data"){this.state.rangeData=null,this.state.consumptionTimeseries=null,this.state.productionTimeseries=null,this.state.error=this.toDisplayError(e,s)}async loadData(){this.state.loading=!0,this.state.error=null,this.state.rangeData=null,this.render();try{const[e,s,a]=await Promise.all([le(this.state.range),_e(),ae()]),{start:n,end:r}=this.getDateRangeISO(),[o,u]=await Promise.all([O("1-1:1.29.0",n,r),O("1-1:2.29.0",n,r)]);this.state.rangeData=e,this.state.consumptionTimeseries=o,this.state.productionTimeseries=u,this.state.sensors=s,this.state.config=a}catch(e){this.clearRangeStateWithError(e,"Failed to load data")}finally{this.state.loading=!1,this.render()}}async changeRange(e){if(this.preZoomRange=null,this.state.range=e,e==="custom"){if(!this.state.customStart||!this.state.customEnd){const s=new Date;s.setDate(s.getDate()-1);const a=new Date(s);a.setDate(a.getDate()-6),this.state.customStart=a.toISOString().slice(0,10),this.state.customEnd=s.toISOString().slice(0,10)}this.render();return}this.state.error=null,this.state.loading=!0,this.render();try{const{start:s,end:a}=this.getDateRangeISO(),[n,r,o]=await Promise.all([le(e),O("1-1:1.29.0",s,a),O("1-1:2.29.0",s,a)]);this.state.rangeData=n,this.state.consumptionTimeseries=r,this.state.productionTimeseries=o}catch(s){this.clearRangeStateWithError(s,"Missing data")}finally{this.state.loading=!1,this.render()}}async applyCustomRange(){this.preZoomRange=null;const{customStart:e,customEnd:s}=this.state;if(!(!e||!s)){this.state.error=null,this.state.loading=!0,this.render();try{const a=Nt(e,s),n=a?le(a):V(async()=>{const{fetchCustomData:m}=await Promise.resolve().then(()=>Y);return{fetchCustomData:m}},void 0).then(({fetchCustomData:m})=>m(e,s)),[r,o,u]=await Promise.all([n,O("1-1:1.29.0",new Date(e+"T00:00:00").toISOString(),new Date(s+"T23:59:59.999").toISOString()),O("1-1:2.29.0",new Date(e+"T00:00:00").toISOString(),new Date(s+"T23:59:59.999").toISOString())]);this.state.rangeData={range:"custom",consumption:r.consumption,production:r.production,exported:r.exported??0,self_consumed:r.self_consumed??0,grid_import:r.grid_import,solar_to_home:r.solar_to_home,direct_solar_to_home:r.direct_solar_to_home,shared:r.shared,shared_with_me:r.shared_with_me,gas_energy:r.gas_energy??0,gas_volume:r.gas_volume??0,peak_power_kw:r.peak_power_kw??0,exceedance_kwh:r.exceedance_kwh??0,metering_point:r.metering_point??"",start:r.start??e,end:r.end??s},this.state.consumptionTimeseries=o,this.state.productionTimeseries=u}catch(a){this.clearRangeStateWithError(a,"Missing data")}finally{this.state.loading=!1,this.render()}}}changeTab(e){this.state.tab=e,this.render(),e==="dashboard"&&!this.state.rangeData&&!this.state.loading&&this.loadData(),e==="sensors"&&!this.state.sensors&&_e().then(s=>{this.state.sensors=s,this.render()}),e==="settings"&&!this.state.config&&ae().then(s=>{this.state.config=s,this.render()}),this.state.isMenuOpen=!1}toggleMenu(){this.state.isMenuOpen=!this.state.isMenuOpen,this.render()}applyTheme(){document.documentElement.dataset.theme=this.state.theme}setTheme(e){e!==this.state.theme&&(this.state.theme=e,Gt(e),this.applyTheme(),this.render())}toggleTheme(){this.setTheme(this.state.theme==="dark"?"light":"dark")}printInvoice(){var o,u;const e=document.title,a=`Leneda-invoice-${(o=this.state.rangeData)!=null&&o.start&&((u=this.state.rangeData)!=null&&u.end)?`${this.state.rangeData.start.slice(0,10)}_to_${this.state.rangeData.end.slice(0,10)}`:this.state.range}`.replace(/[^a-z0-9_-]+/gi,"-");let n=!1;const r=()=>{n||(n=!0,document.title=e,window.removeEventListener("afterprint",r))};document.title=a,window.addEventListener("afterprint",r,{once:!0}),window.print(),window.setTimeout(r,1e3)}getMainContentScrollTop(){const e=this.root.querySelector(".main-content");return e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}restoreMainContentScrollTop(e){requestAnimationFrame(()=>{const s=this.root.querySelector(".main-content");s?s.scrollTop=e:window.scrollTo({top:e})})}renderPreserveMainScroll(){const e=this.getMainContentScrollTop();this.render(),this.restoreMainContentScrollTop(e)}render(){var o;const{tab:e,loading:s,error:a,theme:n}=this.state;if(s&&!this.state.rangeData){this.root.innerHTML=`
        <div class="app-shell">
          ${ve(e,u=>{},!1,n)}
      ...
      `,this.attachNavListeners(),(o=this.root.querySelector("#retry-btn"))==null||o.addEventListener("click",()=>this.loadData());return}let r="";switch(e){case"dashboard":r=Ie(this.state);break;case"sensors":r=St(this.state.sensors);break;case"invoice":r=Tt(this.state);break;case"settings":r=At(this.state.config,this.state.mode,this.state.credentials);break}this.root.innerHTML=`
      <div class="app-shell">
        ${ve(e,u=>this.changeTab(u),this.state.isMenuOpen,n)}
        <main class="main-content">
          ${s?'<div class="loading-bar"></div>':""}
          ${r}
        </main>
      </div>
    `,this.attachNavListeners(),this.attachDashboardListeners(),this.attachInvoiceListeners(),this.attachSettingsListeners()}attachNavListeners(){var e,s;(e=this.root.querySelector(".menu-toggle"))==null||e.addEventListener("click",()=>{this.toggleMenu()}),(s=this.root.querySelector("[data-theme-toggle]"))==null||s.addEventListener("click",()=>{this.toggleTheme()}),this.root.querySelectorAll("[data-tab]").forEach(a=>{a.addEventListener("click",()=>{const n=a.dataset.tab;this.changeTab(n)})})}attachDashboardListeners(e=!1){this.root.querySelectorAll("[data-range]").forEach(o=>{o.addEventListener("click",()=>{const u=o.dataset.range;this.changeRange(u)})});const s=this.root.querySelector("#custom-start"),a=this.root.querySelector("#custom-end");s&&s.addEventListener("change",()=>{this.state.customStart=s.value}),a&&a.addEventListener("change",()=>{this.state.customEnd=a.value});const n=this.root.querySelector("#apply-custom-range");if(n==null||n.addEventListener("click",()=>this.applyCustomRange()),this.root.querySelectorAll("[data-chart-unit]").forEach(o=>{o.addEventListener("click",()=>{const u=o.dataset.chartUnit;u!==this.state.chartUnit&&(this.state.chartUnit=u,this.render())})}),!e){const o=this.root.querySelector("#energy-chart");o&&this.state.rangeData&&this.initChart(o)}const r=this.root.querySelector(".reset-zoom-btn");r==null||r.addEventListener("click",async()=>{const{resetChartZoom:o}=await V(async()=>{const{resetChartZoom:u}=await import("./Charts-CTuzU3zd.js");return{resetChartZoom:u}},[]);if(o(),r.style.display="none",this.preZoomRange!==null){const u=this.preZoomRange;this.state.customStart=this.preZoomCustomStart,this.state.customEnd=this.preZoomCustomEnd,this.preZoomRange=null,this.preZoomCustomStart="",this.preZoomCustomEnd="",u==="custom"?(this.state.range="custom",this.applyCustomRange()):this.changeRange(u)}else this.changeRange(this.state.range==="custom"?"yesterday":this.state.range)})}attachInvoiceListeners(){var e;(e=this.root.querySelector("#print-invoice-btn"))==null||e.addEventListener("click",()=>{this.printInvoice()})}attachSettingsListeners(){var m,f;const e=this.root.querySelector("#credentials-form");if(e){const d=this.root.querySelector("#add-meter-btn");d==null||d.addEventListener("click",()=>{var _,b;const y=new FormData(e),c=g(y);if(c.length<10){c.push({id:"",types:["consumption"]});const w={api_key:y.get("api_key")||((_=this.state.credentials)==null?void 0:_.api_key)||"",energy_id:y.get("energy_id")||((b=this.state.credentials)==null?void 0:b.energy_id)||"",meters:c};this.state.credentials=w,ye(w),this.renderPreserveMainScroll()}}),this.root.querySelectorAll(".remove-meter-btn").forEach(y=>{y.addEventListener("click",()=>{var x,k;const c=parseInt(y.dataset.meter??"0",10),_=new FormData(e),b=g(_);b.splice(c,1);const w={api_key:_.get("api_key")||((x=this.state.credentials)==null?void 0:x.api_key)||"",energy_id:_.get("energy_id")||((k=this.state.credentials)==null?void 0:k.energy_id)||"",meters:b};this.state.credentials=w,ye(w),this.renderPreserveMainScroll()})});const g=y=>{var _,b,w;const c=[];for(let x=0;x<10;x++){const k=y.get(`meter_${x}_id`);if(k===null)break;const D=[];(_=e.querySelector(`[name="meter_${x}_consumption"]`))!=null&&_.checked&&D.push("consumption"),(b=e.querySelector(`[name="meter_${x}_production"]`))!=null&&b.checked&&D.push("production"),(w=e.querySelector(`[name="meter_${x}_gas"]`))!=null&&w.checked&&D.push("gas"),c.push({id:k.trim(),types:D})}return c};e.addEventListener("submit",async y=>{y.preventDefault();const c=new FormData(e),_={api_key:c.get("api_key"),energy_id:c.get("energy_id"),meters:g(c)},b=this.root.querySelector("#creds-status");try{ye(_);const{saveCredentials:w}=await V(async()=>{const{saveCredentials:x}=await Promise.resolve().then(()=>Y);return{saveCredentials:x}},void 0);await w(_),b&&(b.innerHTML='<p style="color: var(--clr-production); padding: var(--sp-3) 0;">✓ Credentials saved. Reloading data…</p>'),this.state.credentials=_,this.state.error=null,await this.loadData()}catch(w){b&&(b.innerHTML=`<p style="color: var(--clr-danger); padding: var(--sp-3) 0;">✗ Save failed: ${w instanceof Error?w.message:w}</p>`)}});const i=this.root.querySelector("#test-creds-btn");i==null||i.addEventListener("click",async()=>{const y=new FormData(e),c={api_key:y.get("api_key"),energy_id:y.get("energy_id"),meters:g(y)},_=this.root.querySelector("#creds-status");_&&(_.innerHTML='<p style="color: var(--clr-muted); padding: var(--sp-3) 0;">Testing connection…</p>');try{const{testCredentials:b}=await V(async()=>{const{testCredentials:x}=await Promise.resolve().then(()=>Y);return{testCredentials:x}},void 0),w=await b(c);_&&(_.innerHTML=w.success?`<p style="color: var(--clr-production); padding: var(--sp-3) 0;">✓ ${w.message}</p>`:`<p style="color: var(--clr-danger); padding: var(--sp-3) 0;">✗ ${w.message}</p>`)}catch(b){_&&(_.innerHTML=`<p style="color: var(--clr-danger); padding: var(--sp-3) 0;">✗ Test failed: ${b instanceof Error?b.message:b}</p>`)}})}const s=this.root.querySelector("#settings-form");if(!s)return;const a=d=>{const g=[];for(let i=0;i<24;i++){const y=d.get(`consumption_window_${i}_label`),c=d.get(`consumption_window_${i}_day_group`),_=d.get(`consumption_window_${i}_start_time`),b=d.get(`consumption_window_${i}_end_time`),w=d.get(`consumption_window_${i}_rate`);if(y===null&&c===null&&_===null&&b===null&&w===null)break;g.push({label:(y??"").trim()||`Window ${i+1}`,day_group:c??"all",start_time:_??"00:00",end_time:b??"06:00",rate:parseFloat(w??"0")||0})}return g},n=d=>{const g=[];for(let i=0;i<24;i++){const y=d.get(`reference_window_${i}_label`),c=d.get(`reference_window_${i}_day_group`),_=d.get(`reference_window_${i}_start_time`),b=d.get(`reference_window_${i}_end_time`),w=d.get(`reference_window_${i}_reference_power_kw`);if(y===null&&c===null&&_===null&&b===null&&w===null)break;g.push({label:(y??"").trim()||`Reference ${i+1}`,day_group:c??"all",start_time:_??"17:00",end_time:b??"00:00",reference_power_kw:parseFloat(w??"0")||0})}return g},r=()=>{var x;const d=new FormData(s),g={};s.querySelectorAll('input[type="checkbox"]').forEach(k=>{g[k.name]=k.checked});const i=[],y=/^feed_in_rate_(\d+)_(.+)$/,c={},_=[],b=/^meter_fee_(\d+)_(.+)$/,w={};for(const[k,D]of d.entries()){if(k.startsWith("consumption_window_")||k.startsWith("reference_window_"))continue;const v=k.match(y);if(v){const W=v[1],I=v[2];c[W]||(c[W]={}),c[W][I]=D;continue}const h=k.match(b);if(h){const W=h[1],I=h[2];w[W]||(w[W]={}),w[W][I]=D;continue}if(g[k]!==void 0&&typeof g[k]=="boolean")continue;const C=D,L=s.elements.namedItem(k);if(C===""&&L instanceof HTMLInputElement&&L.type==="number"){const W=(x=this.state.config)==null?void 0:x[k];typeof W=="number"&&isFinite(W)&&(g[k]=W);continue}const P=parseFloat(C);g[k]=isNaN(P)?C:P}for(const k of Object.keys(c).sort()){const D=c[k],v=D.mode??"fixed",h=v==="sensor"?D.fallback_tariff??D.tariff:D.tariff;i.push({meter_id:D.meter_id??"",mode:v,tariff:parseFloat(h??"0.08")||.08,sensor_entity:D.sensor_entity??""})}i.length>0&&(g.feed_in_rates=i);for(const k of Object.keys(w).sort()){const D=w[k];_.push({meter_id:D.meter_id??"",label:D.label??"",fee:parseFloat(D.fee??"0")||0})}return _.length>0&&(g.meter_monthly_fees=_),g.consumption_rate_windows=a(d),g.reference_power_windows=n(d),g},o=d=>{if(!this.state.config)return;const g=r();d(g),this.state.config={...this.state.config,...g},this.renderPreserveMainScroll()};if((m=this.root.querySelector("#add-consumption-window-btn"))==null||m.addEventListener("click",()=>{o(d=>{var i;const g=Array.isArray(d.consumption_rate_windows)?[...d.consumption_rate_windows]:[];g.push({label:`Window ${g.length+1}`,day_group:"weekdays",start_time:"17:00",end_time:"00:00",rate:((i=this.state.config)==null?void 0:i.energy_variable_rate)??.1125}),d.consumption_rate_windows=g})}),this.root.querySelectorAll(".remove-consumption-window-btn").forEach(d=>{d.addEventListener("click",()=>{const g=parseInt(d.dataset.window??"0",10);o(i=>{const y=Array.isArray(i.consumption_rate_windows)?[...i.consumption_rate_windows]:[];y.splice(g,1),i.consumption_rate_windows=y})})}),(f=this.root.querySelector("#add-reference-window-btn"))==null||f.addEventListener("click",()=>{o(d=>{var i;const g=Array.isArray(d.reference_power_windows)?[...d.reference_power_windows]:[];g.push({label:`Reference ${g.length+1}`,day_group:"weekdays",start_time:"17:00",end_time:"00:00",reference_power_kw:((i=this.state.config)==null?void 0:i.reference_power_kw)??5}),d.reference_power_windows=g})}),this.root.querySelectorAll(".remove-reference-window-btn").forEach(d=>{d.addEventListener("click",()=>{const g=parseInt(d.dataset.window??"0",10);o(i=>{const y=Array.isArray(i.reference_power_windows)?[...i.reference_power_windows]:[];y.splice(g,1),i.reference_power_windows=y})})}),s.querySelectorAll('input[type="radio"][name^="feed_in_rate_"][name$="_mode"]').forEach(d=>{d.addEventListener("change",()=>{const g=d.name.match(/feed_in_rate_(\d+)_mode/);if(!g)return;const i=g[1],y=s.querySelector(`.feed-in-fixed-fields[data-rate-idx="${i}"]`),c=s.querySelector(`.feed-in-sensor-fields[data-rate-idx="${i}"]`);y&&(y.style.display=d.value==="fixed"?"":"none"),c&&(c.style.display=d.value==="sensor"?"":"none")})}),this.state.mode==="ha"){const d=this.root.querySelector("#ha-entity-list");d&&ze().then(({entities:g})=>{d.innerHTML=g.map(i=>`<option value="${i}"></option>`).join("")}).catch(()=>{})}s.addEventListener("submit",async d=>{d.preventDefault();const g=r();try{const{saveConfig:i}=await V(async()=>{const{saveConfig:y}=await Promise.resolve().then(()=>Y);return{saveConfig:y}},void 0);await i(g),this.state.config=await ae(),this.render()}catch(i){alert("Failed to save: "+(i instanceof Error?i.message:i))}});const u=this.root.querySelector("#reset-config-btn");u==null||u.addEventListener("click",async()=>{if(confirm("Reset all billing rates to defaults?"))try{const{resetConfig:d}=await V(async()=>{const{resetConfig:g}=await Promise.resolve().then(()=>Y);return{resetConfig:g}},void 0);await d(),this.state.config=await ae(),this.render()}catch(d){alert("Failed to reset: "+(d instanceof Error?d.message:d))}})}async initChart(e){var s,a;try{const{renderEnergyChart:n}=await V(async()=>{const{renderEnergyChart:c}=await import("./Charts-CTuzU3zd.js");return{renderEnergyChart:c}},[]),{fetchTimeseries:r,fetchPerMeterTimeseries:o}=await V(async()=>{const{fetchTimeseries:c,fetchPerMeterTimeseries:_}=await Promise.resolve().then(()=>Y);return{fetchTimeseries:c,fetchPerMeterTimeseries:_}},void 0),{start:u,end:m}=this.getDateRangeISO(),[f,d]=await Promise.all([r("1-1:1.29.0",u,m),r("1-1:2.29.0",u,m)]),g=((s=this.state.config)==null?void 0:s.reference_power_kw)??0,i=(((a=this.state.config)==null?void 0:a.meters)??[]).filter(c=>c.types.includes("production"));let y;if(i.length>1)try{const c=await o("1-1:2.29.0",u,m);c.meters&&c.meters.length>1&&(y=c.meters)}catch(c){console.warn("Per-meter timeseries fetch failed, using merged view:",c)}n(e,f,d,{unit:this.state.chartUnit,referencePowerKw:g,perMeterProduction:y,onZoomChange:(c,_)=>{this.handleChartZoomChange(c,_)}})}catch(n){console.error("Chart init failed:",n)}}async handleChartZoomChange(e,s){try{this.preZoomRange===null&&(this.preZoomRange=this.state.range,this.preZoomCustomStart=this.state.customStart,this.preZoomCustomEnd=this.state.customEnd);const{fetchCustomData:a}=await V(async()=>{const{fetchCustomData:f}=await Promise.resolve().then(()=>Y);return{fetchCustomData:f}},void 0),n=e.slice(0,10),r=s.slice(0,10),o=await a(n,r),[u,m]=await Promise.all([O("1-1:1.29.0",new Date(n+"T00:00:00").toISOString(),new Date(r+"T23:59:59.999").toISOString()),O("1-1:2.29.0",new Date(n+"T00:00:00").toISOString(),new Date(r+"T23:59:59.999").toISOString())]);this.state.range="custom",this.state.customStart=n,this.state.customEnd=r,this.state.rangeData={range:"custom",consumption:o.consumption,production:o.production,exported:o.exported??0,self_consumed:o.self_consumed??0,gas_energy:o.gas_energy??0,gas_volume:o.gas_volume??0,grid_import:o.grid_import,solar_to_home:o.solar_to_home,direct_solar_to_home:o.direct_solar_to_home,shared:o.shared,shared_with_me:o.shared_with_me,peak_power_kw:o.peak_power_kw??0,exceedance_kwh:o.exceedance_kwh??0,metering_point:o.metering_point??"",start:o.start,end:o.end},this.state.consumptionTimeseries=u,this.state.productionTimeseries=m,this.renderDashboardPartial()}catch(a){console.error("Zoom data fetch failed:",a),this.clearRangeStateWithError(a,"Missing data"),this.render()}}renderDashboardPartial(){var v,h;const e=this.root.querySelector(".dashboard");if(!e||!this.state.rangeData)return;const s=document.createElement("div");s.innerHTML=Ie(this.state);const a=s.querySelector(".dashboard");if(!a)return;const n=e.querySelector(".range-selector"),r=a.querySelector(".range-selector");n&&r&&n.replaceWith(r);const o=e.querySelector(".range-info-bar"),u=a.querySelector(".range-info-bar");o&&u?o.replaceWith(u):!o&&u?(v=e.querySelector(".range-selector"))==null||v.insertAdjacentElement("afterend",u):o&&!u&&o.remove();const m=e.querySelector(".custom-range-picker"),f=a.querySelector(".custom-range-picker");if(m&&f)m.replaceWith(f);else if(!m&&f){const C=e.querySelector(".range-info-bar")??e.querySelector(".range-selector");C==null||C.insertAdjacentElement("afterend",f)}else m&&!f&&m.remove();const d=e.querySelector(".stats-grid"),g=a.querySelector(".stats-grid");d&&g&&d.replaceWith(g);const i=e.querySelector(".flow-card"),y=a.querySelector(".flow-card");i&&y&&i.replaceWith(y);const c=e.querySelector(".metrics-card"),_=a.querySelector(".metrics-card");c&&_&&c.replaceWith(_);const b=e.querySelector(".chart-header .card-title"),w=a.querySelector(".chart-header .card-title");b&&w&&b.replaceWith(w);const x=e.querySelector(".reset-zoom-btn");x&&(x.style.display=""),e.querySelectorAll("[data-range]").forEach(C=>{C.addEventListener("click",()=>{this.changeRange(C.dataset.range)})});const k=e.querySelector("#custom-start"),D=e.querySelector("#custom-end");k&&k.addEventListener("change",()=>{this.state.customStart=k.value}),D&&D.addEventListener("change",()=>{this.state.customEnd=D.value}),(h=e.querySelector("#apply-custom-range"))==null||h.addEventListener("click",()=>{this.preZoomRange=null,this.applyCustomRange()})}getDateRangeISO(){const e=new Date,s=a=>a.toISOString();switch(this.state.range){case"custom":{const a=new Date(this.state.customStart+"T00:00:00"),n=new Date(this.state.customEnd+"T23:59:59.999");return{start:s(a),end:s(n)}}case"yesterday":{const a=new Date(e);a.setDate(a.getDate()-1),a.setHours(0,0,0,0);const n=new Date(a);return n.setHours(23,59,59,999),{start:s(a),end:s(n)}}case"this_week":{const a=new Date(e),n=a.getDay()||7;return a.setDate(a.getDate()-n+1),a.setHours(0,0,0,0),{start:s(a),end:s(e)}}case"last_week":{const a=new Date(e),n=a.getDay()||7,r=new Date(a);r.setDate(a.getDate()-n),r.setHours(23,59,59,999);const o=new Date(r);return o.setDate(r.getDate()-6),o.setHours(0,0,0,0),{start:s(o),end:s(r)}}case"this_month":{const a=new Date(e.getFullYear(),e.getMonth(),1);return{start:s(a),end:s(e)}}case"last_month":{const a=new Date(e.getFullYear(),e.getMonth()-1,1),n=new Date(e.getFullYear(),e.getMonth(),0,23,59,59,999);return{start:s(a),end:s(n)}}case"this_year":{const a=new Date(e.getFullYear(),0,1);return{start:s(a),end:s(e)}}case"last_year":{const a=new Date(e.getFullYear()-1,0,1),n=new Date(e.getFullYear()-1,11,31,23,59,59,999);return{start:s(a),end:s(n)}}default:{const a=new Date(e);a.setDate(a.getDate()-1),a.setHours(0,0,0,0);const n=new Date(a);return n.setHours(23,59,59,999),{start:s(a),end:s(n)}}}}}if(window.self===window.top&&window.location.pathname.startsWith("/leneda-panel/"))window.location.href="/leneda";else{const t=document.getElementById("app");t&&new Yt(t).mount()}
