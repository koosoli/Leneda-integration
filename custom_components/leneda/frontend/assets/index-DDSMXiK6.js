var fa=Object.defineProperty;var wa=(t,e,a)=>e in t?fa(t,e,{enumerable:!0,configurable:!0,writable:!0,value:a}):t[e]=a;var We=(t,e,a)=>wa(t,typeof e!="symbol"?e+"":e,a);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))s(o);new MutationObserver(o=>{for(const n of o)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&s(r)}).observe(document,{childList:!0,subtree:!0});function a(o){const n={};return o.integrity&&(n.integrity=o.integrity),o.referrerPolicy&&(n.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?n.credentials="include":o.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(o){if(o.ep)return;o.ep=!0;const n=a(o);fetch(o.href,n)}})();const $a="modulepreload",ba=function(t){return"/leneda-panel/static/"+t},St={},ce=function(e,a,s){let o=Promise.resolve();if(a&&a.length>0){let r=function(y){return Promise.all(y.map(d=>Promise.resolve(d).then(v=>({status:"fulfilled",value:v}),v=>({status:"rejected",reason:v}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),u=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));o=r(a.map(y=>{if(y=ba(y),y in St)return;St[y]=!0;const d=y.endsWith(".css"),v=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${y}"]${v}`))return;const h=document.createElement("link");if(h.rel=d?"stylesheet":$a,d||(h.as="script"),h.crossOrigin="",h.href=y,u&&h.setAttribute("nonce",u),document.head.appendChild(h),d)return new Promise((f,m)=>{h.addEventListener("load",f),h.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${y}`)))})}))}function n(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return o.then(r=>{for(const l of r||[])l.status==="rejected"&&n(l.reason);return e().catch(n)})};function Ot(t){return{api_key:(t.api_key??"").trim(),energy_id:(t.energy_id??"").trim(),meters:(t.meters??[]).map(e=>({...e,id:(e.id??"").trim()})),proxy_url:(t.proxy_url??"").trim()}}function _a(){var t,e,a,s,o;try{const n=(e=(t=window.parent)==null?void 0:t.document)==null?void 0:e.querySelector("home-assistant");return((o=(s=(a=n==null?void 0:n.hass)==null?void 0:a.auth)==null?void 0:s.data)==null?void 0:o.access_token)??null}catch{return null}}async function J(t,e){const a=_a(),s={...e==null?void 0:e.headers,...a?{Authorization:`Bearer ${a}`}:{}},o={...e,credentials:"include",headers:s},n=await fetch(t,o);if(!n.ok){const r=n.headers.get("content-type")??"";let l="",u="";if(r.includes("application/json")){const y=await n.json().catch(()=>null);l=String((y==null?void 0:y.error)??"").trim(),u=String((y==null?void 0:y.message)??(y==null?void 0:y.error)??"").trim()}else u=(await n.text().catch(()=>"")).trim();throw l==="missing_data"||l==="no_data"||n.status===503?new Error("Missing data"):new Error(u?`API ${n.status}: ${u}`:`API ${n.status}: ${n.statusText}`)}return n.json()}async function Je(t){return J(`/leneda_api/data?range=${t}`)}async function xa(t,e){return J(`/leneda_api/data/custom?start=${encodeURIComponent(t)}&end=${encodeURIComponent(e)}`)}async function Ie(t,e,a){let s=`/leneda_api/data/timeseries?obis=${encodeURIComponent(t)}`;return e&&(s+=`&start=${encodeURIComponent(e)}`),a&&(s+=`&end=${encodeURIComponent(a)}`),J(s)}async function mt(t,e,a){let s=`/leneda_api/data/timeseries/per-meter?obis=${encodeURIComponent(t)}`;return e&&(s+=`&start=${encodeURIComponent(e)}`),a&&(s+=`&end=${encodeURIComponent(a)}`),J(s)}async function gt(){return J("/leneda_api/sensors")}async function Ae(){return J("/leneda_api/config")}async function ka(t){await J("/leneda_api/config",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)})}async function Ma(){await J("/leneda_api/config/reset",{method:"POST"})}async function Ut(){try{return await J("/leneda_api/mode")}catch{return{mode:"standalone",configured:!1}}}async function Bt(){return J("/leneda_api/credentials")}async function Ca(t){const e=Ot(t);await J("/leneda_api/credentials",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})}async function Sa(t){const e=Ot(t);return J("/leneda_api/credentials/test",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})}async function qt(){return J("/leneda_api/ha-entities")}const Te=Object.freeze(Object.defineProperty({__proto__:null,fetchConfig:Ae,fetchCredentials:Bt,fetchCustomData:xa,fetchHAEntities:qt,fetchMode:Ut,fetchPerMeterTimeseries:mt,fetchRangeData:Je,fetchSensors:gt,fetchTimeseries:Ie,resetConfig:Ma,saveConfig:ka,saveCredentials:Ca,testCredentials:Sa},Symbol.toStringTag,{value:"Module"}));function yt(t){const e=t.match(/^(\d{4})-(\d{2})-(\d{2})$/);if(e){const[,a,s,o]=e;return new Date(Number(a),Number(s)-1,Number(o))}return new Date(t)}function p(t,e=2){return t==null?"—":t.toLocaleString(void 0,{minimumFractionDigits:0,maximumFractionDigits:e})}function $e(t){return yt(t).toLocaleDateString(void 0,{month:"short",day:"numeric"})}function Yt(t){return yt(t).toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"})}function Le(t){return yt(t).toLocaleDateString(void 0,{year:"numeric",month:"short",day:"numeric"})}const et=[{id:"year",label:"Year",shortLabel:"Yr",stepLabel:"year",approxMs:365*864e5,maxBuckets:30},{id:"month",label:"Month",shortLabel:"Mo",stepLabel:"month",approxMs:30*864e5,maxBuckets:72},{id:"week",label:"Week",shortLabel:"Wk",stepLabel:"week",approxMs:7*864e5,maxBuckets:104},{id:"day",label:"Day",shortLabel:"Day",stepLabel:"day",approxMs:864e5,maxBuckets:370},{id:"hour",label:"Hour",shortLabel:"Hr",stepLabel:"hour",approxMs:36e5,maxBuckets:744},{id:"quarter_hour",label:"15 min",shortLabel:"15m",stepLabel:"15 minutes",approxMs:15*6e4,maxBuckets:672}];function jt(t){return et.find(e=>e.id===t)??et[3]}function vt(t,e){if(!t||!e)return 0;const a=new Date(t).getTime(),s=new Date(e).getTime();return!Number.isFinite(a)||!Number.isFinite(s)?0:Math.max(0,s-a)}function He(t,e){const a=jt(t);if(e<=0)return t==="quarter_hour";const s=e/a.approxMs;return s>=1.5&&s<=a.maxBuckets}function Ta(t,e){var o;if(e&&He(e,t))return e;const a=t/864e5,s=a<=1.25?"quarter_hour":a<=7?"hour":a<=45?"day":a<=180?"week":a<=900?"month":"year";return He(s,t)?s:((o=et.find(n=>He(n.id,t)))==null?void 0:o.id)??"quarter_hour"}function Ea(t,e){return new Date(t,e+1,0).getDate()}function Tt(t,e,a){const s=t.getDate(),o=new Date(t),n=o.getMonth()+a,r=o.getFullYear()+e+Math.floor(n/12),l=(n%12+12)%12,u=Math.min(s,Ea(r,l));return o.setFullYear(r,l,u),o}function Et(t,e,a){switch(e){case"year":return Tt(t,a,0);case"month":return Tt(t,0,a);case"week":return new Date(t.getTime()+a*7*864e5);case"day":return new Date(t.getTime()+a*864e5);case"hour":return new Date(t.getTime()+a*36e5);case"quarter_hour":return new Date(t.getTime()+a*15*6e4)}}function zt(t,e,a,s){if(!t||!e)return null;const o=new Date(t),n=new Date(e);return!Number.isFinite(o.getTime())||!Number.isFinite(n.getTime())?null:{start:Et(o,a,s),end:Et(n,a,s)}}function Da(t,e){if(!t||!e)return"No period loaded";const a=new Date(t),s=new Date(e);if(!Number.isFinite(a.getTime())||!Number.isFinite(s.getTime()))return"No period loaded";if(a.getFullYear()===s.getFullYear()&&a.getMonth()===s.getMonth()&&a.getDate()===s.getDate()){const n=a.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"}),r=a.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"}),l=s.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"});return`${n}, ${r} - ${l}`}return`${a.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})} - ${s.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"})}`}const Ge=[{id:"yesterday",label:"Yesterday"},{id:"this_week",label:"This Week"},{id:"last_week",label:"Last Week"},{id:"this_month",label:"This Month"},{id:"last_month",label:"Last Month"},{id:"this_year",label:"This Year"},{id:"last_year",label:"Last Year"},{id:"custom",label:"Custom"}];function de(t){const e=a=>`
  ...
  `;switch(t){case"consumption":return e(`
      ...
      `)}}function Wa(t){var Be,Pe,fe,De,Ke,we,xe,ke;const e=t.rangeData,a=k=>{if(!k)return"";const E=k.match(/^(\d{4}-\d{2}-\d{2})/);return E?E[1]:""},s=(e==null?void 0:e.consumption)??0,o=(e==null?void 0:e.production)??0,n=(e==null?void 0:e.exported)??0,r=(e==null?void 0:e.self_consumed)??0,l=(e==null?void 0:e.gas_energy)??0,u=(e==null?void 0:e.gas_volume)??0,y=(e==null?void 0:e.peak_power_kw)??0,d=a(e==null?void 0:e.start),v=a(e==null?void 0:e.end),h=(e==null?void 0:e.shared_with_me)??0,f=(e==null?void 0:e.shared)??0,m=Math.max(0,n),$=(e==null?void 0:e.grid_import)!=null?s-e.grid_import:void 0,x=Math.max(0,$??(e==null?void 0:e.solar_to_home)??(e==null?void 0:e.direct_solar_to_home)??(r>0?r:o-m)),C=Math.max(0,(e==null?void 0:e.direct_solar_to_home)??Math.max(0,x-h)),M=x,_=Math.max(0,(e==null?void 0:e.grid_import)??s-x),S=s>0?s:_+x,i=!!((Be=t.config)!=null&&Be.meter_has_gas||(((Pe=t.config)==null?void 0:Pe.meters)??[]).some(k=>k.types.includes("gas"))),c=f+h,g=S>0?Math.min(100,x/S*100):0,b=Math.max(S,o,_,m,f,h,C,1),F=i?Math.min(Math.max(0,l),b):0,D=(k,E=2.8,W=8.2)=>k>0?E+k/b*(W-E):1.8,P=k=>D(k)+1.4,V=k=>D(k)+5.4,I=(k,E=.28,W=.88)=>k>0?E+k/b*(W-E):.1,j=(k,E=.09,W=.22)=>k>0?E+k/b*(W-E):.05,z=(k,E=1.6,W=3.9)=>`${(k>0?Math.max(E,W-k/b*(W-E)):W).toFixed(2)}s`,se=(k,E=3.4,W=5.8)=>k>0?E+k/b*(W-E):3,Q=k=>k>0?Math.max(18,Math.round(k/b*100)):0,ee=k=>`
    <defs>
  ...
  `,q=k=>{const{x:E,y:W,width:G,accent:B,kicker:Me,value:ne,detail:le}=k;return`
      <g class="scene-node-label" transform="translate(${E}, ${W})">
        <rect width="${G}" height="${le?70:54}" rx="18" fill="var(--clr-overlay)" stroke="${B}" />
        <text x="16" y="22" class="scene-node-kicker">${Me}</text>
        <text x="16" y="${le?39:37}" class="scene-node-value">${ne}</text>
        ${le?`<text x="16" y="56" class="scene-node-detail">${le}</text>`:""}
      </g>
    `},ue=k=>{const{x:E,y:W,scale:G=1,glowId:B}=k;return`
    ...
    `},ie=k=>{const{x:E,y:W,scale:G=1,glowId:B}=k;return`
    ...
    `},he=k=>{const{x:E,y:W,scale:G=1,glowId:B}=k;return`
    ...
    `},U=k=>{const{x:E,y:W,scale:G=1,glowId:B}=k;return`
    ...
    `},A=k=>{const{prefix:E,x:W,y:G,scale:B=1}=k;return`
      <g class="elite-house" transform="translate(${W}, ${G}) scale(${B})">
        ...
        <g transform="translate(90, 124)">
          ...
          <text text-anchor="middle" y="18" class="house-core-value">${p(g,0)}%</text>
        </g>
    ...
    `},N=k=>{const{path:E,value:W,gradientId:G,colorVar:B,filterId:Me,particleClass:ne,direction:le="forward"}=k,Ce=le==="reverse"?"1;0":"0;1";return`
      <path
        class="flow-halo ${ne}"
        d="${E}"
        stroke="url(#${G})"
        stroke-width="${V(W).toFixed(1)}"
        stroke-opacity="${j(W).toFixed(2)}"
      ...
      ${W>0?`
        <circle
          ...
          filter="url(#${Me})"
        >
          <animateMotion dur="${z(W)}" repeatCount="indefinite" path="${E}" keyPoints="${Ce}" keyTimes="0;1" calcMode="linear" />
        </circle>
        <circle
          ...
          filter="url(#${Me})"
        >
          <animateMotion dur="${z(W)}" begin="-${(parseFloat(z(W))/2).toFixed(2)}s" repeatCount="indefinite" path="${E}" keyPoints="${Ce}" keyTimes="0;1" calcMode="linear" />
        </circle>
      `:""}
    `},re=()=>`
    <div class="elite-scene elite-scene-desktop">
      <svg class="elite-main-svg" viewBox="0 0 860 460" fill="none" preserveAspectRatio="xMidYMid meet">
        ...
        ${q({x:58,y:108,width:152,accent:"rgba(248, 81, 73, 0.26)",kicker:"Grid",value:`${p(_+m)} kWh`,detail:m>0?`In ${p(_)} / out ${p(m)} kWh`:void 0})}
        ...
        ${ie({x:430,y:126,glowId:"desktop-glow-green"})}
        ...
        ${N({path:"M 496 268 C 430 298 326 314 176 316",value:m,gradientId:"desktop-flow-grid-out",colorVar:"var(--clr-export)",filterId:"desktop-glow-blue",particleClass:"flow-grid-out"})}
        ...
        ${i?N({path:"M 430 404 C 430 370 430 336 430 302",value:F,gradientId:"desktop-flow-gas",colorVar:"var(--clr-gas)",filterId:"desktop-glow-gas",particleClass:"flow-gas"}):""}
      </svg>
    </div>
  `,te=()=>`
    <div class="elite-scene elite-scene-mobile">
      <svg class="elite-main-svg" viewBox="0 0 420 560" fill="none" preserveAspectRatio="xMidYMid meet">
        ...
        ${q({x:20,y:194,width:126,accent:"rgba(248, 81, 73, 0.26)",kicker:"Grid",value:`${p(_+m)} kWh`})}
        ...
        ${ie({x:210,y:126,scale:.92,glowId:"mobile-glow-green"})}
        ...
        ${N({path:"M 226 318 C 194 340 162 348 102 350",value:m,gradientId:"mobile-flow-grid-out",colorVar:"var(--clr-export)",filterId:"mobile-glow-blue",particleClass:"flow-grid-out"})}
        ...
        ${i?N({path:"M 210 474 C 210 432 210 390 210 344",value:F,gradientId:"mobile-flow-gas",colorVar:"var(--clr-gas)",filterId:"mobile-glow-gas",particleClass:"flow-gas"}):""}
      </svg>
    </div>
  `,X=e!=null&&e.start&&(e!=null&&e.end)?`${$e(e.start)} — ${$e(e.end)}`:t.range==="custom"&&t.customStart&&t.customEnd?`${$e(t.customStart+"T00:00:00")} — ${$e(t.customEnd+"T00:00:00")}`:((fe=Ge.find(k=>k.id===t.range))==null?void 0:fe.label)??"Yesterday",_e=(Ke=(De=t.consumptionTimeseries)==null?void 0:De.items)!=null&&Ke.length?t.consumptionTimeseries.items:((we=t.productionTimeseries)==null?void 0:we.items)??[],Y=t.chartViewportStart??((xe=_e[0])==null?void 0:xe.startedAt)??(e==null?void 0:e.start),me=t.chartViewportEnd??((ke=_e[_e.length-1])==null?void 0:ke.startedAt)??(e==null?void 0:e.end),ae=vt(Y,me),ge=jt(t.chartTimeBucket),Ee=Da(Y,me),ve=zt(Y,me,t.chartTimeBucket,1),bt=new Date,Z=!ve||ve.start.getTime()>bt.getTime(),Oe=et.map(k=>{const E=He(k.id,ae),W=k.id===t.chartTimeBucket,G=k.id==="quarter_hour"?"15-minute detail would be too dense for this selected period":`${k.label} detail does not add useful resolution for this selected period`;return`
            <button
              class="unit-btn chart-bucket-btn ${W?"active":""}"
              data-chart-bucket="${k.id}"
              title="${E?`Show ${k.label.toLowerCase()} detail`:G}"
              ${E?"":'disabled aria-disabled="true"'}
            >${k.label}</button>
          `}).join(""),st=t.chartUnit==="kw"?"kW uses the same detail presets as kWh, but keeps power values in interval bars so short spikes and dips stay visible.":"kWh keeps the aggregated period bars for totals.",Ue=`${t.chartConsumptionView==="house"?"Total Usage shows the full house load, with the solar-covered share highlighted in green and exports below zero. Use the detail presets and arrows above the graph to move through time.":t.chartConsumptionView==="solar_systems"?"PV Systems stacks each configured solar production meter so you can compare panel-system output like the Home Assistant Energy dashboard.":"Net Grid focuses on what still came from the grid after solar, with exports shown below zero. The reference limit in kW mode applies here."} ${st}`,ye=((e==null?void 0:e.exceedance_kwh)??0)>0?de("warning"):de("ok");return`
    <div class="dashboard" style="position: relative;">
      <div style="position:fixed;bottom:4px;right:4px;font-size:10px;opacity:0.5;pointer-events:none;z-index:9999;">v:2.10.3</div>
        ...
        <div class="card flow-card">
          ...
          <div class="leneda-elite-flow">
            ...
            <div class="flow-scene-summary">
              <span class="flow-scene-chip solar">Solar coverage ${p(g,0)}%</span>
              <span class="flow-scene-chip import">Grid import ${p(_)} kWh</span>
              <span class="flow-scene-chip export">Export ${p(m)} kWh</span>
            ...
            <div class="mobile-flow-summary">
              <div class="mobile-flow-house">
                ...
                <span class="mobile-flow-house-meta">
                  ${p(g,0)}% of home usage solar-covered${y>0?` · Peak ${p(y,2)} kW`:""}
                </span>
              </div>
              ...
              <div class="mobile-flow-list">
                ...
                <div class="mobile-flow-item export">
                  <div class="mobile-flow-item-top">
                    ...
                    <strong>${p(m)} kWh</strong>
                  </div>
                  <div class="mobile-flow-bar"><span style="width: ${Q(m)}%;"></span></div>
            ...
            <div class="flow-legend">
              ...
              <div class="flow-legend-item export">
                ...
                <span class="flow-legend-copy">
                  ...
                  <span>${p(m)} kWh sent back to the market or grid</span>
                </span>
              </div>
        ...
        <div class="metrics-list">
          <div class="metric">
            <div class="metric-header">
              ...
              <span class="metric-value">${p(g,1)}%</span>
            </div>
            <div class="metric-bar">
              <div class="metric-fill" style="width: ${g}%"></div>
            </div>
          </div>
          <div class="metric">
            <div class="metric-header">
          ...
          <div class="metric ${((e==null?void 0:e.exceedance_kwh)??0)>0?"metric-warning":"metric-ok"}">
            <div class="metric-header">
              <span class="metric-label"><span class="metric-status-icon">${ye}</span> Exceedance</span>
      ...
      <div class="card chart-card">
        <div class="chart-header">
          <h3 class="card-title"><span class="title-icon">${de("profile")}</span> Energy Profile — ${X}</h3>
          ...
          <div class="chart-control-stack">
            <div class="chart-period-controls" aria-label="Move chart period">
              ...
              >&larr;</button>
              <span class="chart-period-pill">${Ee}</span>
              <button
                class="chart-nav-btn"
  ...
  `}function Fa(t=""){return{iso:t,consumptionKw:0,productionKw:0,gridImportKw:0,solarExportKw:0}}function je(t,e,a){for(const s of(e==null?void 0:e.items)??[]){const o=new Date(s.startedAt).getTime();if(!Number.isFinite(o))continue;const n=t.get(o)??Fa(s.startedAt);n[a]+=Math.max(0,Number(s.value)||0),n.iso||(n.iso=s.startedAt),t.set(o,n)}}function La(t,e,a={}){var r,l,u,y;const s=new Map,o=!!((l=(r=a.gridImport)==null?void 0:r.items)!=null&&l.length),n=!!((y=(u=a.marketExport)==null?void 0:u.items)!=null&&y.length);return je(s,t,"consumptionKw"),je(s,e,"productionKw"),je(s,a.gridImport,"gridImportKw"),je(s,a.marketExport,"solarExportKw"),[...s.entries()].sort((d,v)=>d[0]-v[0]).map(([d,v])=>{const h=Math.max(0,v.consumptionKw),f=Math.max(0,v.productionKw),m=Math.max(0,Math.min(h,f)),$=o?Math.max(0,v.gridImportKw):Math.max(0,h-m),x=Math.max(0,h-$),C=n?Math.max(0,v.solarExportKw):Math.max(0,f-m);return{timestamp:d,iso:v.iso||new Date(d).toISOString(),consumptionKw:h,productionKw:f,solarToHomeKw:x,gridImportKw:$,solarExportKw:C}})}function Ne(t,e){return Number.isFinite(t)?Number(t):e}function pt(t,e,a){return Math.min(a,Math.max(e,t))}function Pa(t,e,a){const s=t.reduce((f,m)=>f+m.producedKwh,0),o=t.reduce((f,m)=>f+m.selfConsumedKwh,0),n=t.reduce((f,m)=>f+m.exportedKwh,0),r=Ne(e,o),l=Ne(a,n),u=Math.max(0,r)+Math.max(0,l),y=Math.max(0,s-Math.max(0,l));if(s<=0)return{selfConsumedKwh:0,exportedKwh:0};if(u<=s+1e-6)return{selfConsumedKwh:pt(Math.max(Math.max(0,r),y),0,s),exportedKwh:pt(Math.max(0,l),0,s)};const d=u>0?Math.max(0,r)/u:0,v=Math.min(s,Math.max(0,r)),h=pt(s*d,0,v);return{selfConsumedKwh:h,exportedKwh:Math.max(0,s-h)}}function Ka(t,e){const a=t?t.slice(-8):"";return a?`Solar ${e} (${a})`:`Solar ${e}`}function Qe(t,e,a){return(typeof a=="string"?a.trim():"")||Ka(t,e)}function ft(t){const e=(t.meters??[]).filter(o=>o.types.includes("production")),a=t.feed_in_rates??[],s=t.currency??"EUR";return e.map((o,n)=>{const r=a.find(v=>v.meter_id===o.id),l=(r==null?void 0:r.mode)==="sensor"&&r.sensor_value!=null&&Number.isFinite(r.sensor_value),u=l?(r==null?void 0:r.sensor_value)??0:Ne(r==null?void 0:r.tariff,Ne(t.feed_in_tariff,0)),y=Math.max(1,Math.round(Ne(r==null?void 0:r.self_use_priority,n+1))),d=Qe(o.id,n+1,r==null?void 0:r.display_name);return{meterId:o.id,shortId:o.id?"…"+o.id.slice(-8):`Meter ${n+1}`,displayName:d,rate:u,label:l?`Sensor (${u.toFixed(4)} ${s}/kWh)`:"Fixed tariff",mode:(r==null?void 0:r.mode)??"fixed",selfUsePriority:y}}).sort((o,n)=>o.selfUsePriority!==n.selfUsePriority?o.selfUsePriority-n.selfUsePriority:o.meterId.localeCompare(n.meterId))}function wt(t,e,a,s,o){var c;if(!e||!(a!=null&&a.length))return null;const n=ft(t);if(!n.length)return null;const r=new Map(a.map(g=>[g.meter_id,g]));if(!n.some(g=>r.has(g.meterId)))return null;const l=n.map(g=>({...g,producedKwh:0,selfConsumedKwh:0,exportedKwh:0,revenue:0,exportEquivalentForSelfUse:0})),u=new Map(l.map((g,b)=>[g.meterId,b])),y=new Map,d=new Set;for(const g of e.items)g.startedAt&&d.add(g.startedAt);const v=new Map;for(const g of e.items){const b=Math.max(0,Number(g.value)||0);v.set(g.startedAt,(v.get(g.startedAt)??0)+b)}for(const g of a){const b=new Map;for(const F of g.items??[]){const D=Math.max(0,Number(F.value)||0);b.set(F.startedAt,(b.get(F.startedAt)??0)+D),F.startedAt&&d.add(F.startedAt)}y.set(g.meter_id,b)}for(const g of[...d].sort()){let b=Math.max(0,v.get(g)??0);for(const F of l){const D=u.get(F.meterId);if(D==null)continue;const P=Math.max(0,((c=y.get(F.meterId))==null?void 0:c.get(g))??0),V=P*.25,I=Math.min(b,P),j=I*.25,z=Math.max(0,P-I)*.25;l[D].producedKwh+=V,l[D].selfConsumedKwh+=j,l[D].exportedKwh+=z,b=Math.max(0,b-I)}}const h=l.reduce((g,b)=>g+b.selfConsumedKwh,0),f=l.reduce((g,b)=>g+b.exportedKwh,0),m=Pa(l,s,o),$=m.selfConsumedKwh,x=m.exportedKwh,C=h>0?$/h:1,M=f>0?x/f:1;for(const g of l)g.selfConsumedKwh*=C,g.exportedKwh*=M,g.revenue=g.exportedKwh*g.rate,g.exportEquivalentForSelfUse=g.selfConsumedKwh*g.rate;const _=l.reduce((g,b)=>g+b.revenue,0),S=l.reduce((g,b)=>g+b.exportEquivalentForSelfUse,0),i=x>0?_/x:0;return{meters:l,totalFeedInRevenue:_,totalSelfUseExportEquivalent:S,weightedExportRate:i,usedPriorityAllocation:!0}}const Dt=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],Ve={house:"Total Usage",grid:"Net Grid",solar:"Solar Production",exceedance_kwh:"Exceedance kWh",exceedance_frequency:"Exceedance Rate"},ze={house:"Total Usage",grid:"Net Grid",solar:"Solar Production"},Fe={previous:"Previous Period",last_year:"Last Year"};function Wt(t){if(!t)return"";const e=t.match(/^(\d{4}-\d{2}-\d{2})/);return e?e[1]:""}function Va(t){const e=new Date(t),a=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),o=String(e.getDate()).padStart(2,"0");return`${a}-${s}-${o}`}function Ra(t){const[e,a,s]=t.split("-").map(Number);return new Date(e,a-1,s,12,0,0,0)}function oe(t,e=0){return t.length?Math.max(...t):e}function $t(t,e=0){return t.length?Math.min(...t):e}function be(t,e,a){return Math.min(a,Math.max(e,t))}function O(t,e){if(!t.length)return 0;const a=[...t].sort((u,y)=>u-y),s=be(e,0,1),o=(a.length-1)*s,n=Math.floor(o),r=Math.ceil(o);if(n===r)return a[n];const l=o-n;return a[n]*(1-l)+a[r]*l}function Ia(t){const e=Math.floor(t/4),a=t%4*15;return`${String(e).padStart(2,"0")}:${String(a).padStart(2,"0")}`}function R(t,e){return`${p(t,2)} ${e}`}function tt(t,e){return`${t>0?"+":t<0?"-":""}${p(Math.abs(t),2)} ${e}`}function Xe(t,e=1){return Math.abs(t)<.005?"0":`${t>0?"+":""}${p(t,e)}`}function Ft(t){const[e,a]=t.split(":").map(s=>parseInt(s,10)||0);return e*60+a}function Aa(t,e){return e==="all"?!0:e==="weekdays"?t>=1&&t<=5:t===0||t===6}function Xt(t,e,a,s){if(!Aa(t.getDay(),e))return!1;const o=t.getHours()*60+t.getMinutes(),n=Ft(a),r=Ft(s);return n===r?!0:n<r?o>=n&&o<r:o>=n||o<r}function Ha(t,e){return e.find(a=>Xt(t,a.day_group,a.start_time,a.end_time))}function Na(t,e){return e.find(a=>Xt(t,a.day_group,a.start_time,a.end_time))}function Zt(t,e,a,s,o){const n=wt(t,e,a,s,o);if(n&&n.weightedExportRate>0)return n.weightedExportRate;const r=ft(t).map(l=>l.rate).filter(l=>Number.isFinite(l)&&l>=0);return r.length?r.reduce((l,u)=>l+u,0)/r.length:t.feed_in_tariff??0}function Ga(t,e,a,s,o,n){const r=o.consumption_rate_windows??[],l=o.reference_power_windows??[],u=o.reference_power_kw??0,y=(o.exceedance_rate??0)*(1+(o.vat_rate??0));return La(t,e,{gridImport:a,marketExport:s}).map(d=>{var b,F;const v=d.timestamp,h=new Date(v),f=d.consumptionKw,m=d.productionKw,$=d.solarToHomeKw,x=d.gridImportKw,C=d.solarExportKw,M=((b=Na(h,l))==null?void 0:b.reference_power_kw)??u,_=Math.max(0,f-M),S=Math.max(0,x-M),i=Math.max(0,_-S),g=((((F=Ha(h,r))==null?void 0:F.rate)??o.energy_variable_rate??0)+(o.network_variable_rate??0)+(o.electricity_tax_rate??0)+(o.compensation_fund_rate??0))*(1+(o.vat_rate??0));return{timestamp:v,iso:d.iso,date:h,houseKw:f,solarKw:m,solarToHomeKw:$,gridKw:x,exportKw:C,referenceKw:M,overKw:S,avoidedOverKw:i,importRateWithVat:g,feedInRate:n,exceedanceRateWithVat:y}})}function Jt(t,e,a,s,o,n){const r=Ga(t,e,a,s,o,n),l=new Map,u=Array.from({length:24},()=>0),y=Array.from({length:24},(i,c)=>({label:`${String(c).padStart(2,"0")}:00`,importCost:0,exportSpreadValue:0,gridKwh:0,exportKwh:0})),d={house:Array.from({length:7},()=>Array.from({length:24},()=>({sum:0,count:0}))),grid:Array.from({length:7},()=>Array.from({length:24},()=>({sum:0,count:0}))),solar:Array.from({length:7},()=>Array.from({length:24},()=>({sum:0,count:0}))),exceedance_kwh:Array.from({length:7},()=>Array.from({length:24},()=>({sum:0,count:0}))),exceedance_frequency:Array.from({length:7},()=>Array.from({length:24},()=>({sum:0,count:0})))},v=()=>Array.from({length:96},()=>[]),h={house:{weekday:v(),weekend:v()},grid:{weekday:v(),weekend:v()},solar:{weekday:v(),weekend:v()}},f={houseKwh:0,solarKwh:0,solarToHomeKwh:0,gridKwh:0,exportKwh:0,exceedanceKwh:0,avoidedExceedanceKwh:0,importCost:0,solarSavings:0,exportRevenue:0,selfConsumptionAdvantage:0,exceedanceCost:0,avoidedExceedanceValue:0,solarValue:0,netValue:0,coveragePct:0,selfConsumedPct:0,peakGridKw:0,peakHouseKw:0,exceedanceIntervals:0};for(const i of r){const g=Va(i.timestamp),b=l.get(g)??(()=>{const te=Ra(g);return{key:g,label:te.toLocaleDateString(void 0,{month:"short",day:"numeric"}),fullDate:te.toLocaleDateString(void 0,{weekday:"short",month:"short",day:"numeric"}),houseKwh:0,solarKwh:0,solarToHomeKwh:0,gridKwh:0,exportKwh:0,exceedanceKwh:0,avoidedExceedanceKwh:0,importCost:0,solarSavings:0,exportRevenue:0,selfConsumptionAdvantage:0,exceedanceCost:0,avoidedExceedanceValue:0,solarValue:0,netValue:0,coveragePct:0,selfConsumedPct:0,peakGridKw:0,peakHouseKw:0,exceedanceIntervals:0}})(),F=i.houseKw*.25,D=i.solarKw*.25,P=i.solarToHomeKw*.25,V=i.gridKw*.25,I=i.exportKw*.25,j=i.overKw*.25,z=i.avoidedOverKw*.25,se=V*i.importRateWithVat,Q=P*i.importRateWithVat,ee=I*i.feedInRate,q=P*(i.importRateWithVat-i.feedInRate),ue=j*i.exceedanceRateWithVat,ie=z*i.exceedanceRateWithVat,he=Q+ee+ie-se-ue;b.houseKwh+=F,b.solarKwh+=D,b.solarToHomeKwh+=P,b.gridKwh+=V,b.exportKwh+=I,b.exceedanceKwh+=j,b.avoidedExceedanceKwh+=z,b.importCost+=se,b.solarSavings+=Q,b.exportRevenue+=ee,b.selfConsumptionAdvantage+=q,b.exceedanceCost+=ue,b.avoidedExceedanceValue+=ie,b.netValue+=he,b.peakGridKw=Math.max(b.peakGridKw,i.gridKw),b.peakHouseKw=Math.max(b.peakHouseKw,i.houseKw),b.exceedanceIntervals+=i.overKw>0?1:0,l.set(g,b),f.houseKwh+=F,f.solarKwh+=D,f.solarToHomeKwh+=P,f.gridKwh+=V,f.exportKwh+=I,f.exceedanceKwh+=j,f.avoidedExceedanceKwh+=z,f.importCost+=se,f.solarSavings+=Q,f.exportRevenue+=ee,f.selfConsumptionAdvantage+=q,f.exceedanceCost+=ue,f.avoidedExceedanceValue+=ie,f.netValue+=he,f.peakGridKw=Math.max(f.peakGridKw,i.gridKw),f.peakHouseKw=Math.max(f.peakHouseKw,i.houseKw),f.exceedanceIntervals+=i.overKw>0?1:0;const U=(i.date.getDay()+6)%7,A=i.date.getHours(),N=A*4+Math.floor(i.date.getMinutes()/15),re=i.date.getDay()===0||i.date.getDay()===6?"weekend":"weekday";d.house[U][A].sum+=i.houseKw,d.house[U][A].count+=1,d.grid[U][A].sum+=i.gridKw,d.grid[U][A].count+=1,d.solar[U][A].sum+=i.solarKw,d.solar[U][A].count+=1,d.exceedance_kwh[U][A].sum+=j,d.exceedance_kwh[U][A].count+=1,d.exceedance_frequency[U][A].sum+=i.overKw>0?1:0,d.exceedance_frequency[U][A].count+=1,u[A]+=j,h.house[re][N].push(i.houseKw),h.grid[re][N].push(i.gridKw),h.solar[re][N].push(i.solarKw),y[A].importCost+=se,y[A].exportSpreadValue+=I*Math.max(i.importRateWithVat-i.feedInRate,0),y[A].gridKwh+=V,y[A].exportKwh+=I}const m=[...l.values()].sort((i,c)=>i.key.localeCompare(c.key)).map(i=>(i.coveragePct=i.houseKwh>0?i.solarToHomeKwh/i.houseKwh*100:0,i.selfConsumedPct=i.solarKwh>0?be(i.solarToHomeKwh/i.solarKwh*100,0,100):0,i.solarValue=i.solarSavings+i.exportRevenue+i.avoidedExceedanceValue,i));f.coveragePct=f.houseKwh>0?f.solarToHomeKwh/f.houseKwh*100:0,f.selfConsumedPct=f.solarKwh>0?be(f.solarToHomeKwh/f.solarKwh*100,0,100):0,f.solarValue=f.solarSavings+f.exportRevenue+f.avoidedExceedanceValue;const $={house:d.house.map(i=>i.map(c=>c.count?c.sum/c.count:0)),grid:d.grid.map(i=>i.map(c=>c.count?c.sum/c.count:0)),solar:d.solar.map(i=>i.map(c=>c.count?c.sum/c.count:0)),exceedance_kwh:d.exceedance_kwh.map(i=>i.map(c=>c.sum)),exceedance_frequency:d.exceedance_frequency.map(i=>i.map(c=>c.count?c.sum/c.count*100:0))},x=Array.from({length:96},(i,c)=>Ia(c)),C={house:{weekday:{lower:h.house.weekday.map(i=>O(i,.1)),median:h.house.weekday.map(i=>O(i,.5)),upper:h.house.weekday.map(i=>O(i,.9))},weekend:{lower:h.house.weekend.map(i=>O(i,.1)),median:h.house.weekend.map(i=>O(i,.5)),upper:h.house.weekend.map(i=>O(i,.9))}},grid:{weekday:{lower:h.grid.weekday.map(i=>O(i,.1)),median:h.grid.weekday.map(i=>O(i,.5)),upper:h.grid.weekday.map(i=>O(i,.9))},weekend:{lower:h.grid.weekend.map(i=>O(i,.1)),median:h.grid.weekend.map(i=>O(i,.5)),upper:h.grid.weekend.map(i=>O(i,.9))}},solar:{weekday:{lower:h.solar.weekday.map(i=>O(i,.1)),median:h.solar.weekday.map(i=>O(i,.5)),upper:h.solar.weekday.map(i=>O(i,.9))},weekend:{lower:h.solar.weekend.map(i=>O(i,.1)),median:h.solar.weekend.map(i=>O(i,.5)),upper:h.solar.weekend.map(i=>O(i,.9))}}},M=r.filter(i=>i.overKw>0).sort((i,c)=>c.overKw-i.overKw||c.timestamp-i.timestamp).slice(0,8),_=[...r].sort((i,c)=>c.houseKw-i.houseKw||c.timestamp-i.timestamp).slice(0,8),S=[...m].filter(i=>i.exceedanceKwh>0).sort((i,c)=>c.exceedanceKwh-i.exceedanceKwh).slice(0,6);return{points:r,daily:m,totals:f,topExceedances:M,peakIntervals:_,hourlyExceedanceKwh:u,heatmapValues:$,intradayProfiles:C,intradayLabels:x,hourlyOpportunity:y,loadDurationGrossKw:r.map(i=>i.houseKw).sort((i,c)=>c-i),loadDurationNetKw:r.map(i=>i.gridKw).sort((i,c)=>c-i),worstDays:S}}function Oa(t){var e,a,s;return(e=t.rangeData)!=null&&e.start&&((a=t.rangeData)!=null&&a.end)?`${$e(t.rangeData.start)} - ${$e(t.rangeData.end)}`:((s=Ge.find(o=>o.id===t.range))==null?void 0:s.label)??"Selected Period"}function Ua(t){var e,a;return(e=t.rangeData)!=null&&e.start&&((a=t.rangeData)!=null&&a.end)?`${Le(t.rangeData.start)} - ${Le(t.rangeData.end)}`:t.range==="custom"&&t.customStart&&t.customEnd?`${t.customStart} - ${t.customEnd}`:"Based on the currently selected range."}function Lt(t){const e=t.analysisComparisonMode==="last_year"?"Same period last year":"Previous matched period";return t.analysisComparison?`${e}: ${Le(t.analysisComparison.start)} - ${Le(t.analysisComparison.end)}`:e}function Ba(t){switch(t){case"house":return{description:"Average hourly power by weekday for total house usage.",note:"Each cell shows the average kW seen in that weekday/hour slot over the selected period."};case"grid":return{description:"Average hourly power by weekday for remaining grid draw after solar.",note:"Each cell shows the average net-grid kW seen in that weekday/hour slot over the selected period."};case"solar":return{description:"Average hourly power by weekday for solar production.",note:"Each cell shows the average solar kW seen in that weekday/hour slot over the selected period."};case"exceedance_kwh":return{description:"Cumulative exceedance energy by weekday and hour, showing where the reference limit hurt the most.",note:"Each cell shows cumulative exceedance kWh recorded in that weekday/hour slot over the selected period."};case"exceedance_frequency":return{description:"How often each weekday/hour slot went over the reference limit.",note:"Each cell shows the share of 15-minute intervals in that weekday/hour slot that exceeded the reference limit."}}}function qa(t,e){switch(t){case"house":case"grid":case"solar":return`${p(e,2)} kW average`;case"exceedance_kwh":return`${p(e,2)} kWh`;case"exceedance_frequency":return`${p(e,0)}% of intervals`}}function pe(t){const e=t.series.filter(g=>g.values.length>0);if(!e.length)return'<div class="analysis-empty">No chart data available for this period.</div>';const a=Math.max(...e.map(g=>g.values.length)),s=Math.max(720,a*24+92),o=244,n=50,r=20,l=18,u=30,y=e.flatMap(g=>g.values);t.referenceValue!=null&&y.push(t.referenceValue);let d=t.minValue??$t(y,0),v=t.maxValue??oe(y,1);d===v&&(v+=1,d=Math.min(0,d-1)),t.minValue==null&&(d=Math.min(0,d));const h=s-n-r,f=o-l-u,m=(g,b)=>b<=1?n+h/2:n+g*h/(b-1),$=g=>l+(v-g)/(v-d)*f,x=t.valueFormatter??(g=>p(g,1)),C=Array.from({length:4},(g,b)=>d+(v-d)/3*b),M=[0,Math.floor((a-1)/2),a-1].filter((g,b,F)=>F.indexOf(g)===b),_=C.map(g=>{const b=$(g);return`
      <line x1="${n}" y1="${b.toFixed(1)}" x2="${(s-r).toFixed(1)}" y2="${b.toFixed(1)}" class="analysis-svg-grid" />
      <text x="${n-8}" y="${(b+4).toFixed(1)}" class="analysis-svg-tick">${x(g)}</text>
    `}).join(""),S=t.referenceValue!=null?(()=>{const g=$(t.referenceValue);return`
        <line x1="${n}" y1="${g.toFixed(1)}" x2="${(s-r).toFixed(1)}" y2="${g.toFixed(1)}" class="analysis-svg-reference" />
        ${t.referenceLabel?`<text x="${s-r}" y="${(g-8).toFixed(1)}" class="analysis-svg-reference-label">${t.referenceLabel}</text>`:""}
      `})():"",i=e.map(g=>{const b=g.values.map((D,P)=>{const V=m(P,g.values.length),I=$(D);return`${P===0?"M":"L"} ${V.toFixed(1)} ${I.toFixed(1)}`}).join(" "),F=g.values.length<=40?g.values.map((D,P)=>{const V=m(P,g.values.length),I=$(D);return`<circle cx="${V.toFixed(1)}" cy="${I.toFixed(1)}" r="2.6" fill="${g.color}" />`}).join(""):"";return`
      <path d="${b}" fill="none" stroke="${g.color}" stroke-width="2.5" ${g.dashed?'stroke-dasharray="6 4"':""} />
      ${F}
    `}).join(""),c=M.map(g=>{const b=m(g,a),F=t.labels[g]??`Point ${g+1}`;return`<text x="${b.toFixed(1)}" y="${o-8}" text-anchor="middle" class="analysis-svg-x-label">${F}</text>`}).join("");return`
  ...
  `}function Ya(t){const e=t.series.filter(c=>c.band.median.length>0);if(!e.length)return'<div class="analysis-empty">No profile data available for this period.</div>';const a=Math.max(...e.map(c=>c.band.median.length)),s=Math.max(760,a*12+92),o=248,n=50,r=20,l=18,u=30,y=e.flatMap(c=>[...c.band.lower,...c.band.median,...c.band.upper]),d=Math.min(0,$t(y,0));let v=oe(y,1);v<=d&&(v=d+1);const h=s-n-r,f=o-l-u,m=(c,g)=>g<=1?n+h/2:n+c*h/(g-1),$=c=>l+(v-c)/(v-d)*f,x=t.valueFormatter??(c=>p(c,1)),C=Array.from({length:4},(c,g)=>d+(v-d)/3*g),M=[0,16,32,48,64,80,a-1].filter((c,g,b)=>c>=0&&c<a&&b.indexOf(c)===g),_=C.map(c=>{const g=$(c);return`
      <line x1="${n}" y1="${g.toFixed(1)}" x2="${(s-r).toFixed(1)}" y2="${g.toFixed(1)}" class="analysis-svg-grid" />
      <text x="${n-8}" y="${(g+4).toFixed(1)}" class="analysis-svg-tick">${x(c)}</text>
    `}).join(""),S=e.map(c=>{const g=c.band.upper.map((D,P)=>{const V=m(P,c.band.upper.length),I=$(D);return`${P===0?"M":"L"} ${V.toFixed(1)} ${I.toFixed(1)}`}).join(" "),b=[...c.band.lower].reverse().map((D,P)=>{const V=c.band.lower.length-1-P,I=m(V,c.band.lower.length),j=$(D);return`L ${I.toFixed(1)} ${j.toFixed(1)}`}).join(" "),F=c.band.median.map((D,P)=>{const V=m(P,c.band.median.length),I=$(D);return`${P===0?"M":"L"} ${V.toFixed(1)} ${I.toFixed(1)}`}).join(" ");return`
      <path d="${g} ${b} Z" fill="${c.fill}" stroke="none" />
      <path d="${F}" fill="none" stroke="${c.color}" stroke-width="2.4" ${c.dashed?'stroke-dasharray="6 4"':""} />
    `}).join(""),i=M.map(c=>{const g=m(c,a),b=t.labels[c]??`Point ${c+1}`;return`<text x="${g.toFixed(1)}" y="${o-8}" text-anchor="middle" class="analysis-svg-x-label">${b}</text>`}).join("");return`
    <div class="analysis-chart-scroller">
  ...
  `}function ja(t){const e=new Date(t.timestamp);return{date:e.toLocaleDateString(void 0,{month:"short",day:"numeric"}),time:e.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"})}}function za(t){if(!t.length)return'<div class="analysis-empty">No peak intervals available for this period.</div>';const e=Math.max(760,t.length*86+96),a=276,s=52,o=16,n=18,r=54,l=oe(t.map($=>$.houseKw),1),u=e-s-o,y=a-n-r,d=n+y,v=u/t.length,h=Math.max(22,Math.min(38,v*.54)),f=t.map(($,x)=>{const C=s+x*v+(v-h)/2,M=$.solarToHomeKw/l*y,S=Math.max(0,Math.min($.gridKw,$.referenceKw))/l*y,i=Math.max(0,$.gridKw-$.referenceKw)/l*y;return`
      <g>
        <rect x="${C.toFixed(1)}" y="${(d-M).toFixed(1)}" width="${h.toFixed(1)}" height="${M.toFixed(1)}" rx="4" fill="rgba(63, 185, 80, 0.85)" />
        <rect x="${C.toFixed(1)}" y="${(d-M-S).toFixed(1)}" width="${h.toFixed(1)}" height="${S.toFixed(1)}" rx="4" fill="rgba(248, 81, 73, 0.62)" />
        ${i>0?`<rect x="${C.toFixed(1)}" y="${(d-M-S-i).toFixed(1)}" width="${h.toFixed(1)}" height="${i.toFixed(1)}" rx="4" fill="rgba(210, 153, 34, 0.92)" />`:""}
      </g>
    `}).join(""),m=t.map(($,x)=>{const C=s+x*v+v/2,{date:M,time:_}=ja($);return`
      <text x="${C.toFixed(1)}" y="${a-20}" text-anchor="middle" class="analysis-svg-x-label">
        <tspan x="${C.toFixed(1)}" dy="0">${M}</tspan>
  ...
  `}function Xa(t){if(!t.length)return'<div class="analysis-empty">No daily energy data available.</div>';const e=Math.max(760,t.length*28+84),a=250,s=52,o=16,n=18,r=34,l=oe(t.map(_=>_.houseKwh),1),u=oe(t.map(_=>_.exportKwh),0),y=e-s-o,d=a-n-r,v=u>0?d*.72:d,h=u>0?d-v:0,f=n+v,m=y/t.length,$=Math.max(8,Math.min(18,m*.62)),x=Math.max(1,Math.ceil(t.length/10)),C=t.map((_,S)=>{const i=s+S*m+(m-$)/2,c=_.solarToHomeKwh/l*v,g=_.gridKwh/l*v,b=u>0?_.exportKwh/u*h:0,F=f-c-g-8;return`
      <g>
        <rect x="${i.toFixed(1)}" y="${(f-c).toFixed(1)}" width="${$.toFixed(1)}" height="${c.toFixed(1)}" rx="3" fill="rgba(63, 185, 80, 0.85)" />
        <rect x="${i.toFixed(1)}" y="${(f-c-g).toFixed(1)}" width="${$.toFixed(1)}" height="${g.toFixed(1)}" rx="3" fill="rgba(248, 81, 73, 0.55)" />
    ...
    `}).join(""),M=t.map((_,S)=>S%x!==0&&S!==t.length-1?"":`<text x="${(s+S*m+m/2).toFixed(1)}" y="${a-10}" text-anchor="middle" class="analysis-svg-x-label">${_.label}</text>`).join("");return`
    <div class="analysis-chart-scroller">
  ...
  `}function Za(t,e){const a=be(e,0,1);return t==="solar"?`rgba(63, 185, 80, ${.12+a*.82})`:t==="exceedance_kwh"||t==="exceedance_frequency"?`rgba(210, 153, 34, ${.14+a*.82})`:t==="grid"?`rgba(210, 153, 34, ${.12+a*.82})`:`rgba(248, 81, 73, ${.12+a*.82})`}function Ja(t,e){const a=t.flat(),s=oe(a,1),o=$t(a,0);return`
    <div class="analysis-heatmap">
      ...
      ${t.map((n,r)=>`
        <div class="analysis-heatmap-row">
          <span class="analysis-heatmap-day">${Dt[r]}</span>
          ${n.map((l,u)=>{const y=s===o?0:(l-o)/(s-o);return`
              <span
                class="analysis-heatmap-cell"
                style="background:${Za(e,y)};"
                title="${Dt[r]} ${String(u).padStart(2,"0")}:00 - ${qa(e,l)}"
              >${l>(e==="exceedance_frequency"?1:.05)?p(l,e==="exceedance_frequency"?0:1):""}</span>
            `}).join("")}
        </div>
      `).join("")}
    </div>
  `}function at(t){const e=oe(t.map(a=>a.value),1);return t.length?`
  ...
  `:'<div class="analysis-empty">No standout patterns in this period.</div>'}function Qa(t){var s,o,n,r;const e=Wt(((s=t.rangeData)==null?void 0:s.start)??t.customStart),a=Wt(((o=t.rangeData)==null?void 0:o.end)??t.customEnd);return`
    <div class="range-selector">
      ${Ge.map(l=>`
        <button
    ...
    ${(n=t.rangeData)!=null&&n.start&&((r=t.rangeData)!=null&&r.end)?`
        <div class="range-info-bar">
          Period: ${Le(t.rangeData.start)} - ${Le(t.rangeData.end)}
        </div>
      `:""}
    ${t.range==="custom"?`
        <div class="custom-range-picker">
      ...
      `:e&&a?`
        ...
        `:""}
  `}function es(t,e,a){const s=a.communitySolarToHomeKwh>.01?`${p(a.totalSolarCoverageKwh)} kWh of ${p(a.consumptionKwh)} kWh usage covered, incl. ${p(a.communitySolarToHomeKwh)} kWh shared`:`${p(a.totalSolarCoverageKwh)} kWh of ${p(a.consumptionKwh)} kWh usage covered`;return`
  ...
  `}function as(t,e){const a=Ba(t.analysisHeatmapMetric);return`
    <div class="card analysis-card">
      ...
      ${Ja(e.heatmapValues[t.analysisHeatmapMetric],t.analysisHeatmapMetric)}
      <p class="analysis-note">${a.note}</p>
    </div>
  `}function ss(t,e){const a=t.analysisProfileMetric,s=e.intradayProfiles[a],o=ze[a],n=s.weekday.median.reduce((l,u,y,d)=>u>d[l]?y:l,0),r=s.weekend.median.reduce((l,u,y,d)=>u>d[l]?y:l,0);return`
    <div class="card analysis-card">
      <div class="analysis-card-header">
        <div>
      ...
      ${Ya({title:`${o} intraday profile`,labels:e.intradayLabels,series:[{label:"Weekday median (p10-p90 band)",color:"#58a6ff",fill:"rgba(88, 166, 255, 0.14)",band:s.weekday},{label:"Weekend median (p10-p90 band)",color:"#d29922",fill:"rgba(210, 153, 34, 0.13)",band:s.weekend,dashed:!0}],valueFormatter:l=>`${p(l,1)} kW`})}
      <p class="analysis-note">This makes the typical daily rhythm much easier to read than the weekday/hour heatmap alone.</p>
    </div>
  `}function rs(t,e,a){const s=t.meters.reduce((n,r)=>n+r.selfConsumedKwh*e,0),o=s+t.totalFeedInRevenue;return`
    <div class="analysis-subchart">
  ...
  `}function ns(t,e,a,s){const o=t.totals.solarKwh>0?be(t.totals.solarToHomeKwh/t.totals.solarKwh*100,0,100):0,n=t.totals.solarKwh>0?be(t.totals.exportKwh/t.totals.solarKwh*100,0,100):0;return`
    <div class="card analysis-card">
      <div class="analysis-card-header">
        <div>
      ...
      ${a!=null&&a.meters.length?rs(a,s,e):""}
      <div class="analysis-subchart">
  ...
  `}function is(t,e){const a=t.hourlyExceedanceKwh.map((s,o)=>({label:`${String(o).padStart(2,"0")}:00`,value:s,meta:`${p(s,2)} kWh`,colorClass:"analysis-progress-fill-warn"})).filter(s=>s.value>0).sort((s,o)=>o.value-s.value).slice(0,6);return`
    <div class="card analysis-card">
      <div class="analysis-card-header">
        <div>
      ...
      <div class="analysis-inline-metrics">
        ...
        <div>
          ...
          <strong>${p(oe(t.topExceedances.map(s=>s.overKw),0),2)} kW</strong>
        </div>
        <div>
  ...
  `}function ls(t){const e=t.peakIntervals.length?t.peakIntervals.reduce((a,s)=>a+(s.houseKw>0?s.solarToHomeKw/s.houseKw*100:0),0)/t.peakIntervals.length:0;return`
    <div class="card analysis-card analysis-card-full">
      <div class="analysis-card-header">
        <div>
      ...
      <div class="analysis-inline-metrics">
        <div>
          ...
          <strong>${p(oe(t.peakIntervals.map(a=>a.houseKw),0),2)} kW</strong>
        </div>
        <div>
          <span class="analysis-inline-label">Highest net-grid peak</span>
          <strong>${p(oe(t.peakIntervals.map(a=>a.gridKw),0),2)} kW</strong>
        </div>
        <div>
  ...
  `}function cs(t,e,a){var u,y;const s=e.analysisComparisonMode==="last_year"?"Last year":"Previous";if(e.analysisComparisonLoading)return`
      <div class="card analysis-card">
        <div class="analysis-card-header">
          <div>
  ...
  `}function ps(t,e){const a=Array.from({length:Math.max(t.loadDurationGrossKw.length,t.loadDurationNetKw.length,1)},(s,o)=>`${o+1}`);return`
    <div class="card analysis-card">
      <div class="analysis-card-header">
        <div>
  ...
  `}function us(t){var i,c;const e=t.config,a=t.rangeData,s=t.consumptionTimeseries,o=t.productionTimeseries;if(!e||!a||!s||!o)return`
      <section class="analysis-view">
        <div class="card">
          <p class="muted">Loading analysis data...</p>
        </div>
      </section>
    `;const n=Math.max(0,a.consumption??0),r=Math.max(0,a.production??0),l=Math.max(0,a.exported??0),u=Math.max(0,a.direct_solar_to_home??(a.self_consumed&&a.self_consumed>0?a.self_consumed:0)),y=Math.max(0,(a.grid_import!=null?n-a.grid_import:void 0)??a.solar_to_home??u??(a.self_consumed&&a.self_consumed>0?a.self_consumed:r-l)),d=Math.max(0,a.grid_import??n-y),v=Math.max(0,y-u),h=wt(e,s,((i=t.perMeterProductionTimeseries)==null?void 0:i.meters)??null,u,l),f=Zt(e,s,((c=t.perMeterProductionTimeseries)==null?void 0:c.meters)??null,u,l),m=Jt(s,o,t.gridImportTimeseries,t.marketExportTimeseries,e,f),$=e.currency||"EUR",x=((e.energy_variable_rate??0)+(e.network_variable_rate??0)+(e.electricity_tax_rate??0)+(e.compensation_fund_rate??0))*(1+(e.vat_rate??0)),C=u*x,M=h?h.totalSelfUseExportEquivalent:u*f,_=h?h.totalFeedInRevenue:l*f,S={consumptionKwh:n,totalSolarCoverageKwh:y,directSolarToHomeKwh:u,communitySolarToHomeKwh:v,exportedKwh:l,billedGridImportKwh:d,coveragePct:n>0?be(y/n*100,0,100):0,selfConsumedPct:r>0?be(u/r*100,0,100):0,totalSolarValue:C+m.totals.avoidedExceedanceValue+_,selfConsumptionAdvantage:C-M,variableImportCost:d*x};return`
    <section class="analysis-view">
      <div class="section-header analysis-section-header">
        ...
        <div class="analysis-header-meta">
          <span>${Ua(t)}</span>
          <span>${p(m.daily.length,0)} day${m.daily.length===1?"":"s"} analysed</span>
        </div>
      </div>
        ...
        <div style="overflow-x: auto;">
          <table class="sensor-table">
            ...
            <tbody>
              ${y.map(v=>`
                <tr>
                  <td class="sensor-name">${hs(v.key)}</td>
                  <td class="sensor-value" style="text-align: right; color: var(--clr-${d});">${p(v.value)}</td>
                  <td class="sensor-unit">${v.unit}</td>
                  <td class="sensor-peak">${v.peak_timestamp?Yt(v.peak_timestamp):'<span style="color: var(--clr-border)">—</span>'}</td>
                </tr>
              `).join("")}
            </tbody>
          </table>
  ...
  `}const Kt=[{kw:3,fixedMonthlyFee:7.42},{kw:7,fixedMonthlyFee:12.84},{kw:12,fixedMonthlyFee:19.61},{kw:17,fixedMonthlyFee:26.39},{kw:27,fixedMonthlyFee:39.94},{kw:43,fixedMonthlyFee:61.62},{kw:70,fixedMonthlyFee:98.2},{kw:100,fixedMonthlyFee:138.85},{kw:150,fixedMonthlyFee:206.6,existingContractsOnly:!0},{kw:200,fixedMonthlyFee:274.35,existingContractsOnly:!0}];function Ze(t){if(!t)return null;const e=t.match(/^(\d{4})-(\d{2})-(\d{2})/);if(e){const[,s,o,n]=e;return new Date(Number(s),Number(o)-1,Number(n))}const a=new Date(t);return Number.isNaN(a.getTime())?null:new Date(a.getFullYear(),a.getMonth(),a.getDate())}function Vt(t){if(!t)return"";const e=t.match(/^(\d{4}-\d{2}-\d{2})/);return e?e[1]:""}function gs(t,e,a,s,o){const n=new Date,r=Ze(s),l=Ze(o);let u=r,y=l;if(!u||!y)switch(t){case"yesterday":{const m=new Date(n);m.setDate(m.getDate()-1),u=new Date(m.getFullYear(),m.getMonth(),m.getDate()),y=new Date(u);break}case"this_week":{const m=new Date(n),$=m.getDay()||7;u=new Date(m.getFullYear(),m.getMonth(),m.getDate()-$+1),y=new Date(n.getFullYear(),n.getMonth(),n.getDate());break}case"last_week":{const m=new Date(n),$=m.getDay()||7,x=new Date(m.getFullYear(),m.getMonth(),m.getDate()-$+1);u=new Date(x.getFullYear(),x.getMonth(),x.getDate()-7),y=new Date(x.getFullYear(),x.getMonth(),x.getDate()-1);break}case"this_month":{u=new Date(n.getFullYear(),n.getMonth(),1),y=new Date(n.getFullYear(),n.getMonth(),n.getDate());break}case"last_month":{u=new Date(n.getFullYear(),n.getMonth()-1,1),y=new Date(n.getFullYear(),n.getMonth(),0);break}case"this_year":{u=new Date(n.getFullYear(),0,1),y=new Date(n.getFullYear(),n.getMonth(),n.getDate());break}case"last_year":{u=new Date(n.getFullYear()-1,0,1),y=new Date(n.getFullYear()-1,11,31);break}case"custom":{u=Ze(e)??new Date(n.getFullYear(),n.getMonth(),n.getDate()),y=Ze(a)??new Date(u);break}default:{u=new Date(n.getFullYear(),n.getMonth(),n.getDate()-1),y=new Date(u);break}}if(y<u){const m=u;u=y,y=m}let d=0,v=0;const h=new Date(u);for(;h<=y;){const m=new Date(h.getFullYear(),h.getMonth()+1,0).getDate();v+=1/m,d+=1,h.setDate(h.getDate()+1)}const f=u.getFullYear()===y.getFullYear()&&u.getMonth()===y.getMonth()&&u.getDate()===1&&y.getDate()===new Date(y.getFullYear(),y.getMonth()+1,0).getDate();return{days:d,factor:v,label:f?"full month":`${d} day${d===1?"":"s"}`}}function vs(t,e){return e==="all"?!0:e==="weekdays"?t>=1&&t<=5:t===0||t===6}function Rt(t){const[e,a]=t.split(":").map(s=>parseInt(s,10)||0);return e*60+a}function Qt(t,e,a,s){if(!vs(t.getDay(),e))return!1;const o=t.getHours()*60+t.getMinutes(),n=Rt(a),r=Rt(s);return n===r?!0:n<r?o>=n&&o<r:o>=n||o<r}function ys(t,e){return e.find(a=>Qt(t,a.day_group,a.start_time,a.end_time))}function fs(t,e){return e.find(a=>Qt(t,a.day_group,a.start_time,a.end_time))}function It(t,e,a,s,o,n=[]){var f;const r=new Map;let l=0,u=0,y=0,d=0,v=0;const h=new Map;for(const m of n){const $=Number(m.value)||0;h.set(m.startedAt,(h.get(m.startedAt)??0)+$)}for(const m of t){const $=Number(m.value)||0,x=$*.25,C=h.get(m.startedAt)??0,M=Math.max(0,$-C),_=new Date(m.startedAt);if(Number.isNaN(_.getTime()))continue;const S=ys(_,s),i=fs(_,o),c=(S==null?void 0:S.rate)??e,g=((f=S==null?void 0:S.label)==null?void 0:f.trim())||"Base tariff",b=(i==null?void 0:i.reference_power_kw)??a;l+=x*c,v=Math.max(v,$),d=Math.max(d,M),$>b&&(y+=($-b)*.25),M>b&&(u+=(M-b)*.25);const F=`${g}__${c}`,D=r.get(F);D?D.kwh+=x:r.set(F,{label:g,rate:c,kwh:x})}return{energyCost:l,exceedanceKwh:u,grossExceedanceKwh:y,avoidedExceedanceKwh:Math.max(0,y-u),peakPowerKw:d,grossPeakPowerKw:v,rateBreakdown:Array.from(r.values()).sort((m,$)=>m.label.localeCompare($.label))}}function ws(t){var xt,kt;const e=t.config,a=t.rangeData;if(!e||!a)return`
      <section class="invoice-view">
        <div class="card">
          <p class="muted">Loading billing configuration…</p>
        </div>
      </section>
    `;const s=a.consumption||0,o=a.production||0,n=a.exported||0,r=Math.max(0,n),l=Math.max(0,(a.grid_import!=null?s-a.grid_import:void 0)??a.solar_to_home??a.direct_solar_to_home??(a.self_consumed&&a.self_consumed>0?a.self_consumed:o-r)),u=Math.min(l,Math.max(0,a.direct_solar_to_home??(a.self_consumed&&a.self_consumed>0?a.self_consumed:o-r))),y=Math.max(0,l-u),d=Math.max(0,a.grid_import??s-l),v=a.peak_power_kw||0,h=e.reference_power_kw||5,f=a.exceedance_kwh||0,m=a.gas_energy||0,$=a.gas_volume||0,x=m>0||$>0,C=e.consumption_rate_windows??[],M=e.reference_power_windows??[],_=t.consumptionTimeseries?It(t.consumptionTimeseries.items,e.energy_variable_rate,h,C,M,((xt=t.productionTimeseries)==null?void 0:xt.items)??[]):null,S=C.length>0&&!!_&&Math.abs(d-s)<.01,i=M.length>0&&!!_,c=_?_.peakPowerKw:v,g=_?_.exceedanceKwh:f,b=Vt(a.start??t.customStart),F=Vt(a.end??t.customEnd),{days:D,factor:P,label:V}=gs(t.range,t.customStart,t.customEnd,a.start,a.end),I=e.energy_fixed_fee*P,j=e.network_metering_rate*P,z=e.network_power_ref_rate*P,se=S?_.energyCost:d*e.energy_variable_rate,Q=d*e.network_variable_rate,ee=g*e.exceedance_rate,q=e.meter_monthly_fees??[],ue=q.reduce((w,H)=>w+(H.fee||0),0)*P,ie=d*e.compensation_fund_rate,he=d*e.electricity_tax_rate,U=Math.max(0,e.connect_discount??0)*P,A=I+se+j+z+Q+ee+ue+ie+he-U,N=A*e.vat_rate,re=A+N,te=ft(e),X=wt(e,t.consumptionTimeseries,((kt=t.perMeterProductionTimeseries)==null?void 0:kt.meters)??null,u,r),_e=te.filter(w=>isFinite(w.rate)&&w.rate>0),Y=te.length>1,me=X?X.weightedExportRate:_e.length>0?_e.reduce((w,H)=>w+H.rate,0)/_e.length:e.feed_in_tariff,ae=X?X.totalFeedInRevenue:r*me,ge=Y&&te.length>0?r/te.length:r,Ee=X?X.meters:te.map(w=>({...w,producedKwh:0,exportedKwh:ge,revenue:ge*w.rate,selfConsumedKwh:0,exportEquivalentForSelfUse:0})),ve=!!X,Z=X?X.meters.reduce((w,H)=>w+H.selfConsumedKwh,0):u,Oe=e.energy_variable_rate+e.network_variable_rate+e.electricity_tax_rate+e.compensation_fund_rate,st=Oe*(1+e.vat_rate),rt=Z*Oe,Ue=rt*e.vat_rate,ye=rt+Ue,Be=X?X.totalSelfUseExportEquivalent:Z*me,Pe=ye-Be,fe=Math.max(0,(_==null?void 0:_.avoidedExceedanceKwh)??0),De=fe*e.exceedance_rate,Ke=De*e.vat_rate,we=De+Ke,xe=fe>1e-4,ke=ye+we+ae,k=Ee.map(w=>{const H=w.selfConsumedKwh*st,Se=H-w.exportEquivalentForSelfUse;return{...w,selfUseSavings:H,selfUseVsExport:Se,totalTrackedValue:H+w.revenue}}),E=ve&&k.length>0,W=re-ae,G=(e.gas_fixed_fee??6.5)*P,B=m*(e.gas_variable_rate??.055),Me=(e.gas_network_fee??4.8)*P,ne=m*(e.gas_network_variable_rate??.012),le=m*(e.gas_tax_rate??.001),Ce=G+B+Me+ne+le,nt=Ce*(e.gas_vat_rate??.08),ot=Ce+nt,K=e.currency||"EUR",T=w=>`${p(w,2)} ${K}`,it=w=>`${w>0?"+":w<0?"-":""}${p(Math.abs(w),2)} ${K}`,L=w=>p(w,3),_t=w=>p(w,3),ra=w=>w>=0?"comparison-delta-savings":"comparison-delta-extra",na=E?`
            ...
            <tr>
              ...
              <td style="text-align: right;">
                ...
                <span class="${ra(w.selfUseVsExport)}">${it(w.selfUseVsExport)}</span> self-use vs export<br/>
      ...
      `:"",oa=ve?`Compared with exporting the same ${L(Z)} kWh using the configured PV self-use priority and each system's own feed-in tariff`:`Compared with selling the same ${L(Z)} kWh at ${p(me,4)} ${K}/kWh`,lt=Kt.find(w=>Math.abs(w.kw-h)<.05),ia=A-z-ee,ct=_?Kt.map(w=>{var Ct;const H=It(t.consumptionTimeseries.items,e.energy_variable_rate,w.kw,C,M,((Ct=t.productionTimeseries)==null?void 0:Ct.items)??[]),Se=w.fixedMonthlyFee*P,Ye=H.exceedanceKwh*e.exceedance_rate,Mt=(ia+Se+Ye)*(1+e.vat_rate);return{...w,fixedCharge:Se,exceedanceKwh:H.exceedanceKwh,exceedanceCharge:Ye,total:Mt,deltaVsCurrent:Mt-re}}):[],qe=ct.reduce((w,H)=>!w||H.total<w.total?H:w,null),la=w=>Math.abs(w)<.005?"Current total":`${w>0?"+":"-"}${T(Math.abs(w))}`,dt=a.start&&a.end?`${$e(a.start)} — ${$e(a.end)}`:t.range.replace("_"," ").replace(/\b\w/g,w=>w.toUpperCase()),ca=g>0?`<div class="card exceedance-warning">
        ...
        <p>Exceedance volume: <strong>${L(g)} kWh</strong></p>
        <p class="muted">Exceedance charge: ${T(ee)}</p>
      </div>`:"",da=S?_.rateBreakdown.map(w=>`
            <tr>
          ...
          `,pa=i?`Reference power windows active (${M.length})`:`${p(h,1)} kW`,ua=S?`Time-of-use windows active (${C.length})`:`${p(e.energy_variable_rate,4)} ${K}/kWh`,ha=ct.map(w=>{const H=!!qe&&w.kw===qe.kw,Se=!!lt&&w.kw===lt.kw,Ye=w.deltaVsCurrent<-.005?"comparison-delta-savings":w.deltaVsCurrent>.005?"comparison-delta-extra":"";return`
            <tr class="${H?"reference-power-best-row":""}${Se?" reference-power-current-row":""}">
              <td>
                <div class="reference-level-cell">
                  ...
                  ${Se?'<span class="reference-level-badge current">Current</span>':""}
              ...
              <td class="${Ye}" style="text-align: right;">${la(w.deltaVsCurrent)}</td>
            </tr>
          `}).join(""),ma=ct.length>0?`
    ...
    `,va=a.start&&a.end?(()=>{const w=new Date(a.start),H=new Date(a.end);return Number.isNaN(w.getTime())||Number.isNaN(H.getTime())?"":`
        <div class="range-info-bar">
    ...
    `:b&&F?`
        <div class="custom-range-picker period-preview">
          ...
          <label>
            <span>To</span>
            <input type="date" value="${F}" readonly aria-label="Preset period end" />
          </label>
        </div>
      `:"";return`
    <section class="invoice-view">
      ...
      <div class="section-header invoice-section-header">
        ...
        <div class="invoice-summary-badges">
          ...
          ${x?`<span class="badge" style="background: rgba(255,160,50,0.12); color: #f5a623;">🔥 ${L(m)} kWh gas (${_t($)} m³)</span>`:""}
        </div>
      </div>
      ...
      <div class="card invoice-card">
        <table class="invoice-table">
          ...
          <tbody>
            ...
            <tr>
              <td>Reference power level (${pa}) <span class="muted">(${V})</span></td>
            ...
            <tr class="${g>0?"exceedance-row":""}">
              <td>Exceedance charge (${L(g)} kWh above the reference power level)</td>
            ...
            <tr class="net-total-row">
              ...
              <td style="text-align: right;"><strong>${T(W)}</strong></td>
            </tr>
            `:""}
            ${r<=0?`
            <tr class="solar-total-row">
      ...
      <div class="card invoice-footer">
        <p class="muted" style="line-height: var(--lh-relaxed);">
          <strong>Supplier bill estimate: ${T(re)}</strong>${ae>0?` Feed-in revenue is shown separately as ${T(ae)}, giving a net electricity position of ${T(W)} after export credit.`:""}
          <br/>
      ...
      <div class="card invoice-card gas-invoice-card">
        ...
        <div style="display: flex; gap: var(--sp-4); flex-wrap: wrap; margin-bottom: var(--sp-4);">
          <span class="badge" style="background: rgba(255,160,50,0.12); color: #f5a623;">🔥 ${L(m)} kWh</span>
          <span class="badge" style="background: rgba(255,160,50,0.12); color: #f5a623;">📐 ${_t($)} m³</span>
        </div>
        <table class="invoice-table">
          <thead>
            <tr>
          ...
          <tbody>
            ...
            <tr>
              <td>Network Variable (${L(m)} kWh)</td>
      ...
      <div class="card invoice-footer">
        <p class="muted" style="line-height: var(--lh-relaxed);">
          <strong>Combined Net Energy Position: ${T(W+ot)}</strong>
          (Electricity net position: ${T(W)} + Gas supplier estimate: ${T(ot)})
        </p>
      </div>
      `:""}
      ...
      <div class="card solar-revenue-card">
        ...
        <div class="solar-revenue-summary">
          ...
          <div class="solar-stat">
            <div class="solar-stat-value">${it(Pe)}</div>
        ...
        <table class="invoice-table solar-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: right;">${it(Pe)}</td>
            </tr>
            <tr>
              <td>Export sold</td>
              <td style="text-align: right;">${L(r)} kWh sent to grid</td>
        ...
        <p class="muted" style="margin-top: var(--sp-3); font-size: var(--text-xs); line-height: var(--lh-relaxed);">
          ...
          ${te.some(w=>w.mode==="sensor")?"Market price sourced from Home Assistant sensor.":"Using fixed feed-in tariff — configure a market price sensor in Settings for real-time rates."}
  ...
  `}function ta(t){return $s.map(e=>`<option value="${e.value}" ${e.value===t?"selected":""}>${e.label}</option>`).join("")}function ks(t,e){return`
    <div class="meter-card">
      <div class="meter-header">
  ...
  `}function Cs(t,e="ha",a){if(!t&&e==="ha")return`
      <section class="settings-view">
        <div class="card">
          <p class="muted">Loading configuration…</p>
        </div>
      </section>
    `;const s=e==="standalone"?(a==null?void 0:a.meters)??[{id:"",types:["consumption"]}]:(t==null?void 0:t.meters)??[];let o="";if(e==="standalone"){const i=s.map((g,b)=>At(b,g,!1)).join("");a==null||a.proxy_url,o=`
      <div class="section-header">
    ...
    `}else{const i=(t==null?void 0:t.meters)??[];o=`
      <div class="card" style="margin-bottom: var(--sp-6); padding: var(--sp-4) var(--sp-5);">
        ...
        <div class="form-section">
          ...
          <div id="meters-container">
            ${i.length>0?i.map((g,b)=>At(b,g,!0)).join(""):'<p class="muted">No meters configured</p>'}
          </div>
        </div>
      </div>
    `}const n=i=>i.map(c=>{const g=t?t[c.key]??"":"";return`
        <div class="form-row">
      ...
      `}).join(""),r=((t==null?void 0:t.meters)??[]).filter(i=>i.types.includes("production")),l=(t==null?void 0:t.feed_in_rates)??[],u=e==="ha";function y(i){return l.find(c=>c.meter_id===i)??{meter_id:i,mode:"fixed",tariff:(t==null?void 0:t.feed_in_tariff)??.08,sensor_entity:"",display_name:"",self_use_priority:r.findIndex(c=>c.id===i)+1}}const d=r.length===0?'<p class="muted">No production meters configured — add a meter with Power Production type above.</p>':r.map((i,c)=>{const g=y(i.id),b=i.id?"…"+i.id.slice(-8):`Meter ${c+1}`,F=Qe(i.id,c+1,g.display_name);return`
            ...
            <div class="form-row">
              ...
              <div class="feed-in-mode-toggle">
                <label class="mode-option">
                  <input type="radio" name="feed_in_rate_${c}_mode" value="fixed" ${g.mode==="fixed"?"checked":""} />
                  <span class="mode-label">💶 Fixed Tariff</span>
                </label>
                <label class="mode-option">
                  <input type="radio" name="feed_in_rate_${c}_mode" value="sensor" ${g.mode==="sensor"?"checked":""} />
                  <span class="mode-label">📡 HA Sensor</span>
                </label>
              </div>
            </div>
            <div class="feed-in-fixed-fields" data-rate-idx="${c}" style="${g.mode==="fixed"?"":"display:none"}">
              <div class="form-row">
                <label for="cfg-feed_in_rate_${c}_tariff">Feed-in Tariff</label>
                <div class="input-group">
                  <input id="cfg-feed_in_rate_${c}_tariff" name="feed_in_rate_${c}_tariff" type="number" step="0.0001" value="${g.tariff}" />
                  <span class="input-unit">EUR/kWh</span>
                </div>
              </div>
            </div>
            <div class="feed-in-sensor-fields" data-rate-idx="${c}" style="${g.mode==="sensor"?"":"display:none"}">
              <div class="form-row">
              ...
              <div class="form-row">
                ...
                <div class="input-group">
                  <input id="cfg-feed_in_rate_${c}_fallback" name="feed_in_rate_${c}_fallback_tariff" type="number" step="0.0001" value="${g.tariff}" />
                  <span class="input-unit">EUR/kWh</span>
                </div>
                <p class="muted" style="font-size: var(--text-xs); margin-top: var(--sp-1);">
        ...
        `}).join(""),v=((t==null?void 0:t.meters)??[]).some(i=>i.types.includes("gas"))||(t==null?void 0:t.meter_has_gas),h=(t==null?void 0:t.consumption_rate_windows)??[],f=(t==null?void 0:t.reference_power_windows)??[],m=(t==null?void 0:t.meters)??[],$=(t==null?void 0:t.meter_monthly_fees)??[];function x(i){return $.find(c=>c.meter_id===i)??{meter_id:i,label:"",fee:0}}const C=m.length===0?'<p class="muted">No meters configured.</p>':m.map((i,c)=>{const g=x(i.id),b=i.id?"…"+i.id.slice(-8):`Meter ${c+1}`;return`
          <div class="meter-fee-card" style="margin-bottom: var(--sp-3); padding: var(--sp-3); border: 1px solid var(--clr-border); border-radius: var(--radius);">
            <div style="display: flex; align-items: center; gap: var(--sp-2); margin-bottom: var(--sp-2);">
              <span>${i.types.map(D=>ea[D]??"").join(" ")}</span>
              <code style="font-size: var(--text-sm);">${b}</code>
            ...
            <div class="form-row" style="margin-bottom: var(--sp-2);">
              ...
              <div class="input-group">
                <input id="cfg-meter_fee_${c}_label" name="meter_fee_${c}_label" type="text" value="${g.label||`Meter ${c+1} metering fee`}" placeholder="e.g. Smart meter rental" />
              </div>
            </div>
            <div class="form-row">
              <label for="cfg-meter_fee_${c}_fee">Monthly Fee</label>
              <div class="input-group">
                <input id="cfg-meter_fee_${c}_fee" name="meter_fee_${c}_fee" type="number" step="0.01" value="${g.fee}" />
    ...
    <div id="consumption-windows-container">
      ${h.length>0?h.map((i,c)=>ks(c,i)).join(""):'<p class="muted">No time-of-use windows configured. Using the flat supplier rate.</p>'}
    </div>
  ...
  `,_=`
    ...
    <div id="reference-windows-container">
      ${f.length>0?f.map((i,c)=>Ms(c,i)).join(""):'<p class="muted">No scheduled reference windows configured. Using one reference power all day.</p>'}
    </div>
    <button type="button" id="add-reference-window-btn" class="btn btn-outline" style="margin-top: var(--sp-3);">
      + Add Reference Window
    </button>
  `,S=bs.map(i=>{if(i.title==="Gas Billing"&&!v||i.title==="Meter Fees"&&m.length<2)return"";let c;return i.title==="Feed-in / Selling"?c=d:i.title==="Time-of-Use Tariffs"?c=M:i.title==="Reference Power Windows"?c=_:i.title==="Discounts"?c=`<p class="muted" style="margin: 0 0 var(--sp-3) 0; font-size: 0.85rem;">
  ...
  `}const aa="leneda_credentials",sa="leneda_theme";function Ss(){try{const t=localStorage.getItem(aa);if(t)return JSON.parse(t)}catch{}return null}function ht(t){try{localStorage.setItem(aa,JSON.stringify(t))}catch{}}function Ts(){var t;try{const e=localStorage.getItem(sa);if(e==="dark"||e==="light")return e}catch{}return(t=window.matchMedia)!=null&&t.call(window,"(prefers-color-scheme: light)").matches?"light":"dark"}function Es(t){try{localStorage.setItem(sa,t)}catch{}}function Ht(t){const e=t.match(/^(\d{4})-(\d{2})-(\d{2})$/);if(!e)return null;const[,a,s,o]=e;return new Date(Number(a),Number(s)-1,Number(o))}function Nt(t){const e=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),s=String(t.getDate()).padStart(2,"0");return`${e}-${a}-${s}`}function Re(t){const e=t.getFullYear(),a=String(t.getMonth()+1).padStart(2,"0"),s=String(t.getDate()).padStart(2,"0"),o=String(t.getHours()).padStart(2,"0"),n=String(t.getMinutes()).padStart(2,"0"),r=String(t.getSeconds()).padStart(2,"0"),l=String(t.getMilliseconds()).padStart(3,"0"),u=-t.getTimezoneOffset(),y=u>=0?"+":"-",d=String(Math.floor(Math.abs(u)/60)).padStart(2,"0"),v=String(Math.abs(u)%60).padStart(2,"0");return`${e}-${a}-${s}T${o}:${n}:${r}.${l}${y}${d}:${v}`}function Gt(t,e){return t.getFullYear()===e.getFullYear()&&t.getMonth()===e.getMonth()&&t.getDate()===e.getDate()}function Ds(t,e=new Date){switch(t){case"yesterday":{const a=new Date(e);a.setDate(a.getDate()-1),a.setHours(0,0,0,0);const s=new Date(a);return s.setHours(23,59,59,999),{start:a,end:s}}case"this_week":{const a=new Date(e),s=a.getDay()||7;return a.setDate(a.getDate()-s+1),a.setHours(0,0,0,0),{start:a,end:e}}case"last_week":{const a=new Date(e),s=a.getDay()||7,o=new Date(a);o.setDate(a.getDate()-s),o.setHours(23,59,59,999);const n=new Date(o);return n.setDate(o.getDate()-6),n.setHours(0,0,0,0),{start:n,end:o}}case"this_month":return{start:new Date(e.getFullYear(),e.getMonth(),1),end:e};case"last_month":{const a=new Date(e.getFullYear(),e.getMonth()-1,1),s=new Date(e.getFullYear(),e.getMonth(),0,23,59,59,999);return{start:a,end:s}}case"this_year":return{start:new Date(e.getFullYear(),0,1),end:e};case"last_year":{const a=new Date(e.getFullYear()-1,0,1),s=new Date(e.getFullYear()-1,11,31,23,59,59,999);return{start:a,end:s}}}}function Ws(t,e,a=new Date){const s=Ht(t),o=Ht(e);if(!s||!o)return null;const n=["yesterday","this_week","last_week","this_month","last_month","this_year","last_year"];for(const r of n){const l=Ds(r,a);if(Gt(s,l.start)&&Gt(o,l.end))return r}return null}class Fs{constructor(e){We(this,"root");We(this,"state",{tab:"dashboard",range:"yesterday",customStart:"",customEnd:"",chartViewportStart:null,chartViewportEnd:null,chartUnit:"kwh",chartTimeBucket:"quarter_hour",chartConsumptionView:"grid",analysisHeatmapMetric:"grid",analysisProfileMetric:"house",analysisComparisonMode:"previous",analysisComparison:null,analysisComparisonLoading:!1,rangeData:null,consumptionTimeseries:null,productionTimeseries:null,gridImportTimeseries:null,marketExportTimeseries:null,perMeterProductionTimeseries:null,sensors:null,config:null,loading:!0,error:null,mode:"ha",credentials:null,isMenuOpen:!1,theme:Ts()});We(this,"preZoomRange",null);We(this,"preZoomCustomStart","");We(this,"preZoomCustomEnd","");this.root=e}async mount(){this.applyTheme(),this.render();const e=await Ut();if(this.state.mode=e.mode,e.mode==="standalone"){const a=Ss();if(a&&(this.state.credentials=a),!e.configured&&!a){this.state.tab="settings",this.state.loading=!1,this.state.error=null,this.render();return}if(!e.configured&&a)try{const{saveCredentials:s}=await ce(async()=>{const{saveCredentials:o}=await Promise.resolve().then(()=>Te);return{saveCredentials:o}},void 0);await s(a)}catch{}if(!a)try{this.state.credentials=await Bt()}catch{}}await this.loadData()}toDisplayError(e,a="Failed to load data"){const s=e instanceof Error?e.message:String(e??"").trim(),o=s.toLowerCase();return o.includes("missing data")||o.includes("no_data")||o.includes("no data")?"Missing data":s||a}clearRangeStateWithError(e,a="Failed to load data"){this.state.rangeData=null,this.state.consumptionTimeseries=null,this.state.productionTimeseries=null,this.state.gridImportTimeseries=null,this.state.marketExportTimeseries=null,this.state.perMeterProductionTimeseries=null,this.clearChartViewport(),this.state.analysisComparison=null,this.state.analysisComparisonLoading=!1,this.state.error=this.toDisplayError(e,a)}async fetchPerMeterProductionForRange(e,a,s){var n;if(((e==null?void 0:e.meters)??[]).filter(r=>r.types.includes("production")).length<=1)return null;try{const r=await mt("1-1:2.29.0",a,s);return(n=r.meters)!=null&&n.length?r:null}catch(r){return console.warn("Per-meter production fetch failed:",r),null}}async fetchEnergyFlowTimeseries(e,a){const[s,o,n,r]=await Promise.all([Ie("1-1:1.29.0",e,a),Ie("1-1:2.29.0",e,a),Ie("1-65:1.29.9",e,a),Ie("1-65:2.29.9",e,a)]);return{consumptionTimeseries:s,productionTimeseries:o,gridImportTimeseries:n,marketExportTimeseries:r}}resetAnalysisComparison(){this.state.analysisComparison=null,this.state.analysisComparisonLoading=!1}clearChartViewport(){this.state.chartViewportStart=null,this.state.chartViewportEnd=null}normalizeChartTimeBucket(){const{start:e,end:a}=this.getDateRangeISO(),s=Ta(vt(e,a),this.state.chartTimeBucket);s!==this.state.chartTimeBucket&&(this.state.chartTimeBucket=s)}getCurrentRangeKey(){const{start:e,end:a}=this.getDateRangeISO();return`${e}|${a}`}shiftIsoByYears(e,a){const s=new Date(e);if(!Number.isFinite(s.getTime()))return e;const o=new Date(s);return o.setUTCFullYear(o.getUTCFullYear()+a),o.toISOString()}getComparisonRangeISO(e,a,s){if(s==="last_year")return{start:this.shiftIsoByYears(e,-1),end:this.shiftIsoByYears(a,-1)};const o=new Date(e).getTime(),n=new Date(a).getTime(),r=Math.max(0,n-o),l=o-1,u=l-r;return{start:new Date(u).toISOString(),end:new Date(l).toISOString()}}async loadAnalysisComparison(e=!1){var l;if(!this.state.consumptionTimeseries||!this.state.productionTimeseries)return;const{start:a,end:s}=this.getDateRangeISO(),o=this.state.analysisComparisonMode,n=`${a}|${s}|${o}`;if(!e&&(this.state.analysisComparisonLoading||((l=this.state.analysisComparison)==null?void 0:l.key)===n))return;const r=this.getComparisonRangeISO(a,s,o);this.state.analysisComparisonLoading=!0,this.state.tab==="charts"&&this.renderPreserveMainScroll();try{const{consumptionTimeseries:u,productionTimeseries:y,gridImportTimeseries:d,marketExportTimeseries:v}=await this.fetchEnergyFlowTimeseries(r.start,r.end);if(n!==this.getCurrentRangeKey())return;this.state.analysisComparison={key:n,mode:o,start:r.start,end:r.end,consumptionTimeseries:u,productionTimeseries:y,gridImportTimeseries:d,marketExportTimeseries:v}}catch(u){console.warn("Comparison data fetch failed:",u),n===this.getCurrentRangeKey()&&(this.state.analysisComparison=null)}finally{n===this.getCurrentRangeKey()&&(this.state.analysisComparisonLoading=!1,this.state.tab==="charts"&&this.renderPreserveMainScroll())}}async loadData(){this.state.loading=!0,this.state.error=null,this.state.rangeData=null,this.clearChartViewport(),this.resetAnalysisComparison(),this.render();try{const[e,a,s]=await Promise.all([Je(this.state.range),gt(),Ae()]),{start:o,end:n}=this.getDateRangeISO(),[r,l]=await Promise.all([this.fetchEnergyFlowTimeseries(o,n),this.fetchPerMeterProductionForRange(s,o,n)]);this.state.rangeData=e,this.state.consumptionTimeseries=r.consumptionTimeseries,this.state.productionTimeseries=r.productionTimeseries,this.state.gridImportTimeseries=r.gridImportTimeseries,this.state.marketExportTimeseries=r.marketExportTimeseries,this.state.perMeterProductionTimeseries=l,this.state.sensors=a,this.state.config=s}catch(e){this.clearRangeStateWithError(e,"Failed to load data")}finally{this.state.loading=!1,this.render(),this.state.tab==="charts"&&this.state.rangeData&&this.loadAnalysisComparison()}}async changeRange(e){if(this.preZoomRange=null,this.clearChartViewport(),this.state.range=e,this.resetAnalysisComparison(),e==="custom"){if(!this.state.customStart||!this.state.customEnd){const a=new Date;a.setDate(a.getDate()-1);const s=new Date(a);s.setDate(s.getDate()-6),this.state.customStart=Nt(s),this.state.customEnd=Nt(a)}this.render();return}this.state.error=null,this.state.loading=!0,this.render();try{const{start:a,end:s}=this.getDateRangeISO(),[o,n,r]=await Promise.all([Je(e),this.fetchEnergyFlowTimeseries(a,s),this.fetchPerMeterProductionForRange(this.state.config,a,s)]);this.state.rangeData=o,this.state.consumptionTimeseries=n.consumptionTimeseries,this.state.productionTimeseries=n.productionTimeseries,this.state.gridImportTimeseries=n.gridImportTimeseries,this.state.marketExportTimeseries=n.marketExportTimeseries,this.state.perMeterProductionTimeseries=r}catch(a){this.clearRangeStateWithError(a,"Missing data")}finally{this.state.loading=!1,this.render(),this.state.tab==="charts"&&this.state.rangeData&&this.loadAnalysisComparison()}}async applyCustomRange(){this.preZoomRange=null,this.clearChartViewport();const{customStart:e,customEnd:a}=this.state;if(!(!e||!a)){this.state.error=null,this.state.loading=!0,this.resetAnalysisComparison(),this.render();try{const s=Ws(e,a),o=s?Je(s):ce(async()=>{const{fetchCustomData:v}=await Promise.resolve().then(()=>Te);return{fetchCustomData:v}},void 0).then(({fetchCustomData:v})=>v(e,a)),n=this.state.config,r=Re(new Date(e+"T00:00:00")),l=Re(new Date(a+"T23:59:59.999")),[u,y,d]=await Promise.all([o,this.fetchEnergyFlowTimeseries(r,l),this.fetchPerMeterProductionForRange(n,r,l)]);this.state.rangeData={range:"custom",consumption:u.consumption,production:u.production,exported:u.exported??0,self_consumed:u.self_consumed??0,grid_import:u.grid_import,solar_to_home:u.solar_to_home,direct_solar_to_home:u.direct_solar_to_home,shared:u.shared,shared_with_me:u.shared_with_me,gas_energy:u.gas_energy??0,gas_volume:u.gas_volume??0,peak_power_kw:u.peak_power_kw??0,exceedance_kwh:u.exceedance_kwh??0,metering_point:u.metering_point??"",start:u.start??e,end:u.end??a},this.state.consumptionTimeseries=y.consumptionTimeseries,this.state.productionTimeseries=y.productionTimeseries,this.state.gridImportTimeseries=y.gridImportTimeseries,this.state.marketExportTimeseries=y.marketExportTimeseries,this.state.perMeterProductionTimeseries=d}catch(s){this.clearRangeStateWithError(s,"Missing data")}finally{this.state.loading=!1,this.render(),this.state.tab==="charts"&&this.state.rangeData&&this.loadAnalysisComparison()}}}async shiftChartPeriod(e){const{start:a,end:s}=this.getDateRangeISO(),o=zt(a,s,this.state.chartTimeBucket,e);o&&await this.handleChartZoomChange(Re(o.start),Re(o.end))}changeTab(e){this.state.tab=e,this.render(),(e==="dashboard"||e==="charts")&&!this.state.rangeData&&!this.state.loading&&this.loadData(),e==="charts"&&this.state.rangeData&&this.loadAnalysisComparison(),e==="sensors"&&!this.state.sensors&&gt().then(a=>{this.state.sensors=a,this.render()}),e==="settings"&&!this.state.config&&Ae().then(a=>{this.state.config=a,this.render()}),this.state.isMenuOpen=!1}toggleMenu(){this.state.isMenuOpen=!this.state.isMenuOpen,this.render()}applyTheme(){document.documentElement.dataset.theme=this.state.theme}setTheme(e){e!==this.state.theme&&(this.state.theme=e,Es(e),this.applyTheme(),this.render())}toggleTheme(){this.setTheme(this.state.theme==="dark"?"light":"dark")}printInvoice(){var r,l;const e=document.title,s=`Leneda-invoice-${(r=this.state.rangeData)!=null&&r.start&&((l=this.state.rangeData)!=null&&l.end)?`${this.state.rangeData.start.slice(0,10)}_to_${this.state.rangeData.end.slice(0,10)}`:this.state.range}`.replace(/[^a-z0-9_-]+/gi,"-");let o=!1;const n=()=>{o||(o=!0,document.title=e,window.removeEventListener("afterprint",n))};document.title=s,window.addEventListener("afterprint",n,{once:!0}),window.print(),window.setTimeout(n,1e3)}getMainContentScrollTop(){const e=this.root.querySelector(".main-content");return e?e.scrollTop:window.scrollY||document.documentElement.scrollTop||0}restoreMainContentScrollTop(e){requestAnimationFrame(()=>{const a=this.root.querySelector(".main-content");a?a.scrollTop=e:window.scrollTo({top:e})})}renderPreserveMainScroll(){const e=this.getMainContentScrollTop();this.render(),this.restoreMainContentScrollTop(e)}getDataSourceLabel(){return this.state.mode==="ha"?"Home Assistant":"Standalone"}getHostedDataNoticeHtml(){var e;return(((e=this.state.credentials)==null?void 0:e.proxy_url)??"").trim().length>0,""}render(){var u;const{tab:e,loading:a,error:s,theme:o}=this.state,n=this.getDataSourceLabel(),r=this.getHostedDataNoticeHtml();if(a&&!this.state.rangeData){this.root.innerHTML=`
        <div class="app-shell">
          ${ut(e,y=>{},!1,o,n)}
      ...
      `,this.attachNavListeners(),(u=this.root.querySelector("#retry-btn"))==null||u.addEventListener("click",()=>this.loadData());return}this.state.rangeData&&this.normalizeChartTimeBucket();let l="";switch(e){case"dashboard":l=Wa(this.state);break;case"charts":l=us(this.state);break;case"sensors":l=ms(this.state.sensors);break;case"invoice":l=ws(this.state);break;case"settings":l=Cs(this.state.config,this.state.mode,this.state.credentials);break}this.root.innerHTML=`
      <div class="app-shell">
    ...
    `,this.attachNavListeners(),this.attachDashboardListeners(),this.attachAnalysisListeners(),this.attachInvoiceListeners(),this.attachSettingsListeners()}attachNavListeners(){var e,a;(e=this.root.querySelector(".menu-toggle"))==null||e.addEventListener("click",()=>{this.toggleMenu()}),(a=this.root.querySelector("[data-theme-toggle]"))==null||a.addEventListener("click",()=>{this.toggleTheme()}),this.root.querySelectorAll("[data-tab]").forEach(s=>{s.addEventListener("click",()=>{const o=s.dataset.tab;this.changeTab(o)})})}attachDashboardListeners(e=!1){this.root.querySelectorAll("[data-range]").forEach(r=>{r.addEventListener("click",()=>{const l=r.dataset.range;this.changeRange(l)})});const a=this.root.querySelector("#custom-start"),s=this.root.querySelector("#custom-end");a&&a.addEventListener("change",()=>{this.state.customStart=a.value}),s&&s.addEventListener("change",()=>{this.state.customEnd=s.value});const o=this.root.querySelector("#apply-custom-range");if(o==null||o.addEventListener("click",()=>this.applyCustomRange()),this.root.querySelectorAll("[data-chart-unit]").forEach(r=>{r.addEventListener("click",()=>{const l=r.dataset.chartUnit;l!==this.state.chartUnit&&(this.state.chartUnit=l,this.renderPreserveMainScroll())})}),this.root.querySelectorAll("[data-chart-bucket]").forEach(r=>{r.addEventListener("click",()=>{const l=r.dataset.chartBucket,{start:u,end:y}=this.getDateRangeISO();He(l,vt(u,y))&&l!==this.state.chartTimeBucket&&(this.state.chartTimeBucket=l,this.renderPreserveMainScroll())})}),this.root.querySelectorAll("[data-chart-period-nav]").forEach(r=>{r.addEventListener("click",()=>{const l=r.dataset.chartPeriodNav==="next"?1:-1;this.shiftChartPeriod(l)})}),this.root.querySelectorAll("[data-chart-view]").forEach(r=>{r.addEventListener("click",()=>{const l=r.dataset.chartView;l!==this.state.chartConsumptionView&&(this.state.chartConsumptionView=l,this.renderPreserveMainScroll())})}),!e){const r=this.root.querySelector("#energy-chart");r&&this.state.rangeData&&this.initChart(r)}const n=this.root.querySelector(".reset-zoom-btn");n==null||n.addEventListener("click",async()=>{const{resetChartZoom:r}=await ce(async()=>{const{resetChartZoom:l}=await import("./Charts-geGBuw1w.js");return{resetChartZoom:l}},[]);if(r(),n.style.display="none",this.clearChartViewport(),this.preZoomRange!==null){const l=this.preZoomRange;this.state.customStart=this.preZoomCustomStart,this.state.customEnd=this.preZoomCustomEnd,this.preZoomRange=null,this.preZoomCustomStart="",this.preZoomCustomEnd="",l==="custom"?(this.state.range="custom",this.applyCustomRange()):this.changeRange(l)}else this.changeRange(this.state.range==="custom"?"yesterday":this.state.range)})}attachAnalysisListeners(){this.root.querySelectorAll("[data-analysis-heatmap]").forEach(e=>{e.addEventListener("click",()=>{const a=e.dataset.analysisHeatmap;a!==this.state.analysisHeatmapMetric&&(this.state.analysisHeatmapMetric=a,this.renderPreserveMainScroll())})}),this.root.querySelectorAll("[data-analysis-profile]").forEach(e=>{e.addEventListener("click",()=>{const a=e.dataset.analysisProfile;a!==this.state.analysisProfileMetric&&(this.state.analysisProfileMetric=a,this.renderPreserveMainScroll())})}),this.root.querySelectorAll("[data-analysis-comparison-mode]").forEach(e=>{e.addEventListener("click",()=>{const a=e.dataset.analysisComparisonMode;a!==this.state.analysisComparisonMode&&(this.state.analysisComparisonMode=a,this.state.analysisComparison=null,this.loadAnalysisComparison(!0))})})}attachInvoiceListeners(){var e;(e=this.root.querySelector("#print-invoice-btn"))==null||e.addEventListener("click",()=>{this.printInvoice()})}attachSettingsListeners(){var u,y;const e=this.root.querySelector("#credentials-form");if(e){const d=this.root.querySelector("#add-meter-btn");d==null||d.addEventListener("click",()=>{var $,x,C;const f=new FormData(e),m=v(f);if(m.length<10){m.push({id:"",types:["consumption"]});const M={api_key:f.get("api_key")||(($=this.state.credentials)==null?void 0:$.api_key)||"",energy_id:f.get("energy_id")||((x=this.state.credentials)==null?void 0:x.energy_id)||"",meters:m,proxy_url:f.get("proxy_url")||((C=this.state.credentials)==null?void 0:C.proxy_url)||""};this.state.credentials=M,ht(M),this.renderPreserveMainScroll()}}),this.root.querySelectorAll(".remove-meter-btn").forEach(f=>{f.addEventListener("click",()=>{var M,_,S;const m=parseInt(f.dataset.meter??"0",10),$=new FormData(e),x=v($);x.splice(m,1);const C={api_key:$.get("api_key")||((M=this.state.credentials)==null?void 0:M.api_key)||"",energy_id:$.get("energy_id")||((_=this.state.credentials)==null?void 0:_.energy_id)||"",meters:x,proxy_url:$.get("proxy_url")||((S=this.state.credentials)==null?void 0:S.proxy_url)||""};this.state.credentials=C,ht(C),this.renderPreserveMainScroll()})});const v=f=>{var $,x,C;const m=[];for(let M=0;M<10;M++){const _=f.get(`meter_${M}_id`);if(_===null)break;const S=[];($=e.querySelector(`[name="meter_${M}_consumption"]`))!=null&&$.checked&&S.push("consumption"),(x=e.querySelector(`[name="meter_${M}_production"]`))!=null&&x.checked&&S.push("production"),(C=e.querySelector(`[name="meter_${M}_gas"]`))!=null&&C.checked&&S.push("gas"),m.push({id:_.trim(),types:S})}return m};e.addEventListener("submit",async f=>{f.preventDefault();const m=new FormData(e),$={api_key:m.get("api_key"),energy_id:m.get("energy_id"),meters:v(m),proxy_url:m.get("proxy_url")},x=this.root.querySelector("#creds-status");try{ht($);const{saveCredentials:C}=await ce(async()=>{const{saveCredentials:S}=await Promise.resolve().then(()=>Te);return{saveCredentials:S}},void 0);await C($),x&&(x.innerHTML='<p style="color: var(--clr-production); padding: var(--sp-3) 0;">✓ Credentials saved. Reloading data…</p>'),this.state.credentials=$,this.state.error=null;const M=!1,_=($.proxy_url??"").trim();await this.loadData()}catch(C){x&&(x.innerHTML=`<p style="color: var(--clr-danger); padding: var(--sp-3) 0;">✗ Save failed: ${C instanceof Error?C.message:C}</p>`)}});const h=this.root.querySelector("#test-creds-btn");h==null||h.addEventListener("click",async()=>{const f=new FormData(e),m={api_key:f.get("api_key"),energy_id:f.get("energy_id"),meters:v(f),proxy_url:f.get("proxy_url")},$=this.root.querySelector("#creds-status");$&&($.innerHTML='<p style="color: var(--clr-muted); padding: var(--sp-3) 0;">Testing connection…</p>');try{const{testCredentials:x}=await ce(async()=>{const{testCredentials:M}=await Promise.resolve().then(()=>Te);return{testCredentials:M}},void 0),C=await x(m);$&&($.innerHTML=C.success?`<p style="color: var(--clr-production); padding: var(--sp-3) 0;">✓ ${C.message}</p>`:`<p style="color: var(--clr-danger); padding: var(--sp-3) 0;">✗ ${C.message}</p>`)}catch(x){$&&($.innerHTML=`<p style="color: var(--clr-danger); padding: var(--sp-3) 0;">✗ Test failed: ${x instanceof Error?x.message:x}</p>`)}})}const a=this.root.querySelector("#settings-form");if(!a)return;const s=d=>{const v=[];for(let h=0;h<24;h++){const f=d.get(`consumption_window_${h}_label`),m=d.get(`consumption_window_${h}_day_group`),$=d.get(`consumption_window_${h}_start_time`),x=d.get(`consumption_window_${h}_end_time`),C=d.get(`consumption_window_${h}_rate`);if(f===null&&m===null&&$===null&&x===null&&C===null)break;v.push({label:(f??"").trim()||`Window ${h+1}`,day_group:m??"all",start_time:$??"00:00",end_time:x??"06:00",rate:parseFloat(C??"0")||0})}return v},o=d=>{const v=[];for(let h=0;h<24;h++){const f=d.get(`reference_window_${h}_label`),m=d.get(`reference_window_${h}_day_group`),$=d.get(`reference_window_${h}_start_time`),x=d.get(`reference_window_${h}_end_time`),C=d.get(`reference_window_${h}_reference_power_kw`);if(f===null&&m===null&&$===null&&x===null&&C===null)break;v.push({label:(f??"").trim()||`Reference ${h+1}`,day_group:m??"all",start_time:$??"17:00",end_time:x??"00:00",reference_power_kw:parseFloat(C??"0")||0})}return v},n=()=>{var M;const d=new FormData(a),v={};a.querySelectorAll('input[type="checkbox"]').forEach(_=>{v[_.name]=_.checked});const h=[],f=/^feed_in_rate_(\d+)_(.+)$/,m={},$=[],x=/^meter_fee_(\d+)_(.+)$/,C={};for(const[_,S]of d.entries()){if(_.startsWith("consumption_window_")||_.startsWith("reference_window_"))continue;const i=_.match(f);if(i){const D=i[1],P=i[2];m[D]||(m[D]={}),m[D][P]=S;continue}const c=_.match(x);if(c){const D=c[1],P=c[2];C[D]||(C[D]={}),C[D][P]=S;continue}if(v[_]!==void 0&&typeof v[_]=="boolean")continue;const g=S,b=a.elements.namedItem(_);if(g===""&&b instanceof HTMLInputElement&&b.type==="number"){const D=(M=this.state.config)==null?void 0:M[_];typeof D=="number"&&isFinite(D)&&(v[_]=D);continue}const F=parseFloat(g);v[_]=isNaN(F)?g:F}for(const _ of Object.keys(m).sort()){const S=m[_],i=S.mode??"fixed",c=i==="sensor"?S.fallback_tariff??S.tariff:S.tariff;h.push({meter_id:S.meter_id??"",mode:i,tariff:parseFloat(c??"0.08")||.08,sensor_entity:S.sensor_entity??"",display_name:(S.display_name??"").trim(),self_use_priority:Math.max(1,parseInt(S.self_use_priority??`${Number(_)+1}`,10)||Number(_)+1)})}h.length>0&&(v.feed_in_rates=h);for(const _ of Object.keys(C).sort()){const S=C[_];$.push({meter_id:S.meter_id??"",label:S.label??"",fee:parseFloat(S.fee??"0")||0})}return $.length>0&&(v.meter_monthly_fees=$),v.consumption_rate_windows=s(d),v.reference_power_windows=o(d),v},r=d=>{if(!this.state.config)return;const v=n();d(v),this.state.config={...this.state.config,...v},this.renderPreserveMainScroll()};if((u=this.root.querySelector("#add-consumption-window-btn"))==null||u.addEventListener("click",()=>{r(d=>{var h;const v=Array.isArray(d.consumption_rate_windows)?[...d.consumption_rate_windows]:[];v.push({label:`Window ${v.length+1}`,day_group:"weekdays",start_time:"17:00",end_time:"00:00",rate:((h=this.state.config)==null?void 0:h.energy_variable_rate)??.1125}),d.consumption_rate_windows=v})}),this.root.querySelectorAll(".remove-consumption-window-btn").forEach(d=>{d.addEventListener("click",()=>{const v=parseInt(d.dataset.window??"0",10);r(h=>{const f=Array.isArray(h.consumption_rate_windows)?[...h.consumption_rate_windows]:[];f.splice(v,1),h.consumption_rate_windows=f})})}),(y=this.root.querySelector("#add-reference-window-btn"))==null||y.addEventListener("click",()=>{r(d=>{var h;const v=Array.isArray(d.reference_power_windows)?[...d.reference_power_windows]:[];v.push({label:`Reference ${v.length+1}`,day_group:"weekdays",start_time:"17:00",end_time:"00:00",reference_power_kw:((h=this.state.config)==null?void 0:h.reference_power_kw)??5}),d.reference_power_windows=v})}),this.root.querySelectorAll(".remove-reference-window-btn").forEach(d=>{d.addEventListener("click",()=>{const v=parseInt(d.dataset.window??"0",10);r(h=>{const f=Array.isArray(h.reference_power_windows)?[...h.reference_power_windows]:[];f.splice(v,1),h.reference_power_windows=f})})}),a.querySelectorAll('input[type="radio"][name^="feed_in_rate_"][name$="_mode"]').forEach(d=>{d.addEventListener("change",()=>{const v=d.name.match(/feed_in_rate_(\d+)_mode/);if(!v)return;const h=v[1],f=a.querySelector(`.feed-in-fixed-fields[data-rate-idx="${h}"]`),m=a.querySelector(`.feed-in-sensor-fields[data-rate-idx="${h}"]`);f&&(f.style.display=d.value==="fixed"?"":"none"),m&&(m.style.display=d.value==="sensor"?"":"none")})}),this.state.mode==="ha"){const d=this.root.querySelector("#ha-entity-list");d&&qt().then(({entities:v})=>{d.innerHTML=v.map(h=>`<option value="${h}"></option>`).join("")}).catch(()=>{})}a.addEventListener("submit",async d=>{d.preventDefault();const v=n();try{const{saveConfig:h}=await ce(async()=>{const{saveConfig:f}=await Promise.resolve().then(()=>Te);return{saveConfig:f}},void 0);await h(v),this.state.config=await Ae(),this.render()}catch(h){alert("Failed to save: "+(h instanceof Error?h.message:h))}});const l=this.root.querySelector("#reset-config-btn");l==null||l.addEventListener("click",async()=>{if(confirm("Reset all billing rates to defaults?"))try{const{resetConfig:d}=await ce(async()=>{const{resetConfig:v}=await Promise.resolve().then(()=>Te);return{resetConfig:v}},void 0);await d(),this.state.config=await Ae(),this.render()}catch(d){alert("Failed to reset: "+(d instanceof Error?d.message:d))}})}async initChart(e){var a,s,o,n;try{const{renderEnergyChart:r}=await ce(async()=>{const{renderEnergyChart:M}=await import("./Charts-geGBuw1w.js");return{renderEnergyChart:M}},[]),{start:l,end:u}=this.getDateRangeISO(),y=this.state.chartViewportStart?new Date(this.state.chartViewportStart).getTime():void 0,d=this.state.chartViewportEnd?new Date(this.state.chartViewportEnd).getTime():void 0;let v=this.state.consumptionTimeseries,h=this.state.productionTimeseries,f=this.state.gridImportTimeseries,m=this.state.marketExportTimeseries;if(!v||!h||!f||!m){const M=await this.fetchEnergyFlowTimeseries(l,u);v=M.consumptionTimeseries,h=M.productionTimeseries,f=M.gridImportTimeseries,m=M.marketExportTimeseries,this.state.consumptionTimeseries=v,this.state.productionTimeseries=h,this.state.gridImportTimeseries=f,this.state.marketExportTimeseries=m}const $=((a=this.state.config)==null?void 0:a.reference_power_kw)??0,x=(((s=this.state.config)==null?void 0:s.meters)??[]).filter(M=>M.types.includes("production"));let C;if((n=(o=this.state.perMeterProductionTimeseries)==null?void 0:o.meters)!=null&&n.length)C=this.state.perMeterProductionTimeseries.meters;else if(x.length>1)try{const M=await mt("1-1:2.29.0",l,u);M.meters&&M.meters.length>1&&(C=M.meters,this.state.perMeterProductionTimeseries=M)}catch(M){console.warn("Per-meter timeseries fetch failed, using merged view:",M)}r(e,v,h,{unit:this.state.chartUnit,consumptionView:this.state.chartConsumptionView,referencePowerKw:$,gridImportTimeseries:f,marketExportTimeseries:m,perMeterProduction:C,viewportStartMs:y,viewportEndMs:d,timeBucket:this.state.chartTimeBucket,onZoomChange:(M,_)=>{this.handleChartZoomChange(M,_)}})}catch(r){console.error("Chart init failed:",r)}}async handleChartZoomChange(e,a){try{this.preZoomRange===null&&(this.preZoomRange=this.state.range,this.preZoomCustomStart=this.state.customStart,this.preZoomCustomEnd=this.state.customEnd),this.state.error=null,this.state.loading=!0,this.renderPreserveMainScroll();const{fetchCustomData:s}=await ce(async()=>{const{fetchCustomData:y}=await Promise.resolve().then(()=>Te);return{fetchCustomData:y}},void 0),o=e.slice(0,10),n=a.slice(0,10);this.resetAnalysisComparison();const r=await s(e,a),[l,u]=await Promise.all([this.fetchEnergyFlowTimeseries(e,a),this.fetchPerMeterProductionForRange(this.state.config,e,a)]);this.state.range="custom",this.state.customStart=o,this.state.customEnd=n,this.state.chartViewportStart=e,this.state.chartViewportEnd=a,this.state.rangeData={range:"custom",consumption:r.consumption,production:r.production,exported:r.exported??0,self_consumed:r.self_consumed??0,gas_energy:r.gas_energy??0,gas_volume:r.gas_volume??0,grid_import:r.grid_import,solar_to_home:r.solar_to_home,direct_solar_to_home:r.direct_solar_to_home,shared:r.shared,shared_with_me:r.shared_with_me,peak_power_kw:r.peak_power_kw??0,exceedance_kwh:r.exceedance_kwh??0,metering_point:r.metering_point??"",start:r.start,end:r.end},this.state.consumptionTimeseries=l.consumptionTimeseries,this.state.productionTimeseries=l.productionTimeseries,this.state.gridImportTimeseries=l.gridImportTimeseries,this.state.marketExportTimeseries=l.marketExportTimeseries,this.state.perMeterProductionTimeseries=u,this.state.loading=!1,this.renderPreserveMainScroll()}catch(s){console.error("Zoom data fetch failed:",s),this.state.loading=!1,this.clearRangeStateWithError(s,"Missing data"),this.render()}}getDateRangeISO(){if(this.state.chartViewportStart&&this.state.chartViewportEnd)return{start:this.state.chartViewportStart,end:this.state.chartViewportEnd};const e=new Date,a=s=>Re(s);switch(this.state.range){case"custom":{const s=new Date(this.state.customStart+"T00:00:00"),o=new Date(this.state.customEnd+"T23:59:59.999");return{start:a(s),end:a(o)}}case"yesterday":{const s=new Date(e);s.setDate(s.getDate()-1),s.setHours(0,0,0,0);const o=new Date(s);return o.setHours(23,59,59,999),{start:a(s),end:a(o)}}case"this_week":{const s=new Date(e),o=s.getDay()||7;return s.setDate(s.getDate()-o+1),s.setHours(0,0,0,0),{start:a(s),end:a(e)}}case"last_week":{const s=new Date(e),o=s.getDay()||7,n=new Date(s);n.setDate(s.getDate()-o),n.setHours(23,59,59,999);const r=new Date(n);return r.setDate(n.getDate()-6),r.setHours(0,0,0,0),{start:a(r),end:a(n)}}case"this_month":{const s=new Date(e.getFullYear(),e.getMonth(),1);return{start:a(s),end:a(e)}}case"last_month":{const s=new Date(e.getFullYear(),e.getMonth()-1,1),o=new Date(e.getFullYear(),e.getMonth(),0,23,59,59,999);return{start:a(s),end:a(o)}}case"this_year":{const s=new Date(e.getFullYear(),0,1);return{start:a(s),end:a(e)}}case"last_year":{const s=new Date(e.getFullYear()-1,0,1),o=new Date(e.getFullYear()-1,11,31,23,59,59,999);return{start:a(s),end:a(o)}}default:{const s=new Date(e);s.setDate(s.getDate()-1),s.setHours(0,0,0,0);const o=new Date(s);return o.setHours(23,59,59,999),{start:a(s),end:a(o)}}}}}if(window.self===window.top&&window.location.pathname.startsWith("/leneda-panel/"))window.location.href="/leneda";else{const t=document.getElementById("app");t&&new Fs(t).mount()}export{La as b};
